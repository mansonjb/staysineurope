...
const copenhagenIt: CityData = {
  city: {
    ...
    tagline: "Cinque quartieri molto diversi, a una pedalata di distanza: scegli bene e il viaggio va da sé.",
    heroIntro:
      "Copenaghen si divide in quartieri tascabili che si somigliano a malapena, quindi dove dormi decide se il viaggio corre su piazze reali, quiete sui canali o cucine aperte fino a tardi. La città vecchia mette ogni attrazione di richiamo a portata di piedi ma la fa pagare, Vesterbro e Nørrebro scambiano le viste da cartolina con il cibo che i locali mangiano davvero, e Christianshavn galleggia in una via di mezzo più calma. Questa guida ripercorre tutti e cinque i quartieri, così il letto che prenoti corrisponde alla città che vuoi davvero.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Questo nucleo medievale si trova tra Strøget, i palazzi e i canali, con quasi ogni attrazione di richiamo entro dieci minuti a piedi. È denso ed elegante di giorno, più tranquillo una volta chiusi i negozi, e mette a portata di piedi la Torre Rotonda, Rosenborg e Nyhavn. Conviene prenotare qui se il viaggio è breve e si preferisce pagare la comodità piuttosto che una stanza più grande.",
      pros: [
        ...
        "Una visita di due giorni si svolge interamente a piedi",
      ],
      cons: [
        "Le tariffe delle camere sono tra le più alte della città",
        "Le vie principali hanno un sovrapprezzo turistico su cibo e bevande",
        "Meno ristoranti di quartiere rispetto a Nørrebro o Vesterbro",
      ],
    },
    {
      slug: "nyhavn",
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "Questa è la vista che ogni visitatore immagina prima ancora di atterrare: un breve canale del Seicento fiancheggiato da facciate dipinte, barche di legno ormeggiate e bar con terrazza affollati in estate. Dormire così vicino mette il porto e il quartiere reale sull'uscio di casa, anche se il bordo dell'acqua diventa rumoroso e caro non appena esce il sole. Conviene prenotare qui se la vista sul canale conta più di una notte tranquilla, e non dispiace mangiare una via più indietro.",
      pros: [
        "Si dorme proprio sul canale più fotografato della città",
        "Quartiere reale, Amalienborg e i pontili dei battelli a pochi passi",
        "Ben servito da metro e bus del porto",
      ],
      cons: [
        "I ristoranti sull'acqua fanno pagare caro la vista",
        "Le sere d'estate portano rumore e folla fuori dalla porta",
        "Le camere economiche scarseggiano così vicino al canale",
      ],
    },
    {
      slug: "vesterbro",
      ...
      vibe: "Un tempo quartiere a luci rosse e dei mattatoi, questa zona a ovest della stazione centrale è diventata la sacca più vivace di cibo e vita notturna della città. I vecchi capannoni di Kødbyen ospitano ora wine bar naturali e panetterie dove passano le serate i giovani locali, non i gruppi turistici. Conviene prenotare qui per prezzi da vera Copenaghen e una serata più animata, con Tivoli e il centro comunque a portata di piedi.",
      pros: [
        "La scena gastronomica e notturna più forte per il prezzo",
        "I bar di Kødbyen e la stazione centrale entrambi a un passo",
        "Una facile camminata fino a Tivoli e al centro città",
      ],
      cons: [
        "Alcune strade si sentono ancora ruvide a notte fonda",
        "Nessun canale o attrazione simbolo all'interno del quartiere stesso",
        "Gli isolati della vita notturna restano rumorosi dopo il buio",
      ],
    },
    {
      slug: "norrebro",
      ...
      vibe: "A nord dei laghi, questo è il quartiere più giovane e più multiculturale della città, ancorato al variegato parco Superkilen e ai caffè lungo Jægersborggade. La scena gastronomica di quartiere qui corre su panetterie e griglie mediorientali invece che su menù turistici, a prezzi che il centro si è lasciato alle spalle. Conviene prenotare qui se si preferisce mangiare come un locale e non dispiace un quarto d'ora a piedi o una breve corsa in bus fino alla città vecchia.",
      pros: [
        "Le camere più economiche tra i quartieri semicentrali",
        "Forte scena gastronomica indipendente con poco sovrapprezzo turistico",
        "Superkilen, il cimitero di Assistens e Jægersborggade a un passo",
      ],
      cons: [
        "Il più lontano tra questi cinque quartieri dalle attrazioni del porto",
        "Abbastanza esteso da dover contare su bici o bus",
        "La copertura della metro è discontinua, anche se i bus passano spesso",
      ],
    },
    {
      slug: "christianshavn",
      ...
      vibe: "Progettata da Cristiano IV, questa isola attraversata da canali mescola case galleggianti e banchine acciottolate con la città libera di Christiania proprio al suo margine. Scambia il trambusto della città vecchia con qualcosa di più residenziale, restando però a una sola fermata di metro o a una camminata lungo il porto dal centro. Conviene prenotare qui per la vista sull'acqua e notti tranquille senza rinunciare a un facile collegamento con tutto il resto.",
      pros: [
        "Canali e case galleggianti lontano dalla folla",
        "Una fermata di metro o una camminata dal centro, con Christiania accanto",
        "Autentici caffè locali e il lungoporto a piedi",
      ],
      cons: [
        "Meno hotel, quindi scelta e disponibilità sono più limitate",
        "Vita notturna più tranquilla che a Vesterbro o Nørrebro",
        "Per la maggior parte delle attrazioni centrali si deve attraversare il porto",
      ],
    },
  ],
