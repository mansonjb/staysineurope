...
const pragueIt: CityData = {
  city: {
    ...
    tagline: "Su quale riva della Moldava dormi decide ancora il viaggio.",
    heroIntro:
      "Praga infila un castello, un ponte medievale e una città vecchia perfettamente intatta in un centro che si attraversa a piedi in mezz'ora, e resta una delle capitali classiche più economiche d'Europa in cui dormire. Quale sponda del fiume scegli, e quale quartiere dietro di essa, continua a determinare il viaggio: vicoli da cartolina e folla, la calma del lato castello, oppure una base locale più economica a una fermata di tram di distanza. Questa guida pesa cinque quartieri che vale la pena prenotare, così puoi organizzare le grandi attrazioni intorno alle ondate dei gruppi turistici, invece di scontrarti con loro.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Ciottoli, guglie e vicoli che finiscono in cortili riempiono il nucleo medievale intorno alla Piazza della Città Vecchia, che di giorno diventa il chilometro quadrato più affollato di tutto il paese. Dopo le 22 i gruppi turistici si diradano in fretta e le strade tornano davvero silenziose. Prenota qui se il viaggio è breve e vuoi tutto ciò che cerca chi visita per la prima volta a dieci minuti a piedi, prezzi da turisti inclusi.",
      pros: [
        "Ponte Carlo, Piazza della Città Vecchia e Josefov sono tutti a pochi passi",
        "La scelta più ampia di hotel e appartamenti della città",
        "Nessun mezzo pubblico necessario per una visita di due giorni",
      ],
      cons: [
        "I ristoranti sulla piazza principale hanno prezzi pensati per i turisti, non per i locali",
        "Le notti del weekend portano rumore in strada e gruppi di addio al celibato",
        "Le camere costano dal 20 al 30 percento in più rispetto allo stesso standard a Vinohrady",
      ],
    },
    {
      slug: "mala-strana",
      ...
      vibe: "Tetti rossi, giardini delle ambasciate e vicoli barocchi riempiono questo quartiere sotto il castello, sulla riva ovest della Moldava, che si svuota completamente quando i visitatori di giornata tornano oltre il fiume nel tardo pomeriggio. Dormire qui vuol dire svegliarsi sul lato del castello, un vero vantaggio di tempistica per le grandi attrazioni. Prenota qui se vuoi un Ponte Carlo vuoto all'alba e serate tranquille più che la vicinanza ai ristoranti della città vecchia.",
      pros: [
        "Castello di Praga, collina di Petrin e Muro di Lennon sono tutti a due passi",
        "Le serate diventano calme e davvero suggestive",
        "Ponte Carlo prima di colazione significa nessuna folla",
      ],
      cons: [
        "Meno supermercati e opzioni economiche per mangiare rispetto alla riva est",
        "Le strade ripide e acciottolate sono faticose con valigie o passeggino",
      ],
    },
    {
      slug: "vinohrady",
      ...
      vibe: "Palazzi Art Nouveau delimitano qui una griglia residenziale di piazze alberate, con la migliore concentrazione di caffè di tutta Praga. È qui che si stabiliscono davvero i locali che possono scegliere dove vivere, e la scena gastronomica lo dimostra. Prenota qui se vuoi le attrazioni della città vecchia a 10 minuti di metro senza pagare i prezzi della città vecchia per dormire.",
      pros: [
        "Il miglior cibo e caffè specialty della città a prezzi locali",
        "La birreria all'aperto di Riegrovy Sady più due grandi parchi",
        "Alloggi notevolmente più economici rispetto al centro",
      ],
      cons: [
        "Ogni attrazione principale richiede uno spostamento, anche se breve",
        "Tranquillo di notte, se cerchi vita notturna sotto casa",
      ],
    },
    {
      slug: "zizkov",
      ...
      vibe: "Più pub pro capite che in qualsiasi altro posto d'Europa danno a questo quartiere ruvido la sua reputazione, più trasandato della vicina Vinohrady e sorvegliato dalla torre della TV in stile spaziale. Birra economica e locali underground dominano ancora, anche se il quartiere si gentrifica isolato dopo isolato. Prenota qui se la base semi-centrale più economica conta più dell'eleganza, e non ti dispiace una camminata un po' più lunga fino alle attrazioni.",
      pros: [
        "I prezzi più bassi per camere e birra vicino al centro",
        "Vera cultura da pub, quasi senza sovrapprezzo turistico",
        "La collina di Vitkov regala una vista enorme e gratuita sulla città vecchia",
      ],
      cons: [
        "Alcuni isolati sembrano trascurati e pieni di graffiti",
        "20-30 minuti a piedi o in tram dalle attrazioni principali",
        "Le notti del weekend portano rumore dai bar sulle strade principali",
      ],
    },
    {
      slug: "karlin",
      ...
      vibe: "Ricostruito dopo l'alluvione del 2002, questo quartiere pianeggiante lungo il fiume è oggi il rione moderno più curato di Praga, con viali larghi e palazzi ottocenteschi ristrutturati. La scena di brunch e birre artigianali qui è pensata soprattutto per i residenti, non per i visitatori, e la città vecchia è a sole due fermate di metro. Prenota qui se strade pianeggianti e adatte ai passeggini e un'atmosfera moderna contano più che essere immersi nell'architettura medievale.",
      pros: [
        "Strade pianeggianti adatte ai passeggini e percorsi lungo il fiume",
        "Ottimi ristoranti cechi moderni a prezzi corretti",
        "Un collegamento veloce con il centro tramite la linea B della metro",
      ],
      cons: [
        "Nessuna attrazione principale nel quartiere stesso",
        "La vita notturna resta sottotono, con i bar che chiudono presto per gli standard di Praga",
      ],
    },
  ],
