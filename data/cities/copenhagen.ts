...
const copenhagen: CityData = {
  city: {
    ...
    tagline: "Five very different quarters, one bike ride apart: pick right and the trip follows.",
    heroIntro:
      "Copenhagen splits into pocket-sized quarters that barely resemble each other, so which one you sleep in decides whether the trip runs on royal squares, canal quiet or late kitchens. The old town puts every headline sight on foot but charges for it, Vesterbro and Nørrebro trade postcard views for the food locals actually eat, and Christianshavn floats somewhere calmer in between. This guide runs through all five so the bed you book matches the city you actually want.",
  ...
  neighborhoods: [
    ...
    },
    {
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "This is the view every visitor pictures before they land: a short 17th-century canal lined with painted gables, moored wooden boats and terrace bars stacked deep in summer. Sleeping this close puts the harbour and the royal quarter on your doorstep, though the water's edge itself turns loud and pricey once the sun is out. Book here if the canal view matters more than a quiet night, and you do not mind eating a street back.",
      pros: [
    ...
    },
    {
      ...
      vibe: "Once Copenhagen's red-light and meatpacking district, this quarter west of Central Station has turned into the sharpest food and nightlife pocket in the city. The old Kødbyen meat halls now hold natural-wine bars and bakeries where young locals, not tour groups, actually spend their evenings. Book here if you want real Copenhagen prices and a livelier night out, with Tivoli and the center still an easy walk away.",
      pros: [
