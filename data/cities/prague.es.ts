...
const pragueEs: CityData = {
  city: {
    ...
    tagline: "Qué orilla del Moldava eliges para dormir sigue decidiendo el viaje.",
    heroIntro:
      "Praga encaja un castillo, un puente medieval y un casco antiguo intacto en un centro que se cruza a pie en media hora, y sigue siendo una de las capitales clásicas más baratas de Europa para dormir. Qué lado del río, y qué barrio detrás de él, elijas sigue marcando el viaje: callejuelas de postal y multitudes, la calma del lado del castillo, o una base local más barata a un trayecto de tranvía. Esta guía pesa cinco barrios que merece la pena reservar para que puedas encajar los grandes monumentos entre las oleadas de grupos turísticos, en lugar de chocar con ellas.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Adoquines, agujas y callejuelas que terminan en patios interiores llenan el núcleo medieval alrededor de la plaza de la Ciudad Vieja, lo que la convierte en el kilómetro cuadrado más concurrido de todo el país durante el día. Después de las 22h los grupos turísticos desaparecen rápido y las calles se quedan de verdad tranquilas. Alójate aquí si es un viaje corto y quieres tener todo lo que busca un primerizo a diez minutos a pie, precios turísticos incluidos.",
      pros: [
        "El Puente de Carlos, la plaza de la Ciudad Vieja y Josefov, todos a poca distancia a pie",
        "La mayor oferta de hoteles y apartamentos de la ciudad",
        "No necesitas transporte público para una visita de dos días",
      ],
      cons: [
        "Los restaurantes de la plaza principal tienen precios para turistas, no para locales",
        "Las noches de fin de semana traen ruido de calle y grupos de despedidas de soltero",
        "Las habitaciones cuestan un 20 a 30 por ciento más que el mismo nivel en Vinohrady",
      ],
    },
    {
      slug: "mala-strana",
      ...
      vibe: "Tejados rojos, jardines de embajadas y callejuelas barrocas llenan este barrio bajo el castillo, en la orilla oeste del Moldava, que se vacía por completo cuando los excursionistas de un día cruzan de vuelta el río a última hora de la tarde. Dormir aquí significa despertarte en el lado del castillo, lo que se convierte en una auténtica ventaja de horarios para los grandes monumentos. Alójate aquí si prefieres un Puente de Carlos vacío a primera hora y noches tranquilas antes que la cercanía a los restaurantes del casco antiguo.",
      pros: [
        "El Castillo de Praga, la colina de Petrin y el muro de Lennon están a la puerta de casa",
        "Las noches se vuelven tranquilas y con ambiente de verdad",
        "El Puente de Carlos antes del desayuno significa cero multitudes",
      ],
      cons: [
        "Menos supermercados y opciones de comida económica que en la orilla este",
        "Las calles empinadas y adoquinadas cuestan con maletas o con un carrito de bebé",
      ],
    },
    {
      slug: "vinohrady",
      ...
      vibe: "Bloques de pisos modernistas bordean aquí una retícula residencial de plazas arboladas, con la mejor concentración de cafeterías de toda Praga. Es donde se instalan de verdad los praguenses que pueden elegir dónde vivir, y la escena de restaurantes lo demuestra. Alójate aquí si quieres los monumentos del casco antiguo a 10 minutos en metro sin pagar precios de casco antiguo para dormir.",
      pros: [
        "La mejor comida y el mejor café de especialidad de la ciudad, a precios locales",
        "La cervecería al aire libre de Riegrovy Sady más dos grandes parques",
        "Alojamiento notablemente más barato que el centro",
      ],
      cons: [
        "Cada gran monumento exige un desplazamiento, aunque sea corto",
        "Tranquilo de noche si lo que buscas es vida nocturna nada más salir por la puerta",
      ],
    },
    {
      slug: "zizkov",
      ...
      vibe: "Más pubs por habitante que en cualquier otro sitio de Europa le dan a este barrio de aristas su reputación, más desaliñado que la vecina Vinohrady y vigilado por la torre de televisión de aspecto futurista. La cerveza barata y los bares de mala muerte todavía dominan, aunque se aburguesa manzana a manzana. Alójate aquí si te importa más una base barata cerca del centro que el pulido, y no te molesta caminar un poco más hasta los monumentos.",
      pros: [
        "Los precios de habitación y de cerveza más bajos cerca del centro",
        "Cultura de pub auténtica, casi sin recargo turístico",
        "La colina de Vitkov regala una vista enorme y gratuita sobre el casco antiguo",
      ],
      cons: [
        "Algunas manzanas parecen descuidadas y cargadas de grafitis",
        "20 a 30 minutos a pie o en tranvía hasta los monumentos principales",
        "Las noches de fin de semana traen ruido de bares en las calles principales",
      ],
    },
    {
      slug: "karlin",
      ...
      vibe: "Reconstruido tras la inundación de 2002, este barrio llano junto al río es hoy el sector moderno más cuidado de Praga, con amplios bulevares y edificios del siglo XIX rehabilitados. La escena de brunch y cerveza artesanal aquí apunta directamente a los residentes, no a los visitantes, y el casco antiguo queda a solo dos paradas de metro. Alójate aquí si prefieres calles llanas, aptas para carritos, y un ambiente moderno antes que estar envuelto en arquitectura medieval.",
      pros: [
        "Calles llanas aptas para carritos y paseos junto al río",
        "Sólidos restaurantes checos modernos a precios justos",
        "Una conexión rápida al centro por la línea B de metro",
      ],
      cons: [
        "Ningún gran monumento dentro del propio barrio",
        "Vida nocturna discreta, con bares que cierran pronto para lo que es Praga",
      ],
    },
  ],
