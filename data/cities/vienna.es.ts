...
const viennaEs: CityData = {
  city: {
    ...
    tagline: "Cinco distritos, un mismo ring: dónde duermas decide lo imperial que se sienta el viaje.",
    heroIntro:
      "Las grandes atracciones de Viena se apiñan dentro de la Ringstrasse, pero los distritos que la rodean funcionan a ritmos completamente distintos, desde la elegancia imperial silenciosa hasta las tiendas de diseño y las tabernas de vino que siguen abiertas cuando los palacios ya duermen. Dónde duermas decide si el viaje se inclina hacia lo formal y céntrico o hacia lo local y más barato, a un trayecto de tranvía. Esta guía recorre los cinco distritos que merece la pena reservar, desde la puerta de la catedral hasta las calles más tranquilas al otro lado del Canal del Danubio.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Envuelto en torno a la catedral de San Esteban y la Hofburg dentro de la Ringstrasse, este primer distrito es el núcleo imperial: grandes bulevares, patios con arcadas y los cafés que todo el mundo imagina al pensar en Viena. Todo lo que pide una primera visita queda a quince minutos a pie, y las multitudes se disuelven rápido en cuanto las tiendas cierran por la tarde. Alójate aquí si la comodidad te importa más que el precio y quieres hacer todo el viaje imperial a pie.",
      pros: [
        "Catedral, Hofburg, Ópera Estatal y los grandes museos, todos a pie",
        "Todas las líneas de tranvía y metro convergen aquí, fácil para excursiones de un día",
        "Una visita de dos días no necesita transporte alguno",
      ],
      cons: [
        "El distrito más caro de la ciudad para hotel y para cenar",
        "Los restaurantes cerca de la catedral y el Graben viven de las vistas, no de la comida",
        "La vida nocturna se apaga en cuanto termina la cena",
      ],
    },
    {
      slug: "leopoldstadt",
      ...
      vibe: "Al otro lado del Canal del Danubio, este segundo distrito mezcla la enorme extensión verde del Prater con la vieja Viena judía, tiendas de alimentación turcas y balcánicas y una escena creativa en pleno crecimiento. El Karmelitermarkt ancla una escena gastronómica y de cafés que se siente de verdad local, no montada para visitantes. Alójate aquí si quieres espacio de parque y vida de barrio auténtica a una parada de metro de los palacios, a precios muy por debajo del centro.",
      pros: [
        "El parque Prater, la Riesenrad y largos paseos junto al canal, ideales para familias",
        "El Karmelitermarkt y el Volkertmarkt sirven comida local a precios justos",
        "Las rápidas líneas U1 y U2 dejan el centro a una sola parada",
      ],
      cons: [
        "Ningún gran monumento en el distrito más allá del propio Prater",
        "Las calles cerca de las estaciones pueden resultar anodinas y sin acabar",
        "Las noches son residenciales y tranquilas si buscas salir de fiesta",
      ],
    },
    {
      slug: "neubau",
      ...
      vibe: "Detrás del MuseumsQuartier, este séptimo distrito es donde de verdad vive el mundillo del diseño vienés: las callejuelas adoquinadas Biedermeier de Spittelberg albergan tabernas de vino y boutiques, mientras que la Neubaugasse enhebra concept stores, tostadores de café y bares pequeños. Se llega a pie a los grandes museos y, aun así, se siente como las tardes que los locales eligen para sí mismos. Alójate aquí si quieres estar cerca de las grandes atracciones sin dormir dentro de una postal.",
      pros: [
        "El MuseumsQuartier y el Kunsthistorisches Museum a un corto paseo",
        "Las mejores tiendas independientes, tostadores de café y restaurantes de raciones de la ciudad",
        "Una animada y nada pretenciosa escena de bares y tabernas de vino al caer la noche",
      ],
      cons: [
        "Un paseo o un corto trayecto en tranvía te separa de las atracciones del primer distrito",
        "Las manzanas más populares se ponen ruidosas las noches de fin de semana",
        "Menos hoteles grandes; predominan los apartamentos y los alojamientos boutique",
      ],
    },
    {
      slug: "mariahilf",
      ...
      vibe: "El sexto distrito discurre a lo largo de la Mariahilfer Strasse, la calle comercial más transitada de la ciudad, con el extenso Naschmarkt anclando su extremo inferior. Equilibra lo práctico con lo genuino: hoteles fiables de gama media en la parte alta, puestos de comida y mercadillo de los sábados junto al mercado en la parte baja. Alójate aquí si quieres una relación calidad-precio segura y un trayecto directo de quince minutos a pie o dos paradas de metro hasta el centro.",
      pros: [
        "Los puestos de comida del Naschmarkt y el mercadillo de los sábados cerca",
        "La mayor variedad de hoteles sólidos de gama media y económicos",
        "Acceso directo por la U3 y una ruta peatonal hasta el centro",
      ],
      cons: [
        "La calle comercial principal se satura y pierde encanto en horas punta",
        "Menos carácter que Neubau, cuesta arriba",
        "Los restaurantes del Naschmarkt cuestan más de lo que sugiere la fama de sus puestos de comida",
      ],
    },
    {
      slug: "landstrasse",
      ...
      vibe: "Al sureste del ring, este tercer distrito envuelve el palacio Belvedere y sus jardines formales, con la Hundertwasserhaus y el Rochusmarkt completando un tramo tranquilo y residencial. Aquí está también Wien Mitte, así que el tren del aeropuerto llega más rápido que a cualquier otro punto de la ciudad. Alójate aquí si quieres el Belvedere y el ring a distancia caminable por menos que las tarifas del primer distrito.",
      pros: [
        "El palacio Belvedere, sus jardines y El beso de Klimt a unos minutos",
        "Wien Mitte ofrece la conexión al aeropuerto más rápida de la ciudad",
        "Más tranquilo y más barato que el centro, y aun así a distancia caminable de él",
      ],
      cons: [
        "Lo bastante extenso como para que algunos hoteles queden a una caminata real de cualquier atracción",
        "Menos restaurantes destacados que en Neubau o Leopoldstadt",
        "Ningún núcleo animado único que sirva de ancla para una velada",
      ],
    },
  ],
