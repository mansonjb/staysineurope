...
const vienna: CityData = {
  city: {
    ...
    tagline: "Five districts, one ring: where you sleep decides how imperial the trip feels.",
    heroIntro:
      "Vienna's grandest sights cluster tightly inside the Ringstrasse, but the districts around it run at completely different speeds, from hushed imperial elegance to design shops and wine taverns that stay open past the palaces' bedtime. Where you sleep decides whether the trip leans formal and central or local and cheaper a tram ride out. This guide walks through all five districts worth booking, from the cathedral doorstep to the calmer streets across the Danube Canal.",
