...
const copenhagenDe: CityData = {
  city: {
    ...
    tagline: "Fünf sehr unterschiedliche Viertel, nur eine Radfahrt voneinander entfernt: Die richtige Wahl entscheidet die ganze Reise.",
    heroIntro:
      "Kopenhagen gliedert sich in kompakte Viertel, die einander kaum ähneln, sodass die Wahl Ihrer Unterkunft entscheidet, ob die Reise auf königlichen Plätzen, an ruhigen Kanälen oder in späten Küchen stattfindet. Die Altstadt bringt jede Top-Sehenswürdigkeit in Gehweite, lässt sich das aber bezahlen, Vesterbro und Nørrebro tauschen Postkartenblicke gegen das Essen, das Einheimische tatsächlich essen, und Christianshavn treibt irgendwo ruhiger dazwischen. Dieser Leitfaden geht alle fünf Viertel durch, damit das gebuchte Bett zu der Stadt passt, die Sie wirklich wollen.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Dieser mittelalterliche Kern liegt zwischen Strøget, den Schlössern und den Kanälen, mit fast jeder Top-Sehenswürdigkeit in zehn Gehminuten. Tagsüber ist er dicht und ansehnlich, ruhiger sobald die Läden schließen, und stellt Sie zu Fuß an den Runden Turm, Rosenborg und Nyhavn. Buchen Sie hier, wenn die Reise kurz ist und Sie lieber für Bequemlichkeit zahlen als für ein größeres Zimmer.",
      pros: [
        "Runder Turm, Rosenborg, Strøget und Nyhavn alle zu Fuß erreichbar",
        "Beste straßenbahnfreie Begehbarkeit und Metro-Anbindung der Stadt",
        "Ein zweitägiger Besuch lässt sich komplett zu Fuß bewältigen",
      ],
      cons: [
        "Die Zimmerpreise liegen an der Spitze der Stadt",
        "Die Hauptstraßen verlangen einen Touristenaufschlag auf Essen und Trinken",
        "Weniger Nachbarschaftsrestaurants als Nørrebro oder Vesterbro",
      ],
    },
    {
      slug: "nyhavn",
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "Das ist der Anblick, den sich jeder Besucher schon vor der Landung vorstellt: ein kurzer Kanal aus dem 17. Jahrhundert, gesäumt von bemalten Giebelhäusern, vertäuten Holzbooten und im Sommer dicht gedrängten Terrassenbars. Wer so nah schläft, hat den Hafen und das königliche Viertel direkt vor der Tür, auch wenn das Ufer selbst laut und teuer wird, sobald die Sonne scheint. Buchen Sie hier, wenn Ihnen der Kanalblick wichtiger ist als eine ruhige Nacht, und es Sie nicht stört, eine Straße weiter zu essen.",
      pros: [
        "Übernachten direkt am meistfotografierten Kanal der Stadt",
        "Königliches Viertel, Amalienborg und die Kanalboot-Anleger nur einen kurzen Spaziergang entfernt",
        "Gut angebunden mit Metro und Hafenbussen",
      ],
      cons: [
        "Die Restaurants am Wasser verlangen kräftig für die Aussicht",
        "Sommerabende bringen Lärm und Menschenmengen direkt vor die Tür",
        "Günstige Zimmer sind so nah am Kanal rar",
      ],
    },
    {
      slug: "vesterbro",
      ...
      vibe: "Einst Kopenhagens Rotlicht- und Schlachthofviertel, hat sich dieses Quartier westlich des Hauptbahnhofs zur schärfsten Gastronomie- und Nachtlebenecke der Stadt entwickelt. In den alten Kødbyen-Fleischhallen sitzen heute Naturweinbars und Bäckereien, in denen junge Einheimische, nicht Reisegruppen, tatsächlich ihre Abende verbringen. Buchen Sie hier, wenn Sie echte Kopenhagener Preise und ein lebendigeres Nachtleben wollen, wobei Tivoli und das Zentrum immer noch bequem zu Fuß erreichbar sind.",
      pros: [
        "Beste Gastronomie- und Nachtlebenszene fürs Geld",
        "Kødbyen-Bars und Hauptbahnhof beide in der Nähe",
        "Ein bequemer Fußweg zum Tivoli und ins Stadtzentrum",
      ],
      cons: [
        "Ein paar Straßen wirken spät nachts noch ruppig",
        "Kein Kanal und keine Wahrzeichen im Viertel selbst",
        "Die Nachtlebenblöcke bleiben nach Einbruch der Dunkelheit laut",
      ],
    },
    {
      slug: "norrebro",
      ...
      vibe: "Nördlich der Seen ist dies das jüngste und gemischteste Viertel der Stadt, verankert im bunten Superkilen-Park und den Cafés entlang der Jægersborggade. Die Nachbarschafts-Gastronomieszene hier lebt von Bäckereien und nahöstlichen Grills statt Touristenmenüs, zu Preisen, die das Zentrum längst hinter sich gelassen hat. Buchen Sie hier, wenn Sie lieber wie ein Einheimischer essen und ein fünfzehnminütiger Fußweg oder eine kurze Busfahrt in die Altstadt Sie nicht stören.",
      pros: [
        "Günstigste Zimmer unter den halbwegs zentralen Vierteln",
        "Starke unabhängige Gastronomieszene mit geringem Touristenaufschlag",
        "Superkilen, der Assistens-Friedhof und die Jægersborggade in der Nähe",
      ],
      cons: [
        "Von diesen fünf Vierteln am weitesten von den Hafensehenswürdigkeiten entfernt",
        "Weitläufig genug, dass Sie auf Räder oder Busse angewiesen sind",
        "Die Metro-Abdeckung ist lückenhaft, auch wenn Busse häufig fahren",
      ],
    },
    {
      slug: "christianshavn",
      ...
      vibe: "Von Christian IV. angelegt, mischt dieses von Kanälen durchzogene Inselviertel Hausboote und gepflasterte Kais mit der Freistadt Christiania direkt an seinem Rand. Es tauscht die Geschäftigkeit der Altstadt gegen etwas Wohnlicheres, bleibt aber nur eine Metro-Station oder einen Hafenspaziergang vom Zentrum entfernt. Buchen Sie hier, wenn Sie Wasserblick und ruhige Nächte wollen, ohne auf einen einfachen Weg zu allem anderen zu verzichten.",
      pros: [
        "Kanäle und Hausboote abseits der Menschenmengen",
        "Eine Metro-Station oder ein Fußweg vom Zentrum entfernt, mit Christiania direkt nebenan",
        "Echte lokale Cafés und die Hafenfront zu Fuß",
      ],
      cons: [
        "Weniger Hotels, sodass Auswahl und Verfügbarkeit knapper sind",
        "Ein ruhigeres Nachtleben als Vesterbro oder Nørrebro",
