...
const viennaIt: CityData = {
  city: {
    ...
    tagline: "Cinque quartieri, un anello: dove dormi decide quanto il viaggio sa d'impero.",
    heroIntro:
      "Le mete più maestose di Vienna si concentrano dentro la Ringstrasse, ma i quartieri attorno corrono a velocità completamente diverse, dall'eleganza imperiale silenziosa ai negozi di design e alle osterie di vino che restano aperte ben oltre l'orario dei palazzi. Dove dormi decide se il viaggio pende verso il formale e centrale o verso il locale ed economico, a una fermata di tram di distanza. Questa guida attraversa tutti e cinque i quartieri che vale la pena prenotare, dalla soglia del duomo alle strade più tranquille oltre il Canale del Danubio.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Avvolto attorno al Duomo di Santo Stefano e all'Hofburg dentro la Ringstrasse, questo primo distretto è il nucleo imperiale: grandi viali, cortili con portici e i caffè storici che tutti immaginano quando pensano a Vienna. Tutto ciò che serve a una prima visita sta entro un quarto d'ora a piedi, e le folle si diradano in fretta appena i negozi chiudono per la sera. Prenota qui se la comodità conta più del prezzo e vuoi l'intero viaggio imperiale a portata di piedi.",
      pros: [
        "Duomo, Hofburg, Opera di Stato e i musei principali tutti a portata di piedi",
        "Qui convergono tutte le linee di tram e metro, comodo per le gite fuori porta",
        "Per una visita di due giorni non serve alcun mezzo pubblico",
      ],
      cons: [
        "Il distretto più caro della città per hotel e cena",
        "I ristoranti vicino al duomo e al Graben vivono di vista, non di cucina",
        "La vita notturna si assottiglia appena finisce la cena",
      ],
    },
    {
      slug: "leopoldstadt",
      ...
      vibe: "Oltre il Canale del Danubio, questo secondo distretto unisce la distesa verde del Prater alla vecchia Vienna ebraica, a drogherie turche e balcaniche e a una folla creativa in rapida crescita. Il Karmelitermarkt fa da ancora a una scena gastronomica e di caffè genuinamente locale, non costruita per i visitatori. Prenota qui se vuoi spazio verde e vita di quartiere autentica a una fermata di metro dai palazzi, a prezzi ben sotto quelli del centro.",
      pros: [
        "Il parco del Prater, la Riesenrad e lunghi sentieri lungo il canale, ideali per le famiglie",
        "Karmelitermarkt e Volkertmarkt offrono cibo locale a prezzi giusti",
        "Rapidi collegamenti U1 e U2 tengono il centro a una sola fermata",
      ],
      cons: [
        "Nessuna grande attrazione nel distretto a parte il Prater stesso",
        "Le strade vicino alle stazioni possono sembrare anonime e incompiute",
        "Le sere restano residenziali e tranquille, se cerchi vita notturna",
      ],
    },
    {
      slug: "neubau",
      ...
      vibe: "Dietro il MuseumsQuartier, questo settimo distretto è dove vive davvero la scena del design di Vienna: i vicoli acciottolati Biedermeier di Spittelberg custodiscono osterie di vino e boutique, mentre la Neubaugasse allinea concept store, torrefazioni e piccoli bar. Resta a portata di piedi dai grandi musei, eppure sa di serate che i locali scelgono per sé. Prenota qui se vuoi stare vicino alle grandi attrazioni senza dormire dentro una cartolina.",
      pros: [
        "MuseumsQuartier e Kunsthistorisches Museum a pochi passi",
        "I migliori negozi indipendenti, torrefazioni e cucina di piccoli piatti della città",
        "Una scena di bar e osterie di vino vivace e senza pretese dopo il tramonto",
      ],
      cons: [
        "Una camminata o un breve tram ti separano dalle attrazioni del primo distretto",
        "Gli isolati più frequentati diventano rumorosi nelle sere del weekend",
        "Pochi grandi hotel, soprattutto appartamenti e strutture boutique",
      ],
    },
    {
      slug: "mariahilf",
      ...
      vibe: "Il sesto distretto corre lungo la Mariahilfer Strasse, la via dello shopping più trafficata della città, con l'ampio Naschmarkt ad ancorarne l'estremità inferiore. Bilancia il pratico e il caratteristico: hotel di fascia media affidabili in alto, bancarelle di cibo e mercatino delle pulci del sabato giù verso il mercato. Prenota qui se cerchi un buon rapporto qualità-prezzo e un quarto d'ora a piedi in linea retta, o due fermate di metro, dal centro.",
      pros: [
        "Le bancarelle del Naschmarkt e il mercatino delle pulci del sabato a due passi",
        "La scelta più ampia di solidi hotel di fascia media ed economica",
        "Accesso diretto alla U3 e un percorso pedonale verso il centro",
      ],
      cons: [
        "La via dello shopping principale diventa affollata e senza fascino nelle ore di punta",
        "Meno carattere di Neubau, poco più su",
        "I ristoranti del Naschmarkt costano più di quanto suggerisca la fama delle bancarelle",
      ],
    },
    {
      slug: "landstrasse",
      ...
      vibe: "A sud-est dell'anello, questo terzo distretto avvolge il palazzo del Belvedere e i suoi giardini all'italiana, con la Hundertwasserhaus e il Rochusmarkt a completare un tratto calmo e residenziale. Ospita anche Wien Mitte, quindi il treno per l'aeroporto arriva qui più in fretta che in qualsiasi altro punto della città. Prenota qui se vuoi il Belvedere e l'anello a portata di piedi, a prezzi inferiori a quelli del primo distretto.",
      pros: [
        "Il palazzo del Belvedere, i suoi giardini e Il Bacio di Klimt a pochi minuti",
        "Wien Mitte offre il collegamento più rapido all'aeroporto della città",
        "Più tranquillo ed economico del centro, pur restando raggiungibile a piedi",
      ],
      cons: [
        "Abbastanza esteso da far sì che alcuni hotel distino una vera camminata da qualunque attrazione",
        "Meno ristoranti di spicco rispetto a Neubau o Leopoldstadt",
        "Nessun unico cuore vivace attorno a cui costruire la serata",
      ],
    },
  ],
