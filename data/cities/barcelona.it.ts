...
const barcelonaIt: CityData = {
  city: {
    ...
    tagline: "Dove dormi decide se la tua Barcellona corre sui vicoli gotici, sulla griglia di Gaudi o sulla sabbia.",
    heroIntro:
      "Barcellona racchiude i capolavori modernisti di Gaudi, un centro storico medievale e una spiaggia cittadina in un centro abbastanza piccolo da girare a piedi, con la metro che copre il resto. Dove scegli di dormire decide quale versione della città ti ritrovi ogni mattina: vicoli gotici economici, un angolo elegante del centro storico, l'ordinata griglia di Gaudi, una piazza di quartiere quasi da paese, o la sabbia fuori dalla porta. Questa guida mette a confronto cinque quartieri che vale la pena prenotare e indica i compromessi che ciascuno ti chiede di accettare.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Qui i vicoli di pietra si snodano tra la cattedrale e La Rambla, aprendosi su piazze nascoste in un labirinto che resta ancora oggi il cuore medievale della città. Tutto ciò che cerca chi visita Barcellona per la prima volta sta entro dieci minuti a piedi, e le strade diventano davvero suggestive quando le folle diurne si diradano dopo il tramonto. Prenota qui se budget e vicinanza contano più di una notte tranquilla, e tieni d'occhio la borsa, perché è anche il quartiere più battuto dai borseggiatori della città.",
      pros: [
        "Raggiungi a piedi la cattedrale, La Rambla, il porto ed El Born",
        "Pieno di bar di tapas economici, caffè e piccoli hotel",
        "Vicoli che si svuotano e si illuminano dopo cena",
      ],
      cons: [
        "La zona più colpita dai borseggi della città, peggio vicino a La Rambla",
        "Viavai di gente e rumore dei bar fino a tardi, difficile per chi ha il sonno leggero",
        "Alcuni ristoranti nelle piazze principali vivono di posizione più che di cucina",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Appena a est del nucleo gotico, qui i vicoli medievali avvolgono la chiesa di Santa Maria del Mar e il Museo Picasso, costeggiati da boutique, wine bar e cocktail bar. Resta vivace dopo il tramonto senza scivolare nella trappola per turisti, portando l'atmosfera del centro storico con un tocco più adulto e attento al design. Prenota qui se vuoi l'atmosfera del centro storico con cibo e drink migliori, e non ti dispiace pagare un po' di più.",
      pros: [
        "La miglior concentrazione di wine bar, cocktail bar e tapas del centro storico",
        "A due passi dal Museo Picasso, Santa Maria del Mar e il parco della Ciutadella",
        "Vicoli acciottolati che restano vivaci pur conservando un carattere locale e da boutique",
      ],
      cons: [
        "Le sere del weekend i vicoli principali diventano rumorosi",
        "Nessuna fermata di metro dentro il quartiere, anche se Jaume I e Barceloneta sono vicine",
        "Le tariffe degli hotel sono più alte che nel vicino quartiere gotico",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "Ampi viali ottocenteschi e angoli smussati definiscono questa griglia, sede della più densa concentrazione di facciate moderniste della città lungo il Passeig de Gracia. Ti mette a breve distanza a piedi da Casa Batllo, La Pedrera e Sagrada Familia, tutte su una rete di metro ben collegata. Prenota qui se vuoi stare centrale e ordinato senza la calca del centro storico, soprattutto per una prima visita incentrata su Gaudi.",
      pros: [
        "Raggiungi a piedi le case di Gaudi sul Passeig de Gracia, e la Sagrada Familia è vicina",
        "Una fitta rete di metro con collegamenti diretti al treno per l'aeroporto e oltre",
        "Strade ampie che di notte si fanno silenziose, più una buona offerta di hotel di fascia media",
      ],
      cons: [
        "Sembra più funzionale che romantico rispetto ai vicoli del centro storico",
        "Dormire proprio sul Passeig de Gracia costa un sovrapprezzo",
        "Alcuni isolati sono a una lunga camminata rettilinea dalla spiaggia o dal porto",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "Questo ex villaggio, inghiottito dalla città a nord dell'Eixample, ha conservato la sua struttura fatta di piazza in piazza e una forte identità locale. Negozi indipendenti, bar bohémien e cucine a gestione familiare circondano piazze dove la gente del posto beve all'aperto nelle sere calde, con il Park Guell su per la collina sopra a tutto. Prenota qui se preferisci rientrare in un vero quartiere anziché in una cartolina, e puoi convivere con un tragitto di 20 minuti verso il centro storico.",
      pros: [
        "Vita di quartiere autentica, con piazze piene di gente del posto anziché di gruppi turistici",
        "Ristorazione dal miglior rapporto qualità-prezzo e una scena di bar senza pretese",
        "Raggiungi a piedi il Park Guell, con la metro per tutto il resto",
      ],
      cons: [
        "A 20-25 minuti a piedi o in metro dal centro storico e dalla spiaggia",
    ...
    },
    {
      ...
      vibe: "Incastrato tra il porto e la spiaggia cittadina, questo antico quartiere di pescatori è una fitta griglia di isolati stretti che si apre direttamente sulla sabbia. Ha molto carattere di giorno, con ristoranti di pesce e il lungomare proprio fuori dalla porta, e i bar sul mare lo tengono animato fino a tardi nelle notti d'estate. Prenota qui se la spiaggia è il vero scopo del viaggio, non un'aggiunta del pomeriggio.",
      pros: [
        "A pochi passi dalla spiaggia cittadina e dal lungomare, senza bisogno di mezzi",
        "Una fermata di metro sulla linea L4, a un paio di fermate dal centro storico",
        "Bar di pesce e vermut genuini a una via dall'acqua",
      ],
      cons: [
        "I ristoranti sul lungomare tendono alla trappola per turisti, meglio mangiare una via più all'interno",
        "Gli appartamenti sono angusti e caldi d'estate, con rumore vicino ai bar della spiaggia",
        "Una camminata o una corsa in metro ti separa dalle attrazioni di Gaudi su nell'Eixample",
      ],
    },
  ],
