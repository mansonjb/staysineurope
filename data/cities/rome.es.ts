...
const romeEs: CityData = {
  city: {
    ...
    tagline: "Las ruinas antiguas llenan cada vista, pero el lado del Tíber en el que duermes decide si la ciudad se siente cercana o interminable.",
    heroIntro:
      "Roma reparte ruinas antiguas, el Vaticano y algunas de las mejores mesas al aire libre de Europa por un centro que se recorre a pie por tramos, pero nunca en un único circuito fácil, así que el barrio que elijas decide cuánto de cada día se va en llegar en vez de en ver. Esta guía compara las cinco zonas que merece la pena reservar, desde el Centro Storico con precio de postal hasta el Prati, más tranquilo y con mejor relación calidad-precio, junto al Vaticano, y nombra el hotel que se gana su tarifa en cada una.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Un laberinto de callejones ocres tendidos entre el Panteón, Piazza Navona y la Fontana di Trevi, del tipo que desemboca en una plaza barroca cada pocos pasos. Todo lo que necesita una primera visita cabe en un cuarto de hora a pie, y en cuanto los grupos de autocares se marchan después de cenar, esas mismas calles se vuelven silenciosas y de verdad hermosas. Resérvalo aquí si el viaje es corto y quieres todos los grandes atractivos, más esa calma nocturna, sin abrir nunca un mapa.",
      pros: [
        "El Panteón, Trevi, Navona y la Plaza de España, todos dentro de un mismo circuito a pie",
        "Se vuelve tranquilo y con ambiente en cuanto se marchan los autocares de excursión por la tarde",
        "Un café, una gelatería o un bar de aperitivo en casi cada esquina",
      ],
      cons: [
        "Las tarifas de hotel más altas de toda la ciudad",
        "Ninguna línea de metro lo atraviesa, así que vas a pie o en autobús",
        "Denso en gentío y ruido en torno a los grandes atractivos todo el día",
      ],
    },
    {
      slug: "monti",
      ...
      vibe: "Encajado entre el Coliseo y Termini, este rincón fue antaño el barrio rojo de la ciudad y hoy es su esquina más habitada: percheros vintage, bares de vino e hiedra sobre los callejones en torno a Piazza della Madonna dei Monti. Por la noche salen los vecinos a beber en los escalones de la fuente, no grupos turísticos cumpliendo una lista. Resérvalo aquí para tener la Roma antigua a un paseo, a una fracción del precio y del tráfico de autocares del casco antiguo.",
      pros: [
        "Diez minutos a pie cubren tanto el Coliseo como el Foro",
        "Estación Cavour en la línea B de metro, con las conexiones de Termini muy cerca",
        "Bares de vino y enotecas que se llenan de vecinos, no de visitantes",
      ],
      cons: [
        "Algunas calles hacia Termini se ven descuidadas al caer la noche",
        "Los bares más concurridos se derraman ruidosos a la calle las noches de fin de semana",
        "Los pequeños alojamientos boutique y los apartamentos superan en número a los hoteles de cadena",
      ],
    },
    {
      slug: "trastevere",
      ...
      vibe: "Una maraña de callejones adoquinados al otro lado del Tíber, cubiertos de hiedra y ropa tendida de día, y convertidos en el barrio más animado de la ciudad para cenar y tomar algo en cuanto se pone el sol. Las mesas se extienden por la acera frente a cada trattoria, y los bares que rodean Piazza di Santa Maria siguen abiertos bien pasada la medianoche. Resérvalo aquí si quieres comer y beber bien después de anochecer y puedes desconectar del ruido de fin de semana una vez de vuelta en la habitación.",
      pros: [
        "La mayor concentración de trattorias de verdad y de ambiente nocturno de Roma",
        "Un corto paseo cruzando el río hasta el centro y el Gueto judío",
        "Callejones adoquinados que mejor quedan en foto en la calma de primera hora de la mañana",
      ],
      cons: [
        "Las noches de fin de semana son ruidosas hasta bien pasada la medianoche, duro para quien tiene el sueño ligero",
        "Ninguna estación de metro en absoluto, solo tranvías, autobuses o tus propios pies",
        "Algunos restaurantes de la plaza principal viven de la dirección, no de la comida",
      ],
    },
    {
      slug: "prati",
      ...
      vibe: "Amplios bulevares ordenados trazados en cuadrícula junto al Vaticano, flanqueados por tiendas elegantes y cocinas fiables que ven muchos menos turistas que el casco histórico. Deja San Pedro y los Museos Vaticanos a un paseo fácil sin dejar de sentirse un barrio residencial corriente. Resérvalo aquí si quieres el Vaticano a pie, una línea de metro a todo lo demás, y precios de hotel por debajo de los del centro.",
      pros: [
        "San Pedro y los Museos Vaticanos, ambos a un paseo fácil, por delante de los grupos de autocares",
        "Dos paradas en la línea A de metro llegan directas a Termini y a la Plaza de España",
        "Hoteles con mejor relación calidad-precio y cocinas que se saltan el recargo turístico",
      ],
      cons: [
        "La oferta de bares y vida nocturna se reduce en cuanto cierran las tiendas",
        "Un paseo de 20 a 25 minutos o un cambio de metro desde el lado del Coliseo",
        "Se siente más práctico que romántico frente al casco antiguo",
      ],
    },
    {
      slug: "testaccio",
      ...
      vibe: "Construido en torno al antiguo matadero al sur del centro, este barrio obrero es donde la cucina povera romana, casquería incluida, se sigue cocinando a la manera de siempre. Su mercado cubierto y sus trattorias sin pretensiones atraen a comensales serios, no a turistas de paso, y las discotecas excavadas en la ladera del Monte Testaccio sostienen la vida nocturna después de cenar. Resérvalo aquí si comer bien a precio local te importa más que las vistas, y no te molesta desplazarte hasta los grandes atractivos.",
      pros: [
        "Algunas de las comidas más auténticas y con mejor relación calidad-precio de toda Roma",
        "Estación Piramide en la línea B de metro, a pocas paradas del Coliseo",
        "Un ambiente residencial de verdad, casi sin recargo turístico",
      ],
      cons: [
        "Pocos atractivos convencionales, es un barrio para comer, no para visitar",
        "20 minutos o más a pie o en metro desde el casco histórico",
