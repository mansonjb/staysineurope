...
const prague: CityData = {
  city: {
    ...
    tagline: "Which bank of the Vltava you sleep on still decides the trip.",
    heroIntro:
      "Prague fits a castle, a medieval bridge and a fully intact old town into a center you can cross on foot in half an hour, and it stays one of the cheapest classic capitals in Europe to sleep in. Which side of the river, and which district behind it, you choose still shapes the trip: postcard lanes and crowds, castle-side calm, or a cheaper local base a tram ride out. This guide weighs five neighborhoods worth booking so you can time the big sights around the tour-group waves rather than against them.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Cobbles, spires and lanes that dead-end into courtyards fill the medieval core around Old Town Square, making it the busiest square kilometer in the whole country by day. After 10pm the tour groups clear out fast and the streets turn properly quiet. Book here if this is a short trip and you want everything a first-timer wants within ten minutes on foot, tourist prices included.",
      pros: [
    ...
    },
    {
      ...
      vibe: "More pubs per capita than anywhere else in Europe give this rough-edged district its reputation, scruffier than Vinohrady next door and watched over by the space-age TV tower. Cheap beer and dive bars still dominate, even as it gentrifies block by block. Book here if the cheapest near-central base matters more than polish, and you don't mind a slightly longer walk to the sights.",
      pros: [
