...
const lisbonDe: CityData = {
  city: {
    ...
    tagline: "Sieben Hügel und ein Fluss, und ob Sie sie erklimmen oder umgehen, entscheidet sich danach, wo Sie schlafen.",
    heroIntro:
      "Lissabon teilt sich scharf in das flache, mit Trams erschlossene Raster der Innenstadt und die steilen Hügelviertel drumherum, sodass das Viertel, das Sie buchen, darüber entscheidet, wie viel jedes Tages aufs Gehen und wie viel aufs Klettern entfällt. Dieser Guide vergleicht die fünf Viertel, in denen sich eine Unterkunft lohnt, von den gefliesten Treppen Alfamas bis zur Flussruhe von Belém, und nennt für jedes das Hotel, das seinen Preis wert ist.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Steile Steintreppen winden sich vorbei an Wäscheleinen zwischen gefliesten Fassaden, vom Flussufer hinauf zu den Burgmauern. Nach Einbruch der Dunkelheit dringt Fado aus winzigen Tascas, und sobald die Reisegruppen abgezogen sind, legt sich über die Gassen eine Ruhe, die eher an ein Fischerdorf erinnert als an eine Hauptstadt. Buchen Sie hier für Burg, Kathedrale und die besten Aussichtspunkte, alle in steilem Fußweg erreichbar, und akzeptieren Sie, dass jeder Gang zum Laden einen Hügel bedeutet.",
      pros: [
        "Burg, Kathedrale und die besten Aussichtspunkte der Stadt zu Fuß erreichbar",
        "Fado-Häuser und familiengeführte Tascas ersetzen nach Einbruch der Dunkelheit die Touristenmeile",
        "Die Gassen wirken echt bewohnt und fotogen, bevor die Tagesbesucher eintreffen",
      ],
      cons: [
        "Steile Kopfsteinpflastergassen machen Rollkoffer zur Qual und sind bei eingeschränkter Mobilität schwer zu bewältigen",
        "Keine Metrostation im Viertel selbst, Trams, Busse oder Treppen sind die einzigen Wege nach oben",
        "Die Hauptgassen verstopfen tagsüber mit Reisegruppen",
      ],
    },
    {
      slug: "baixa-chiado",
      ...
      vibe: "Nach dem Erdbeben von 1755 auf einem strengen Raster wiederaufgebaut, ist dies der einzige wirklich flache Abschnitt im Zentrum Lissabons, der von der Praça do Comércio hinauf durch die Ladenfronten und Cafés des Chiado verläuft. Drei Metrolinien, die Tramrouten und das Fährterminal treffen sich alle innerhalb dieser Blocks, sodass nichts in der Stadt mehr als ein Umsteigen entfernt liegt. Buchen Sie hier, wenn die Reise kurz oder das Programm dicht ist, denn jedes hügelige Viertel auf dieser Liste beginnt seinen Spaziergang direkt vor dieser Tür.",
      pros: [
        "Der einzige ebene Boden im Zentrum Lissabons, am leichtesten für Beine und Gepäck",
        "Jede Metrolinie und Tramroute läuft hier zusammen, dazu das Fährterminal",
        "Die größte Auswahl an Hotels und Restaurants in jeder Preisklasse der Stadt",
      ],
      cons: [
        "Die Restaurants an den Hauptachsen kochen für Laufkundschaft statt für Geschmack",
        "Die Rua Augusta und die umliegenden Blocks bleiben tagsüber laut und überfüllt",
      ],
    },
    {
      slug: "principe-real",
      ...
      vibe: "Ein von einer riesigen Zeder beschatteter Gartenplatz bildet das Herz dieses gehobenen Viertels oberhalb des Bairro Alto, umringt von Stadthäusern aus dem 19. Jahrhundert, heute voller Concept Stores und Naturweinbars. Am Wochenende richtet sich auf dem Platz ein Biomarkt ein, und die Restaurantszene hier übertrifft still den Großteil der Innenstadt. Buchen Sie hier, wenn gutes Essen und ein ruhiger Abend Ihnen wichtiger sind als fünf Minuten zur nächsten Sehenswürdigkeit, und rechnen Sie an den meisten Abenden mit einem Anstieg zu Fuß oder einem kurzen Taxi.",
      pros: [
        "Einige der besten Restaurants und Weinbars der Stadt, bei einem Bruchteil des Andrangs der Innenstadt",
        "Bleibt nach Einbruch der Dunkelheit ruhig, obwohl die Barmeile des Bairro Alto nur zehn Minuten entfernt liegt",
        "Ein echtes Nachbarschaftsgefühl, mit einem Gartenplatz und Kioskcafés, die Einheimische tatsächlich nutzen",
      ],
      cons: [
        "Aus fast jeder Richtung geht es bergauf, planen Sie manche Abende ein Taxi ein",
        "Die Zimmer sind boutiquehaft und teuer, mit wenig Angebot für kleine Budgets",
        "Keine Metrostation im Viertel, die nächste, Rato, ist immer noch ein Fußweg entfernt",
      ],
    },
    {
      slug: "bairro-alto",
      ...
      vibe: "Tagsüber ist dieses Raster enger Gassen fast leer, nachts wird es zu Lissabons Open-Air-Kneipentour, bei der die Trinkenden weit über 2 Uhr hinaus auf dem Kopfsteinpflaster stehen. Die Bars sind winzig, das Bier ist billig, und es gibt keine Illusionen darüber, wofür das Viertel da ist. Buchen Sie hier nur, wenn Sie Teil des Lärms sein wollen statt hindurchschlafen zu wollen, denn die Straßen, die bis 10 Uhr morgens leer sind, stehen zwölf Stunden später Schulter an Schulter.",
      pros: [
        "Dutzende Bars in fünf Minuten Taumelweite, das dichteste Nachtleben der Stadt",
        "Liegt zentral zwischen Chiado und Principe Real, praktisch, sobald die Sonne untergeht",
        "Eine Handvoll wirklich günstiger Pensionen hat sich zwischen den Bars gehalten",
      ],
      cons: [
        "Der Straßenlärm am Wochenende hält bis nach 2 Uhr an, und Ohrstöpsel helfen nur bedingt",
        "Die Straßen sehen und riechen an den meisten Morgen ramponiert, die Aufräumarbeit der Nacht zuvor",
        "Die Baixa zu Fuß zu erreichen bedeutet ein steiles Gefälle, oder Sie warten auf die Standseilbahn Glória",
      ],
    },
    {
      slug: "belem",
      ...
      vibe: "Sechs Kilometer westlich am Tejo hat Portugal seine Denkmäler aus dem Zeitalter der Entdeckungen abgestellt: das Kloster, den Turm und eine Reihe moderner Museen entlang breiter, flacher, baumgesäumter Straßen. Tagesbesucher füllen das Viertel bis etwa 18 Uhr, dann leert es sich zu etwas, das eher einem Flussvorort als einer Hauptstadt gleicht. Buchen Sie hier, um Kloster und Turm zu erreichen, bevor die Reisebusse eintreffen, und um spürbar weniger fürs Zimmer zu zahlen, und akzeptieren Sie eine Tramfahrt, jedes Mal wenn Sie nach Einbruch der Dunkelheit in die Altstadt wollen.",
      pros: [
        "Das flachste und leichteste Gehen der Stadt, mit einem echten Uferweg",
        "Kloster, Turm und Museen in kurzer Gehdistanz, ruhig bevor die Reisebusse eintreffen",
        "Ruhigere Abende und niedrigere Hotelpreise als überall in der Altstadt",
      ],
      cons: [
        "Die Tram 15 ins Zentrum braucht 20 bis 30 Minuten und wird zu Stoßzeiten überfüllt",
        "Restaurants und Nachtleben dünnen schnell aus, sobald die Tagesbesucher gehen",
      ],
    },
  ],
