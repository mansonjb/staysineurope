...
const viennaDe: CityData = {
  city: {
    ...
    tagline: "Fünf Bezirke, ein Ring: Wo Sie schlafen, entscheidet, wie kaiserlich sich die Reise anfühlt.",
    heroIntro:
      "Wiens größte Sehenswürdigkeiten drängen sich dicht innerhalb der Ringstraße, doch die Bezirke ringsum schlagen völlig unterschiedliche Tempi an, von stiller kaiserlicher Eleganz bis zu Designläden und Weinlokalen, die noch geöffnet haben, wenn die Schlösser längst schlafen. Wo Sie schlafen, entscheidet, ob die Reise eher formell und zentral ausfällt oder lokal und günstiger, eine Straßenbahnfahrt weiter draußen. Dieser Guide führt durch alle fünf buchenswerten Bezirke, von der Domschwelle bis zu den ruhigeren Straßen jenseits des Donaukanals.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Rund um den Stephansdom und die Hofburg innerhalb der Ringstraße gelegen, ist dieser erste Bezirk der kaiserliche Kern: prächtige Boulevards, Arkadenhöfe und die Kaffeehäuser, die jeder vor Augen hat, wenn er an Wien denkt. Alles, was ein Erstbesuch will, liegt in fünfzehn Gehminuten, und die Menschenmengen verschwinden rasch, sobald abends die Geschäfte schließen. Buchen Sie hier, wenn Ihnen Bequemlichkeit wichtiger ist als der Preis und Sie die ganze kaiserliche Reise zu Fuß erleben wollen.",
      pros: [
        "Dom, Hofburg, Staatsoper und die Hauptmuseen alle zu Fuß erreichbar",
        "Jede Straßenbahn- und U-Bahn-Linie trifft sich hier, ideal für Tagesausflüge",
        "Für einen Zweitagesbesuch braucht es überhaupt keine öffentlichen Verkehrsmittel",
      ],
      cons: [
        "Der teuerste Bezirk der Stadt für Hotels und Abendessen",
        "Restaurants nahe dem Dom und am Graben leben von der Aussicht, nicht vom Essen",
        "Das Nachtleben dünnt aus, sobald das Abendessen vorbei ist",
      ],
    },
    {
      slug: "leopoldstadt",
      ...
      vibe: "Jenseits des Donaukanals verbindet dieser zweite Bezirk die grüne Weite des Praters mit dem alten jüdischen Wien, türkischen und balkanischen Lebensmittelläden und einer schnell wachsenden kreativen Szene. Der Karmelitermarkt trägt eine Speis- und Café-Szene, die sich wirklich lokal anfühlt statt für Besucher inszeniert. Buchen Sie hier, wenn Sie Parkfläche und echtes Nachbarschaftsleben wollen, eine U-Bahn-Station von den Schlössern entfernt, zu Preisen deutlich unter dem Zentrum.",
      pros: [
        "Der Prater, das Riesenrad und lange Wege am Kanal eignen sich für Familien",
        "Karmelitermarkt und Volkertmarkt bieten lokales Essen zu fairen Preisen",
        "Schnelle U1- und U2-Anbindung hält das Zentrum eine Station entfernt",
      ],
      cons: [
        "Außer dem Prater selbst gibt es keine große Sehenswürdigkeit im Bezirk",
        "Straßen nahe den Stationen können schlicht und unfertig wirken",
        "Abende bleiben ruhig und wohnviertelhaft, falls Sie ausgehen wollen",
      ],
    },
    {
      slug: "neubau",
      ...
      vibe: "Hinter dem MuseumsQuartier ist dieser siebte Bezirk der Ort, an dem Wiens Designszene wirklich wohnt: In den kopfsteingepflasterten Biedermeier-Gassen des Spittelbergs reihen sich Weinlokale und Boutiquen, während die Neubaugasse Concept Stores, Kaffeeröstereien und kleine Bars aneinanderreiht. Er bleibt zu Fuß erreichbar zu den großen Museen und fühlt sich trotzdem nach den Abenden an, die Einheimische für sich selbst wählen. Buchen Sie hier, wenn Sie nah an den großen Sehenswürdigkeiten sein wollen, ohne in einer Postkarte zu schlafen.",
      pros: [
        "MuseumsQuartier und Kunsthistorisches Museum nur einen kurzen Spaziergang entfernt",
        "Die besten unabhängigen Läden, Röstereien und Small-Plates-Restaurants der Stadt",
        "Eine lebendige, unprätentiöse Bar- und Weinlokalszene nach Einbruch der Dunkelheit",
      ],
      cons: [
        "Ein Fußweg oder eine kurze Straßenbahnfahrt trennt Sie von den Sehenswürdigkeiten im ersten Bezirk",
        "Beliebte Blocks werden an Wochenendabenden laut",
        "Weniger große Hotels, meist Apartments und Boutique-Unterkünfte",
      ],
    },
    {
      slug: "mariahilf",
      ...
      vibe: "Der sechste Bezirk zieht sich entlang der Mariahilfer Straße, der belebtesten Einkaufsstraße der Stadt, mit dem weitläufigen Naschmarkt an ihrem unteren Ende. Er hält das Praktische gegen das Charaktervolle in Balance: verlässliche Mittelklassehotels oben, Essensstände und ein Samstagsflohmarkt unten am Markt. Buchen Sie hier, wenn Sie verlässliches Preis-Leistungs-Verhältnis wollen und einen geraden Fünfzehn-Minuten-Weg oder zwei U-Bahn-Stationen ins Zentrum.",
      pros: [
        "Naschmarkt-Essensstände und der Samstagsflohmarkt gleich in der Nähe",
        "Die größte Auswahl an soliden Mittelklasse- und Budgethotels",
        "Direkter U3-Anschluss und eine Fußgängerroute ins Zentrum",
      ],
      cons: [
        "Die Haupteinkaufsstraße wird zu Stoßzeiten voll und reizlos",
        "Weniger Charakter als das gleich bergauf liegende Neubau",
        "Naschmarkt-Restaurants kosten mehr, als der Ruf der Essensstände vermuten lässt",
      ],
    },
    {
      slug: "landstrasse",
      ...
      vibe: "Südöstlich des Rings umschließt dieser dritte Bezirk das Schloss Belvedere und seine formalen Gärten, während das Hundertwasserhaus und der Rochusmarkt einen ruhigen, wohnlichen Abschnitt abrunden. Er beherbergt außerdem Wien Mitte, sodass der Flughafenzug hier schneller ankommt als irgendwo sonst in der Stadt. Buchen Sie hier, wenn Sie das Belvedere und den Ring in Gehweite wollen, zu Preisen unter denen des ersten Bezirks.",
      pros: [
        "Schloss Belvedere, seine Gärten und Klimts Kuss nur Minuten entfernt",
        "Wien Mitte bietet die schnellste Flughafenanbindung der Stadt",
        "Ruhiger und günstiger als das Zentrum und dabei zu Fuß erreichbar",
      ],
      cons: [
        "Weitläufig genug, dass manche Hotels einen echten Fußweg von jeder Sehenswürdigkeit entfernt liegen",
        "Weniger herausragende Restaurants als Neubau oder Leopoldstadt",
        "Kein einzelner lebendiger Kern, der einen Abend trägt",
      ],
    },
  ],
