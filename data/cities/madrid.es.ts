...
const madridEs: CityData = {
  city: {
    ...
    tagline: "Una capital construida sobre noches tardías y grandes museos, donde cinco barrios tiran en cinco direcciones distintas y elegir uno moldea toda la estancia.",
    heroIntro:
      "Madrid concentra un triángulo del arte de talla mundial, un elegante casco de los Austrias y una cultura de tapas que apenas arranca antes de las 22h, en una ciudad donde la distancia importa menos que el barrio que elijas. Esta guía compara los cinco barrios que merece la pena reservar, desde el Centro de postal hasta las callejuelas de tapas de La Latina, y señala el hotel que justifica su precio en cada uno.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Cada sitio estrella de Madrid queda a diez minutos a pie de esta milla cuadrada en torno a la Puerta del Sol, la Plaza Mayor y el Palacio Real, con las tiendas y los teatros de la Gran Vía a solo unas manzanas al norte. Es la zona más ruidosa y concurrida de la ciudad de día y hasta bien entrada la noche: grupos de autocar, puestos de recuerdos y trampas para turistas con menú del día rodeando las plazas principales. Resérvalo si el viaje es corto y cada hora importa más que la dirección, y no te molesta cambiar la tranquilidad por cero tiempo de trayecto. Esta es la puerta de entrada de Madrid, no su rincón tranquilo.",
      pros: [
        "La Plaza Mayor, el Palacio Real, la Puerta del Sol y la Gran Vía, todos a diez minutos a pie",
        "La base mejor comunicada de la ciudad, justo encima del intercambiador de Cercanías y metro de Sol",
        "Nunca falta un bar de tapas o un puesto de mercado, de día o de noche",
      ],
      cons: [
        "Las multitudes turísticas más densas de Madrid, con carteristas muy activos en Sol y la Gran Vía",
        "El ruido de la calle se prolonga pasada la medianoche, mala opción para quien duerme con el sueño ligero",
        "Los restaurantes que dan a las plazas principales cobran por la dirección, no por la comida",
      ],
    },
    {
      slug: "la-latina",
      ...
      vibe: "Al sur de la Plaza Mayor, las calles más antiguas de Madrid serpentean entre los bares de tapas pared con pared de la Cava Baja y la extensión dominical del mercado de El Rastro. Los locales lo consideran la auténtica ruta de tapas, no la versión turística, y el ritual del vermú y los platillos se alarga mucho después de que los puestos del mercado recogen. Resérvalo si una buena ruta de bares importa más que la vista de un museo, y prefieres caminar a la Plaza Mayor y al palacio antes que coger un transporte. Los fines de semana traen algunas de las noches más ruidosas y más auténticas del centro.",
      pros: [
        "La Cava Baja y la Cava Alta reúnen la ruta de bares de tapas más densa y mejor de Madrid",
        "Diez minutos a pie, sin cuestas, hasta la Plaza Mayor y el Palacio Real",
        "Las mañanas de domingo traen El Rastro y una buena sesión de vermú después",
      ],
      cons: [
        "Las noches de jueves a domingo se vuelven realmente ruidosas en las calles de bares",
        "Los edificios antiguos suponen habitaciones pequeñas, escaleras estrechas y ascensores que a menudo no existen",
        "Las multitudes del mercado dominical atascan las callejuelas hasta bien entrada la tarde",
      ],
    },
    {
      slug: "malasana",
      ...
      vibe: "Al norte de la Gran Vía, las calles que vieron nacer la Movida de los años ochenta viven ahora de percheros vintage, café de tueste artesanal y bares indie en torno a la Plaza del Dos de Mayo. Es joven y desaliñado en los bordes, despierto hasta más tarde que casi cualquier otra zona del centro, con cocinas y coctelerías en vez de monumentos para llenar las noches. Resérvalo por las camas de mejor precio a un paso de la acción, y acepta la banda sonora del fin de semana colándose por la ventana. El centro histórico queda a diez minutos a pie siempre que prefieras la versión de postal de Madrid.",
      pros: [
        "La mejor concentración de bares independientes, cafés y tiendas vintage de la ciudad",
        "Diez minutos a pie hasta la Gran Vía y el centro histórico",
        "Las habitaciones bajan los precios de Sol y Salamanca con un nivel de centralidad similar",
      ],
      cons: [
        "Las noches de fin de semana en torno a las plazas se vuelven ruidosas y siguen así pasadas las 3h",
        "Pocos monumentos convencionales quedan dentro del propio barrio",
        "El público de fiesta que atrae puede dejar algunas calles alborotadas a altas horas de la noche",
      ],
    },
    {
      slug: "chueca",
      ...
      vibe: "Justo al noreste de la Gran Vía, el barrio LGTBQ+ de Madrid vive de boutiques de diseño, vinotecas y mesas de restaurante que se desbordan en torno a la Plaza de Chueca, y se convierte en el epicentro del enorme Orgullo de principios de julio. Se siente pulido y sociable antes que transgresor, más cerca de una buena cena y un cóctel tardío que de una ruta de bares alborotada. Resérvalo para caminar al Thyssen y a la Gran Vía en quince minutos y aun así sentirte bienvenido volviendo a casa a las 2h. Fuera de la semana del Orgullo, las noches aquí son animadas sin caer en el caos.",
      pros: [
        "Una apretada concentración de excelentes restaurantes, coctelerías y boutiques de diseño",
        "Quince minutos a pie hasta la Gran Vía, el Thyssen y el Retiro",
        "Una vida nocturna acogedora y sociable que alcanza su punto álgido durante la semana del Orgullo de julio",
      ],
      cons: [
        "La Plaza de Chueca se vuelve realmente ruidosa los fines de semana y durante toda la semana del Orgullo",
        "Los hoteles y restaurantes de aquí están entre los más caros del centro",
        "Pocos monumentos de renombre caen dentro de las propias calles del barrio",
      ],
    },
    {
      slug: "salamanca",
      ...
      vibe: "Al noreste del Retiro, la amplia cuadrícula de Salamanca cambia el encanto de los adoquines por bulevares tranquilos, compras de alta gama en la Calle Serrano y un sueño nocturno notablemente más silencioso. Es el distrito elegante de Madrid: restaurantes refinados y porteros en vez de bares de tapas y ruido de calle. Resérvalo si el espacio, la seguridad y el refinamiento importan más que la cercanía tambaleante al casco antiguo, ya que el Retiro y el Prado siguen a un corto paseo o una parada de metro. La vida nocturna aquí significa una buena cena, no una ruta de bares.",
      pros: [
        "Calles amplias, tranquilas y elegantes, con compras de alta gama en Serrano",
        "Un corto paseo hasta el Retiro y el Prado, respaldado por buenas conexiones de metro",
        "Gastronomía de alta gama consistentemente buena, sin el alboroto del casco antiguo",
      ],
      cons: [
        "Hoteles, tiendas y restaurantes con los precios más altos de la ciudad",
        "Se siente residencial y formal antes que animado una vez que se pone el sol",
        "A veinte minutos a pie o un salto de metro del viejo centro de los Austrias",
      ],
    },
  ],
