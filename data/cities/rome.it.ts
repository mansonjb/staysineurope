...
const romeIt: CityData = {
  city: {
    ...
    tagline: "Le rovine antiche riempiono ogni scorcio, ma il lato del Tevere in cui si dorme decide se la città sembra a portata di mano o interminabile.",
    heroIntro:
      "Roma distribuisce rovine antiche, il Vaticano e alcune delle migliori cene all'aperto d'Europa in un centro percorribile a piedi a tratti ma mai in un unico giro comodo, così il quartiere scelto decide quanta parte di ogni giornata se ne va per spostarsi invece che per vedere. Questa guida mette a confronto le cinque zone che vale la pena prenotare, dal Centro Storico dai prezzi da cartolina alla più tranquilla e conveniente Prati vicino al Vaticano, e indica l'hotel che in ciascuna vale davvero la tariffa richiesta.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Un dedalo di vicoli color ocra intrecciati tra il Pantheon, Piazza Navona e la Fontana di Trevi, di quelle strade che ogni pochi passi si aprono su una piazza barocca. Tutto ciò che serve per una prima visita sta entro un quarto d'ora a piedi, e una volta che i gruppi organizzati si diradano dopo cena gli stessi vicoli diventano silenziosi e davvero belli. Prenotate qui se il soggiorno è breve e volete tutte le attrazioni principali, più la quiete serale, senza mai dover aprire una mappa.",
      pros: [
        "Pantheon, Trevi, Navona e Piazza di Spagna tutti raggiungibili in un unico giro a piedi",
        "Diventa tranquillo e suggestivo una volta che i pullman delle gite giornaliere ripartono la sera",
        "Un caffè, una gelateria o un locale da aperitivo quasi a ogni angolo",
      ],
      cons: [
        "Le tariffe alberghiere più alte di tutta la città",
        "Nessuna linea della metro lo attraversa, quindi ci si sposta a piedi o in autobus",
        "Folla fitta e rumore intorno alle grandi attrazioni per tutto il giorno",
      ],
    },
    {
      slug: "monti",
      ...
      vibe: "Incastonato tra il Colosseo e Termini, questo angolo di città era un tempo il quartiere a luci rosse ed è oggi il più vissuto dai romani: negozi vintage, wine bar ed edera sui vicoli intorno a Piazza della Madonna dei Monti. La sera porta fuori i residenti a bere sui gradini della fontana, non gruppi turistici in giro con la lista delle cose da vedere. Prenotate qui per avere la Roma antica a portata di mano, a una frazione del prezzo e del traffico di pullman del centro storico.",
      pros: [
        "Dieci minuti a piedi bastano per Colosseo e Foro",
        "Stazione Cavour sulla linea B della metro, con i collegamenti di Termini a due passi",
        "Wine bar ed enoteche sempre pieni di residenti, non di visitatori",
      ],
      cons: [
        "Alcune strade verso Termini diventano trasandate dopo il buio",
        "I bar più frequentati riversano rumore in strada nelle sere del weekend",
        "Piccoli boutique hotel e appartamenti superano di numero gli alberghi di marca",
      ],
    },
    {
      slug: "trastevere",
      ...
      vibe: "Un groviglio di vicoli acciottolati sull'altra sponda del Tevere, appesi di edera e panni stesi di giorno e trasformati nel quartiere più vivace della città per cena e drink una volta calato il sole. I tavoli invadono i marciapiedi davanti a ogni trattoria, e i bar intorno a Piazza di Santa Maria restano aperti ben oltre la mezzanotte. Prenotate qui se volete mangiare e bere bene fino a tardi e riuscite a ignorare il rumore del weekend una volta rientrati in camera.",
      pros: [
        "La concentrazione più fitta di trattorie autentiche e fermento serale di tutta Roma",
        "Una breve camminata oltre il fiume porta al centro e al Ghetto ebraico",
        "Vicoli acciottolati che rendono al meglio nelle foto nella quiete del primo mattino",
      ],
      cons: [
        "Le notti del weekend restano rumorose oltre la mezzanotte, difficili per chi ha il sonno leggero",
        "Nessuna stazione della metro, solo tram, autobus o le proprie gambe",
        "Alcuni ristoranti sulla piazza principale vivono di rendita sull'indirizzo, non sulla cucina",
      ],
    },
    {
      slug: "prati",
      ...
      vibe: "Ampi viali ordinati disposti a scacchiera accanto al Vaticano, con negozi eleganti e cucine affidabili che vedono molti meno turisti del centro storico. Mette San Pietro e i Musei Vaticani a una comoda distanza a piedi pur mantenendo l'aria di un normale quartiere residenziale. Prenotate qui se volete il Vaticano a piedi, una linea di metro per tutto il resto, e prezzi degli hotel più bassi che nel centro.",
      pros: [
        "San Pietro e i Musei Vaticani entrambi a portata di mano, in anticipo sui gruppi organizzati",
        "Due fermate sulla linea A della metro portano direttamente a Termini e a Piazza di Spagna",
        "Hotel con miglior rapporto qualità-prezzo e cucine senza il sovrapprezzo turistico",
      ],
      cons: [
        "Le opzioni di bar e vita notturna si diradano una volta chiusi i negozi",
        "20-25 minuti a piedi o un cambio di metro per raggiungere il lato del Colosseo",
        "Risulta più pratico che romantico rispetto al centro storico",
      ],
    },
    {
      slug: "testaccio",
      ...
      vibe: "Cresciuto intorno all'ex mattatoio a sud del centro, questo quartiere popolare è dove la cucina povera romana, quinto quarto compreso, si cucina ancora come una volta. Il suo mercato coperto e le trattorie senza fronzoli attirano buongustai seri più che turisti in visita, e i locali scavati nella collina di Monte Testaccio portano avanti la vita notturna dopo cena. Prenotate qui se mangiare bene a prezzi locali conta più di una vista, e non vi dispiace fare qualche fermata per raggiungere le attrazioni.",
      pros: [
        "Tra la cucina più autentica e conveniente di tutta Roma",
        "Stazione Piramide sulla linea B della metro, poche fermate dal Colosseo",
        "Un'atmosfera davvero residenziale, quasi senza sovrapprezzo turistico",
      ],
      cons: [
        "Poche attrazioni classiche, è un quartiere per mangiare, non per visitare",
        "20 minuti o più a piedi o in metro dal centro storico",
        "La fila di locali di Monte Testaccio è rumorosa nelle notti del weekend",
      ],
    },
  ],
