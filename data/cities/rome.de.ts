...
const romeDe: CityData = {
  city: {
    ...
    tagline: "Antike Ruinen prägen jeden Blick, doch welches Tiber-Ufer Sie zum Schlafen wählen, entscheidet, ob sich die Stadt nah oder endlos anfühlt.",
    heroIntro:
      "Rom breitet antike Ruinen, den Vatikan und einige der besten Restaurants im Freien Europas über ein Zentrum aus, das sich in einzelnen Abschnitten zu Fuß erkunden lässt, aber nie in einer einzigen bequemen Runde, sodass das gewählte Viertel bestimmt, wie viel jedes Tages fürs Hinkommen statt fürs Sehen draufgeht. Dieser Guide vergleicht die fünf Viertel, die eine Buchung wert sind, vom postkartenteuren Centro Storico bis zum ruhigeren, preiswerteren Prati beim Vatikan, und nennt das Hotel, das seinen Preis in jedem von ihnen rechtfertigt.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Ein Gewirr ockerfarbener Gassen zwischen Pantheon, Piazza Navona und Trevi-Brunnen, Straßen, die sich alle paar Schritte zu einem barocken Platz öffnen. Alles, was ein erster Besuch braucht, liegt innerhalb von fünfzehn Gehminuten, und sobald sich die Reisebusgruppen nach dem Abendessen verzogen haben, werden dieselben Gassen still und wirklich schön. Buchen Sie hier, wenn die Reise kurz ist und Sie jede Top-Sehenswürdigkeit sehen wollen, dazu die nächtliche Ruhe, ohne je eine Karte aufzuschlagen.",
      pros: [
        "Pantheon, Trevi-Brunnen, Navona und die Spanische Treppe alle in einer einzigen begehbaren Runde",
        "Wird ruhig und stimmungsvoll, sobald die Tagesausflugsbusse am Abend abziehen",
        "Ein Café, eine Gelateria oder eine Aperitivo-Bar an fast jeder Ecke",
      ],
      cons: [
        "Die höchsten Hotelpreise der ganzen Stadt",
        "Keine Metrolinie führt hindurch, Sie sind also zu Fuß oder mit dem Bus unterwegs",
        "Den ganzen Tag über dicht an Menschenmengen und Lärm rund um die großen Sehenswürdigkeiten",
      ],
    },
    {
      slug: "monti",
      ...
      vibe: "Eingebettet zwischen Kolosseum und Termini war dieses Viertel einst das Rotlichtviertel der Stadt und ist heute ihre lebendigste Ecke: Vintage-Läden, Weinbars und Efeu über den Gassen rund um die Piazza della Madonna dei Monti. Abends kommen Anwohner heraus, um auf den Brunnenstufen zu trinken, statt Reisegruppen, die eine Checkliste abarbeiten. Buchen Sie hier für fußläufige Nähe zum antiken Kern zu einem Bruchteil des Preises und des Reisebusverkehrs des alten Zentrums.",
      pros: [
        "Ein zehnminütiger Fußweg deckt sowohl das Kolosseum als auch das Forum ab",
        "Metrostation Cavour an der Linie B, mit den Anschlüssen von Termini in der Nähe",
        "Weinbars und Enotecas, die voller Anwohner bleiben, nicht Besucher",
      ],
      cons: [
        "Ein paar Straßen Richtung Termini wirken nach Einbruch der Dunkelheit heruntergekommen",
        "Die belebtesten Bars werden an Wochenendabenden laut und quellen auf die Straße",
        "Kleine Boutique-Unterkünfte und Apartments übertreffen namhafte Hotels zahlenmäßig",
      ],
    },
    {
      slug: "trastevere",
      ...
      vibe: "Ein Gewirr kopfsteingepflasterter Gassen auf der anderen Seite des Tibers, tagsüber behangen mit Efeu und Wäscheleinen, und nach Sonnenuntergang verwandelt in das lebendigste Ausgeh-Viertel der Stadt für Abendessen und Drinks. Tische breiten sich vor jeder Trattoria auf dem Gehweg aus, und die Bars rund um die Piazza di Santa Maria laufen weit über Mitternacht hinaus. Buchen Sie hier, wenn Sie nach Einbruch der Dunkelheit gut essen und trinken wollen und den Wochenendlärm ausblenden können, sobald Sie wieder im Zimmer sind.",
      pros: [
        "Die dichteste Konzentration echter Trattorien und nächtlichen Trubels in Rom",
        "Ein kurzer Fußweg über den Fluss ins Zentrum und zum jüdischen Ghetto",
        "Kopfsteingepflasterte Gassen, die sich in der Stille des frühen Morgens am besten fotografieren lassen",
      ],
      cons: [
        "An Wochenenden laut bis über Mitternacht hinaus, schwer für leichte Schläfer",
        "Überhaupt keine Metrostation, nur Trams, Busse oder die eigenen Füße",
        "Ein paar Restaurants am Hauptplatz leben von der Adresse, nicht vom Essen",
      ],
    },
    {
      slug: "prati",
      ...
      vibe: "Breite, geordnete Boulevards im Rasterplan neben dem Vatikan, gesäumt von schicken Läden und verlässlichen Küchen, die weit weniger Touristen sehen als der historische Kern. Es bringt den Petersdom und die Vatikanischen Museen in bequeme Gehnähe und fühlt sich dabei noch wie ein gewöhnliches Wohnviertel an. Buchen Sie hier, wenn Sie den Vatikan zu Fuß erreichen wollen, eine Metrolinie überallhin sonst und Hotelpreise unter denen des Zentrums.",
      pros: [
        "Petersdom und Vatikanische Museen beide in bequemer Gehnähe, den Reisebusgruppen voraus",
        "Zwei Stationen an der Metrolinie A erreichen direkt Termini und die Spanische Treppe",
        "Preiswertere Hotels und Küchen, die den Touristenaufschlag auslassen",
      ],
      cons: [
        "Bar- und Nachtleben-Angebot dünnt aus, sobald die Läden schließen",
        "20 bis 25 Gehminuten oder ein Metroumstieg von der Kolosseum-Seite entfernt",
        "Wirkt eher praktisch als romantisch im Vergleich zum alten Zentrum",
      ],
    },
    {
      slug: "testaccio",
      ...
      vibe: "Rund um den alten Schlachthof südlich des Zentrums gebaut, ist dieses Arbeiterviertel der Ort, an dem römische Cucina povera, Innereien eingeschlossen, noch auf die alte Art gekocht wird. Seine überdachte Markthalle und schnörkellosen Trattorien ziehen ernsthafte Esser an statt Sightseer, und die in den Hang des Monte Testaccio gegrabenen Clubs tragen das Nachtleben nach dem Abendessen weiter. Buchen Sie hier, wenn gutes Essen zu Einheimischenpreisen wichtiger ist als eine Aussicht, und es Ihnen nichts ausmacht, von den Sehenswürdigkeiten herzufahren.",
      pros: [
        "Einige der besten und authentischsten Küchen Roms zu fairen Preisen",
        "Metrostation Piramide an der Linie B, wenige Stationen vom Kolosseum entfernt",
        "Ein echtes Wohnviertel-Gefühl mit fast keinem Touristenaufschlag",
      ],
      cons: [
        "Kaum klassische Sehenswürdigkeiten, dies ist ein Viertel zum Essen, nicht zum Besichtigen",
        "20 Minuten oder mehr zu Fuß oder mit der Metro vom historischen Kern entfernt",
