...
const copenhagenPt: CityData = {
  city: {
    ...
    tagline: "Cinco bairros muito diferentes, a uma pedalada de distância: escolha bem e a viagem segue-se.",
    heroIntro:
      "Copenhaga divide-se em bairros de bolso que quase não se parecem entre si, por isso o local onde dorme decide se a viagem gira em torno de praças reais, do sossego dos canais ou de cozinhas que fecham tarde. A cidade velha coloca todas as grandes atrações a pé, mas cobra por isso; Vesterbro e Nørrebro trocam as vistas de postal pela comida que os locais realmente comem; e Christianshavn flutua num ponto mais calmo entre os dois extremos. Este guia percorre os cinco bairros para que a cama que reserva corresponda à cidade que realmente quer.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Este núcleo medieval fica entre Strøget, os palácios e os canais, com quase todas as principais atrações a menos de dez minutos a pé. É denso e elegante de dia, mais tranquilo assim que as lojas fecham, e coloca a Torre Redonda, Rosenborg e Nyhavn tudo a pé. Reserve aqui se a viagem for curta e preferir pagar pela comodidade em vez de um quarto maior.",
      pros: [
        "A Torre Redonda, Rosenborg, Strøget e Nyhavn tudo a pé",
        "Melhor caminhabilidade da cidade e as melhores ligações de metro",
        "Uma visita de dois dias faz-se inteiramente a pé",
      ],
      cons: [
        "Os preços de quarto estão entre os mais altos da cidade",
        "As ruas principais têm preços de turista para comida e bebida",
        "Menos restaurantes de bairro do que Nørrebro ou Vesterbro",
      ],
    },
    {
      slug: "nyhavn",
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "É a imagem que todos os visitantes imaginam antes de aterrar: um curto canal do século XVII ladeado por empenas pintadas, barcos de madeira ancorados e esplanadas empilhadas fundo a fundo no verão. Dormir tão perto coloca o porto e o bairro real à porta, embora a própria margem da água se torne ruidosa e cara assim que o sol aparece. Reserve aqui se a vista do canal importar mais do que uma noite sossegada, e não se importar de comer uma rua mais atrás.",
      pros: [
        "Dorme mesmo junto ao canal mais fotografado da cidade",
        "Bairro real, Amalienborg e os cais dos barcos de canal a curta distância a pé",
        "Bem servido por metro e autocarros do porto",
      ],
      cons: [
        "Os restaurantes junto à água cobram muito pela vista",
        "As noites de verão trazem ruído e multidões à porta",
        "Quartos económicos são escassos tão perto do canal",
      ],
    },
    {
      slug: "vesterbro",
      ...
      vibe: "Antigo bairro da luz vermelha e das carnes de Copenhaga, este bairro a oeste da Estação Central transformou-se no ponto mais afiado de gastronomia e vida noturna da cidade. Os antigos pavilhões de carne de Kødbyen albergam agora bares de vinho natural e padarias onde os jovens locais, não os grupos de turistas, passam realmente os seus serões. Reserve aqui se quiser preços reais de Copenhaga e uma noite mais animada, com o Tivoli e o centro ainda a uma curta caminhada.",
      pros: [
        "A melhor cena de gastronomia e vida noturna em relação qualidade-preço",
        "Os bares de Kødbyen e a Estação Central ambos perto",
        "Uma caminhada fácil até ao Tivoli e ao centro da cidade",
      ],
      cons: [
        "Algumas ruas ainda parecem duras a horas tardias",
        "Sem canal nem atrações emblemáticas no próprio bairro",
        "Os quarteirões de vida noturna mantêm-se ruidosos depois de escurecer",
      ],
    },
    {
      slug: "norrebro",
      ...
      vibe: "A norte dos lagos, este é o bairro mais jovem e mais misto da cidade, ancorado no parque de retalhos Superkilen e nos cafés ao longo de Jægersborggade. A cena gastronómica de bairro aqui assenta em padarias e grelhados do Médio Oriente em vez de menus turísticos, a preços que o centro já deixou para trás. Reserve aqui se preferir comer como um local e não se importar com quinze minutos a pé ou uma curta viagem de autocarro até à cidade velha.",
      pros: [
        "Os quartos mais baratos entre os bairros relativamente centrais",
        "Forte cena gastronómica independente com pouca margem turística",
        "Superkilen, o Cemitério de Assistens e Jægersborggade por perto",
      ],
      cons: [
        "O mais afastado destes cinco bairros das atrações do porto",
        "Suficientemente disperso para depender de bicicletas ou autocarros",
        "A cobertura de metro é irregular, embora os autocarros sejam frequentes",
      ],
    },
    {
      slug: "christianshavn",
      ...
      vibe: "Traçada por Cristiano IV, esta ilha entrecortada de canais mistura casas-barco e cais de calçada com a cidade livre de Christiania mesmo na sua orla. Troca a azáfama da cidade velha por algo mais residencial, mas fica apenas a uma paragem de metro ou a uma caminhada pelo porto do centro. Reserve aqui se quiser vistas de água e noites sossegadas sem abdicar de um acesso fácil a tudo o resto.",
      pros: [
        "Canais e casas-barco longe das multidões",
      ...
      cons: [
        "Menos hotéis, por isso as opções e a disponibilidade são mais limitadas",
        "Vida noturna mais tranquila do que em Vesterbro ou Nørrebro",
        "A maioria das atrações centrais implica atravessar o porto",
      ],
    },
  ],
