...
const portoPt: CityData = {
  city: {
    ...
    tagline: "Uma cidade empilhada em duas margens, onde o lado e a colina em que dorme mudam a viagem toda.",
    heroIntro:
      "O Porto sobe as suas casas de azulejo por encostas íngremes de granito em ambas as margens do Douro, e o bairro que escolher decide se acorda sobre a água, no centro comercial plano, ou do outro lado do rio, entre as caves de vinho do Porto de Gaia. Este guia pesa o encanto de postal da Ribeira contra as ruas mais calmas e locais de Cedofeita e Bonfim, e o argumento prático a favor de se basear antes na Baixa. Dois dias chegam para provar a maior parte, e a comida e o vinho continuam a valer muito mais do que os preços baixos fazem crer.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Um emaranhado apertado de vielas medievais e cais com arcadas cai a pique até ao Douro aqui, sob o vão de ferro da ponte Dom Luís I, casas coloridas debruçadas sobre a água e barcos a baloiçar junto ao muro. É o sítio com mais atmosfera da cidade para acordar, sobretudo ao pôr do sol, e também o mais turístico, com preços à altura da vista. Reserve aqui se o brilho da beira-rio importa mais do que uma pechincha, porque escapar às multidões não é bem uma opção.",
      pros: [
        "Acorde com as melhores vistas de rio e de ponte da cidade, a passos do seu quarto",
        "São Bento, a Sé e a travessia para Gaia ficam todos a uma curta caminhada",
        "O cais mantém-se animado com cafés e restaurantes do pequeno-almoço até à noite",
      ],
      cons: [
        "Os restaurantes mesmo à beira-água têm preços exagerados e são feitos para turistas, não para locais",
        "Chegar ao metro ou às ruas mais altas exige uma subida íngreme de calçada",
        "As noites de verão trazem multidões e barulho ao longo da beira-rio",
      ],
    },
    {
      slug: "baixa",
      ...
      vibe: "A grandiosa Avenida dos Aliados e a estação de São Bento ancoram o coração comercial do Porto, onde convergem as principais lojas, o mercado do Bolhão e a maior parte das linhas de metro. É mais plana do que a beira-rio e a base mais bem ligada da cidade, ainda que ao nível da rua penda para o turístico e o corporativo. Reserve aqui se chegar depressa a todo o lado importa mais do que dormir num sítio com mais carácter.",
      pros: [
        "Todas as linhas de metro convergem aqui, e o comboio do aeroporto deixa-o a uma única paragem",
        "As ruas planas tornam isto muito mais fácil do que as colinas da Ribeira com bagagem",
        "Hotéis e sítios para comer cobrem todos os orçamentos",
      ],
      cons: [
        "O carácter fica em segundo plano face às lojas de cadeia e ao trânsito, em comparação com a beira-rio",
        "A avenida principal e a zona da estação ficam ruidosas e congestionadas durante o dia",
      ],
    },
    {
      slug: "cedofeita",
      ...
      vibe: "A noroeste do centro, o eixo de galerias ao longo da Rua de Miguel Bombarda dá o tom a um bairro artístico de lojas independentes, wine bars e cafés de especialidade, atraindo um público mais jovem e mais local do que o rio alguma vez verá. Mantém-se animado até à noite sem parecer encenado para visitantes. Reserve aqui se quer comer e beber onde o Porto realmente sai, a uma curta caminhada dos monumentos em vez de em cima deles.",
      pros: [
        "Cozinhas independentes, torrefações de café e bares que ofuscam o centro, sem as multidões",
        "Passear entre galerias e concept stores ao longo da Rua de Cedofeita, pedonal",
        "Ainda central, só que mais calmo, a dez minutos a pé dos Aliados",
      ],
      cons: [
        "Sem frente de rio e sem monumentos de grande nome dentro do próprio bairro",
        "Apartamentos e pequenas estadias boutique dominam em vez de grandes hotéis",
      ],
    },
    {
      slug: "bonfim",
      ...
      vibe: "A leste do centro, antigas oficinas convivem agora com bares de vinho natural e ateliês criativos num bairro residencial que muda depressa mas ainda parece a vida normal do Porto, e não um cenário. Quartos e refeições custam ambos menos aqui, e come-se onde o bairro come. Reserve-o se preferir deslocar-se um pouco até aos monumentos de postal a dormir entre eles.",
      pros: [
        "Quartos e refeições saem mais baratos aqui do que em qualquer sítio mais perto do centro",
        "A cena de comida e bares está a melhorar depressa e os turistas mal a descobriram",
        "Boas ligações de metro, mais uma caminhada plana de 20 minutos até ao rio",
      ],
      cons: [
        "Visitar monumentos implica deslocar-se, já que os pontos de destaque ficam noutro sítio",
        "A qualidade varia de quarteirão para quarteirão, e alguns cantos ainda parecem por acabar",
        "Escasseiam as grandes marcas hoteleiras; guesthouses e apartamentos preenchem o vazio",
      ],
    },
    {
      ...
      vibe: "Atravesse para a margem sul, tecnicamente a sua própria cidade, e todas as grandes casas de vinho do Porto têm aqui as caves alinhadas ao longo do cais, com o passeio ribeirinho a olhar diretamente para a cidade velha empilhada do Porto, a melhor vista da Ribeira que vai conseguir em qualquer lado. É mais calma e mais verde do que a margem norte, construída à volta das caves e do teleférico em vez da vida noturna. Reserve aqui pelas provas e pela vista de postal, e aceite atravessar a ponte sempre que quiser a cidade velha em si.",
      pros: [
        "Percorra o cais de prova em prova de vinho do Porto",
        "Este lado do rio dá a vista mais nítida e mais fotografada do horizonte do Porto",
        "Um passeio ribeirinho e um teleférico garantem noites mais calmas do que as da Ribeira",
      ],
      cons: [
        "Chegar aos monumentos da cidade velha ou à rede de metro implica atravessar a ponte todas as vezes",
        "Os restaurantes no cais cobram preços de turista, tal como a Ribeira do outro lado da água",
      ],
    },
  ],
