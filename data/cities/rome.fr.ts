...
const romeFr: CityData = {
  city: {
    ...
    tagline: "Les ruines antiques envahissent chaque vue, mais le côté du Tibre où l'on dort décide si la ville paraît proche ou interminable.",
    heroIntro:
      "Rome déploie des ruines antiques, le Vatican et une des meilleures scènes de dîner en terrasse d'Europe sur un centre qui se parcourt à pied par poches mais jamais en une seule boucle simple, si bien que le quartier choisi décide de la part de chaque journée passée à s'y rendre plutôt qu'à en profiter. Ce guide compare les cinq quartiers qui méritent une réservation, du Centro Storico au prix de carte postale au Prati, plus calme et mieux placé côté prix, près du Vatican, et nomme l'hôtel qui justifie son tarif dans chacun.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Un dédale de ruelles ocre tendues entre le Panthéon, la place Navone et la fontaine de Trevi, le genre de rues qui débouchent sur une place baroque à chaque détour. Tout ce dont a besoin un premier séjour tient dans un rayon de quinze minutes à pied, et une fois les groupes en car partis après le dîner, ces mêmes ruelles deviennent silencieuses et vraiment magnifiques. Réservez ici si le séjour est court et que vous voulez tous les sites incontournables, plus ce calme nocturne, sans jamais ouvrir de carte.",
      pros: [
        "Panthéon, Trevi, Navone et la place d'Espagne, tous dans une même boucle à pied",
        "Devient calme et chargé d'atmosphère une fois les cars d'excursion partis le soir",
        "Un café, un glacier ou un bar à apéritif à presque chaque coin de rue",
      ],
      cons: [
        "Les tarifs d'hôtel les plus élevés de toute la ville",
        "Aucune ligne de métro n'y passe : on est à pied ou en bus",
        "Dense en foule et en bruit autour des grands sites toute la journée",
      ],
    },
    {
      slug: "monti",
      ...
      vibe: "Niché entre le Colisée et Termini, ce petit quartier fut jadis le quartier chaud de la ville et en est aujourd'hui le coin le plus vivant : friperies, bars à vin et lierre au-dessus des ruelles autour de la Piazza della Madonna dei Monti. Le soir, ce sont les habitants qui sortent boire un verre sur les marches de la fontaine, pas des groupes de touristes cochant une liste. Réservez ici pour être à distance de marche du centre antique, à une fraction du prix et de l'afflux de cars du vieux centre.",
      pros: [
        "Dix minutes à pied suffisent pour rejoindre le Colisée et le Forum",
        "Station Cavour sur la ligne de métro B, avec les correspondances de Termini tout près",
        "Des bars à vin et enotecas qui restent pleins d'habitants, pas de visiteurs",
      ],
      cons: [
        "Quelques rues vers Termini deviennent miteuses à la nuit tombée",
        "Les bars les plus fréquentés débordent bruyamment sur la rue les soirs de week-end",
        "Les petites adresses de charme et les appartements dépassent en nombre les grandes enseignes",
      ],
    },
    {
      slug: "trastevere",
      ...
      vibe: "Un enchevêtrement de ruelles pavées de l'autre côté du Tibre, tendues de lierre et de linge le jour, qui devient le quartier le plus animé de la ville pour dîner et boire un verre une fois le soleil couché. Les tables débordent sur le trottoir devant chaque trattoria, et les bars autour de la place Santa Maria tournent bien après minuit. Réservez ici si vous voulez bien manger et boire après la tombée de la nuit et pouvez faire abstraction du bruit du week-end une fois de retour dans la chambre.",
      pros: [
        "La plus forte concentration de vraies trattorias et d'animation nocturne de Rome",
        "Une courte marche par-dessus le fleuve pour rejoindre le centre et le ghetto juif",
        "Des ruelles pavées qui se photographient le mieux dans le calme du petit matin",
      ],
      cons: [
        "Les nuits de week-end restent bruyantes bien après minuit, difficile pour les petits dormeurs",
        "Aucune station de métro : seulement des trams, des bus ou ses propres jambes",
        "Quelques restaurants de la place principale vivent de l'adresse, pas de la cuisine",
      ],
    },
    {
      slug: "prati",
      ...
      vibe: "De larges boulevards ordonnés, tracés en quadrillage à côté du Vatican, bordés de boutiques chics et de restaurants fiables qui voient bien moins de touristes que le centre historique. Il met Saint-Pierre et les Musées du Vatican à une marche facile tout en gardant l'allure d'un quartier résidentiel ordinaire. Réservez ici si vous voulez le Vatican à pied, une ligne de métro vers partout ailleurs, et des prix d'hôtel inférieurs à ceux du centre.",
      pros: [
        "Saint-Pierre et les Musées du Vatican tous deux à une marche facile, avant les groupes en car",
        "Deux arrêts sur la ligne de métro A pour rejoindre directement Termini et la place d'Espagne",
        "Des hôtels et des restaurants à meilleur rapport qualité-prix, sans la majoration touristique",
      ],
      cons: [
        "L'offre de bars et de vie nocturne se raréfie une fois les boutiques fermées",
        "20 à 25 minutes à pied, ou un changement de métro, pour rejoindre le côté du Colisée",
        "Se lit comme plus pratique que romantique face au vieux centre",
      ],
    },
    {
      slug: "testaccio",
      ...
      vibe: "Bâti autour de l'ancien abattoir au sud du centre, ce quartier populaire est l'endroit où la cucina povera romaine, abats compris, se cuisine encore à l'ancienne. Son marché couvert et ses trattorias sans façon attirent de vrais gourmands plutôt que des touristes en visite, et les clubs creusés dans le flanc du Monte Testaccio assurent la vie nocturne après le dîner. Réservez ici si bien manger à prix locaux compte plus qu'une vue, et que le trajet depuis les sites ne vous dérange pas.",
      pros: [
        "Une des cuisines les plus authentiques et les mieux tarifées de tout Rome",
        "Station Piramide sur la ligne de métro B, à quelques arrêts du Colisée",
        "Une véritable ambiance résidentielle, avec quasiment aucune majoration touristique",
      ],
      cons: [
        "Peu de sites classiques : c'est un quartier pour manger, pas pour visiter",
        "20 minutes ou plus à pied ou en métro depuis le coeur historique",
