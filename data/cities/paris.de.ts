...
const parisDe: CityData = {
  city: {
    ...
    tagline: "Paris ist zu groß, um es zu Fuß zu durchqueren, daher bestimmt das Arrondissement, in dem Sie buchen, wie viel Zeit jedes Tages an die Metro geht.",
    heroIntro:
      "Paris verteilt seine Sehenswürdigkeiten über ein Dutzend Arrondissements, die kein Besucher von einem Ende zum anderen zu Fuß durchquert, weshalb das Viertel, in dem Sie schlafen, die Reise mehr prägt als jede Route. Dieser Guide vergleicht die fünf Gegenden, die eine Buchung wert sind, von den modischen Gassen des Marais bis zu den Bars am Kanal im Nordosten, und nennt jeweils das Hotel, das seinen Preis wert ist.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Mittelalterliche Gassen und prächtige Hotels particuliers verdichten das 3. und 4. Arrondissement zur modischsten Ecke des Pariser Zentrums, voller Boutiquen, Galerien und einer Barszene, die lange nach Ladenschluss weitergeht. Die prächtige Place des Vosges bildet den Ankerpunkt des Viertels, und Notre-Dame, der Louvre und die Inseln sind alle zu Fuß statt mit der Metro erreichbar. Buchen Sie hier, wenn Sie eine stilvolle, zentrale Basis mit Ausgehmöglichkeiten nach dem Abendessen möchten.",
      pros: [
        "Notre-Dame, die Inseln, der Louvre und das Centre Pompidou sind alle zu Fuß erreichbar",
        "Die beste Konzentration an Boutiquen und Galerien im Pariser Zentrum",
        "Bars und späte Küchen halten das Viertel lange nach dem Abendessen wach, ganz ohne Metro",
      ],
      cons: [
        "Hotelpreise und Restaurantrechnungen liegen hier höher als fast überall sonst",
        "An Wochenendabenden werden die engen Gassen laut und wirklich überfüllt",
        "Der Sonntag bringt sein eigenes Gedränge, da hier viele Geschäfte geöffnet bleiben, während der Rest von Paris schließt",
      ],
    },
    {
      slug: "saint-germain",
      ...
      vibe: "Das alte Literaturviertel des linken Ufers zehrt noch immer vom Ruhm des Cafe de Flore und der Les Deux Magots, doch der eigentliche Reiz liegt darin, wie zentral und ungehetzt es sich anfühlt, mit eleganten Galerien, dem Jardin du Luxembourg an seinem Rand und dem Musee d'Orsay einen kurzen Fußweg über den Fluss entfernt. Es wirkt gepflegt statt rau, die Art von Gegend, die zu einem ersten Besuch oder einer Reise mit gemächlichen Morgenstunden passt. Buchen Sie hier für eine elegante, entspannte Basis, von der aus die Seine und das Quartier Latin dennoch zu Fuß erreichbar bleiben.",
      pros: [
        "Kurzer Fußweg zum Musee d'Orsay, über den Fluss zum Louvre und zum Jardin du Luxembourg",
        "Ruhig, zentral und leicht zu überblicken, eine nachsichtige Wahl für einen ersten Aufenthalt",
        "Zwei Metrolinien und RER-Anschluss erreichen beide Flughäfen und Versailles ohne lästiges Umsteigen",
      ],
      cons: [
        "Hotelzimmer und ein Kaffee in den berühmten Cafes kosten beide einen Aufpreis",
        "Das Nachtleben ist nach dem Abendessen ruhiger als im Marais oder am Kanalviertel",
        "Wirkt eher gepflegt und auf Besucher ausgerichtet als wirklich gelebt",
      ],
    },
    {
      slug: "montmartre",
      ...
      vibe: "Der Hügel über dem 18. Arrondissement bewahrt ein Dorfgefühl, das der Rest des Pariser Zentrums längst verloren hat, mit Kopfsteinpflastertreppen und kleinen Plätzen, die zu den weißen Kuppeln von Sacre-Coeur hinaufsteigen. Schlendern Sie ein, zwei Straßen jenseits der Menschenmengen rund um die Basilika und die Place du Tertre, und Sie finden Weinbars und ein wirklich einheimisches Tempo. Übernachten ist hier günstiger als im Zentrum, doch jeder Weg hinunter zum Louvre oder zur Seine bedeutet eine Metrofahrt statt eines Spaziergangs.",
      pros: [
        "Das kostenlose Panorama von den Stufen von Sacre-Coeur schlägt jeden kostenpflichtigen Aussichtspunkt der Stadt",
        "Zimmer kosten hier spürbar weniger als am zentralen rechten Ufer",
        "Ruhige Gassen und einheimische Bars tauchen auf, sobald Sie an den Reisegruppen vorbeigehen",
      ],
      cons: [
        "Jede größere Sehenswürdigkeit unten im Tal ist eine Metrofahrt entfernt, kein Spaziergang",
        "Steile Treppen und Hänge überall machen es mit Gepäck oder Kinderwagen mühsam",
        "Die Basilikatreppen und die Place du Tertre sind bekanntes Taschendieb- und Aufdringlingsgebiet",
      ],
    },
    {
      slug: "latin-quarter",
      ...
      vibe: "Die Straßen rund um die Sorbonne im 5. Arrondissement bleiben belebt mit Buchläden, günstigen Küchen und studentischer Energie zwischen dem Pantheon und dem Fluss. Sie liegen nah genug, um zu Fuß zu Notre-Dame, den Inseln und dem Jardin du Luxembourg zu gelangen, mit Betten, die in der Regel günstiger sind als im gepflegteren Saint-Germain nebenan. Tagsüber lebendig, wird es an seinen touristischsten Ecken abends, wenn die Abendmenge eintrifft, etwas rau.",
      pros: [
        "Notre-Dame, die Sainte-Chapelle und die Inseln sind alle ein Spaziergang über den Fluss",
        "Zimmer und Mahlzeiten sind hier beide günstiger als im benachbarten Saint-Germain",
        "RER- und Metroanbindungen von hier erreichen Versailles und beide Flughäfen direkt",
      ],
      cons: [
        "Die Rue de la Huchette und die umliegenden Straßen sind gesäumt von Touristenfallen-Küchen",
        "Das Gebiet rund um die Sorbonne und die Uferpromenade wird überfüllt und laut",
        "Alte Gebäude bedeuten, dass manche Zimmer klein sind, mit knarrenden Böden und Treppen",
      ],
    },
    {
      ...
      vibe: "Dieser Abschnitt des 10. und 11. Arrondissements verläuft entlang eines baumgesäumten Kanals, an dessen Ufern Einheimische picknicken, während unabhängige Kaffeeröstereien, Naturweinbars und Vintage-Läden die Seitenstraßen füllen. Er hat keines der Postkartenmonumente, dafür alles vom Viertelleben, das Nächste, was Paris an einem Abend unter Einheimischen statt unter Besuchern bietet. Rechnen Sie mit einer Metrofahrt zum Eiffelturm oder zum Louvre, denn nichts Schlagzeilenträchtiges liegt in Gehweite.",
      pros: [
        "Das wirklich einheimischste Nachtleben der Stadt, mit Naturweinbars und Picknicks am Kanal",
        "Essen und Trinken kosten hier beide weniger als überall in der Nähe des Touristenzentrums",
        "Metroanbindungen ins Marais und den Rest des rechten Ufers sind schnell und direkt",
      ],
      cons: [
        "Eine Metrofahrt trennt dieses Viertel vom Eiffelturm, dem Louvre und den Inseln",
        "Fast keine Top-Sehenswürdigkeiten liegen in Gehweite",
        "Manche Straßen nahe dem Kanal wirken nach Einbruch der Dunkelheit unwirtlich",
      ],
    },
  ],
