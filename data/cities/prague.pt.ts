...
const praguePt: CityData = {
  city: {
    ...
    tagline: "A margem do Vltava onde escolhe dormir continua a decidir a viagem.",
    heroIntro:
      "Praga encaixa um castelo, uma ponte medieval e um centro histórico totalmente intacto numa zona que se atravessa a pé em meia hora, e continua a ser uma das capitais clássicas mais baratas da Europa para dormir. O lado do rio, e o bairro por trás dele, que escolhe continua a moldar a viagem: vielas de postal e multidões, calma do lado do castelo, ou uma base local mais barata a um elétrico de distância. Este guia pesa cinco bairros que vale a pena reservar, para que possa programar os grandes monumentos em torno das vagas de grupos turísticos, em vez de contra elas.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Calçada, torres e vielas que terminam em pátios enchem o núcleo medieval em torno da Praça da Cidade Velha, tornando-o o quilómetro quadrado mais movimentado do país durante o dia. Depois das 22h os grupos turísticos dispersam depressa e as ruas ficam mesmo sossegadas. Reserve aqui se esta for uma viagem curta e quiser tudo o que um visitante de primeira viagem procura a dez minutos a pé, preços turísticos incluídos.",
      pros: [
        "A Ponte Carlos, a Praça da Cidade Velha e Josefov ficam todos a uma curta distância a pé",
        "A maior oferta de hotéis e apartamentos da cidade",
        "Não precisa de transportes públicos para uma visita de dois dias",
      ],
      cons: [
        "Os restaurantes na praça principal têm preços para turistas, não para locais",
        "As noites de fim de semana trazem ruído de rua e grupos de despedidas de solteiro",
        "Os quartos custam mais 20 a 30 por cento do que o mesmo padrão em Vinohrady",
      ],
    },
    {
      slug: "mala-strana",
      ...
      vibe: "Telhados vermelhos, jardins de embaixadas e vielas barrocas enchem este bairro aos pés do castelo, na margem oeste do Vltava, que esvazia por completo assim que os visitantes de um dia regressam ao outro lado do rio ao fim da tarde. Dormir aqui significa acordar do lado do castelo, o que se transforma numa verdadeira vantagem de tempo para os grandes monumentos. Reserve aqui se preferir uma Ponte Carlos vazia de manhã cedo e noites calmas, mais do que proximidade aos restaurantes do centro histórico.",
      pros: [
        "O Castelo de Praga, a colina de Petrin e o Muro de Lennon ficam à porta",
        "As noites tornam-se calmas e genuinamente cheias de ambiente",
        "A Ponte Carlos antes do pequeno-almoço significa zero multidões",
      ],
      cons: [
        "Menos supermercados e opções de refeição económicas do que na margem leste",
        "As ruas íngremes de calçada são difíceis com bagagem ou um carrinho de bebé",
      ],
    },
    {
      slug: "vinohrady",
      ...
      vibe: "Prédios Arte Nova alinham-se numa malha residencial de praças arborizadas aqui, com a melhor concentração de cafés de toda a Praga. É aqui que se instalam os locais que podem escolher onde viver, e a cena de restaurantes mostra isso. Reserve aqui se quiser os monumentos do centro histórico a 10 minutos de metro sem pagar preços de centro histórico para dormir.",
      pros: [
        "A melhor comida e café de especialidade da cidade a preços locais",
        "O jardim de cerveja de Riegrovy Sady mais dois grandes parques",
        "Alojamento visivelmente mais barato do que no centro",
      ],
      cons: [
        "Todos os grandes monumentos exigem uma deslocação, mesmo que curta",
    ...
    },
    {
      ...
      vibe: "Mais cervejarias per capita do que em qualquer outro lugar da Europa dão a este bairro de arestas vivas a sua reputação, mais desgastado do que a vizinha Vinohrady e vigiado pela torre de televisão futurista. A cerveja barata e os bares de esquina continuam a dominar, mesmo à medida que gentrifica quarteirão a quarteirão. Reserve aqui se a base quase central mais barata importar mais do que o polimento, e não se importar com uma caminhada um pouco mais longa até aos monumentos.",
      pros: [
        "Os preços de quarto e de cerveja mais baixos perto do centro",
        "Verdadeira cultura de cervejaria, quase sem margem turística",
        "A colina de Vitkov oferece uma enorme vista gratuita sobre o centro histórico",
      ],
      cons: [
        "Alguns quarteirões parecem abandonados e carregados de graffiti",
        "20 a 30 minutos a pé ou de elétrico até aos principais monumentos",
        "As noites de fim de semana trazem ruído de bares nas ruas principais",
      ],
    },
    {
      slug: "karlin",
      ...
      vibe: "Reconstruído depois da cheia de 2002, este bairro plano à beira-rio é hoje o quarteirão moderno mais polido de Praga, com avenidas largas e prédios do século XIX renovados. A cena de brunch e cerveja artesanal aqui é dirigida diretamente aos residentes, não aos visitantes, e o centro histórico fica a apenas duas estações de metro. Reserve aqui se ruas planas, fáceis com carrinho de bebé, e um ambiente moderno importarem mais do que estar envolvido em arquitetura medieval.",
      pros: [
        "Ruas planas, fáceis com carrinho de bebé, e caminhos à beira-rio",
        "Excelentes restaurantes checos modernos a preços justos",
        "Uma ligação rápida ao centro pela linha B do metro",
      ],
      cons: [
        "Sem grandes monumentos no próprio bairro",
        "Vida noturna discreta, com bares a fechar cedo para os padrões de Praga",
      ],
    },
  ],
