...
const parisIt: CityData = {
  city: {
    ...
    tagline: "Parigi è troppo grande da attraversare a piedi, quindi l'arrondissement che si prenota decide quanta parte di ogni giornata finisce in metro.",
    heroIntro:
      "Parigi distribuisce i suoi monumenti su una dozzina di arrondissement che nessun visitatore percorre da un capo all'altro a piedi, ed è proprio per questo che il quartiere in cui si dorme plasma il viaggio più di qualsiasi itinerario. Questa guida mette a confronto le cinque zone che vale la pena prenotare, dai vicoli alla moda del Marais ai bar lungo il canale nel nordest, e indica l'hotel che in ciascuna vale il suo prezzo.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Vicoli medievali e grandi hotel particuliers riempiono il 3° e il 4° arrondissement nell'angolo più alla moda del centro di Parigi, tra boutique, gallerie e una scena di bar che continua ben oltre la chiusura dei negozi. La grande Place des Vosges fa da fulcro al quartiere, e Notre-Dame, il Louvre e le isole si raggiungono a piedi, non in metro. Conviene prenotare qui per una base elegante e centrale, con dove andare dopo cena.",
      pros: [
        "Notre-Dame, le isole, il Louvre e il Pompidou sono tutti a distanza pedonale",
        "La migliore concentrazione di boutique e gallerie del centro di Parigi",
        "Bar e cucine aperte fino a tardi tengono il quartiere sveglio ben oltre cena, senza bisogno della metro",
      ],
      cons: [
        "Tariffe alberghiere e conti al ristorante sono più alti qui che quasi ovunque altrove",
        "Le sere del weekend rendono i vicoli stretti rumorosi e davvero affollati",
        "La domenica porta la sua ressa, dato che qui molti negozi restano aperti mentre il resto di Parigi chiude",
      ],
    },
    {
      slug: "saint-germain",
      ...
      vibe: "Il vecchio quartiere letterario della Rive Gauche vive ancora della fama del Cafe de Flore e dei Deux Magots, ma il vero fascino sta in quanto risulti centrale e senza fretta, con gallerie eleganti, i Giardini del Lussemburgo ai suoi margini e il Museo d'Orsay a pochi passi oltre il fiume. È raffinato più che autentico, il tipo di zona adatta a una prima visita o a un viaggio fatto di mattine lente. Conviene prenotare qui per una base elegante e senza stress, che tiene comunque a portata di piedi la Senna e il Quartiere Latino.",
      pros: [
        "Breve passeggiata dall'Orsay, dall'attraversamento del fiume verso il Louvre e dai Giardini del Lussemburgo",
        "Tranquillo, centrale e facile da orientarsi, una scelta indulgente per un primo soggiorno",
        "Due linee della metro e l'accesso al RER raggiungono entrambi gli aeroporti e Versailles senza il mal di testa dei cambi",
      ],
      cons: [
        "Sia le camere d'albergo sia un caffè nei locali celebri costano un premio",
        "La vita notturna dopo cena è più tranquilla che nel Marais o nel quartiere del canale",
        "Risulta raffinato e rivolto ai visitatori più che davvero vissuto",
      ],
    },
    {
      slug: "montmartre",
      ...
      vibe: "La collina sopra il 18° arrondissement conserva un'atmosfera da paese che il resto del centro di Parigi ha perso da tempo, con le sue scalinate acciottolate e le piccole piazze che salgono verso le cupole bianche del Sacre-Coeur. Basta allontanarsi di una strada o due dalla folla attorno alla basilica e a Place du Tertre per trovare enoteche e un ritmo davvero locale. Si dorme più economico rispetto al centro, ma ogni discesa verso il Louvre o la Senna significa una corsa in metro, non una passeggiata.",
      pros: [
        "Il panorama gratuito dai gradini del Sacre-Coeur batte qualsiasi punto panoramico a pagamento della città",
        "Le camere qui costano decisamente meno che nella Rive Droite centrale",
        "Vicoli tranquilli e bar locali compaiono non appena si superano i gruppi in tour",
      ],
      cons: [
        "Ogni attrazione principale più in basso è una corsa in metro, non una camminata",
        "Scale ripide e pendii ovunque rendono faticoso muoversi con valigie o passeggini",
        "I gradini della basilica e Place du Tertre sono noto terreno di borseggiatori e venditori insistenti",
      ],
    },
    {
      slug: "latin-quarter",
      ...
      vibe: "Le strade costruite attorno alla Sorbona nel 5° arrondissement restano animate da librerie, cucine economiche ed energia studentesca tra il Pantheon e il fiume. È abbastanza vicino da raggiungere a piedi Notre-Dame, le isole e i Giardini del Lussemburgo, con letti che in genere costano meno della più raffinata Saint-Germain accanto. Vivace di giorno, diventa un po' ruvido nei suoi angoli più turistici quando arriva la folla serale.",
      pros: [
        "Notre-Dame, la Sainte-Chapelle e le isole sono tutte raggiungibili a piedi oltre il fiume",
        "Camere e pasti costano entrambi meno che nella vicina Saint-Germain",
        "I collegamenti RER e metro da qui raggiungono Versailles ed entrambi gli aeroporti in modo diretto",
      ],
      cons: [
        "Rue de la Huchette e le strade circostanti sono costellate di cucine da trappola per turisti",
        "La zona attorno alla Sorbona e al lungofiume diventa affollata e rumorosa",
        "Gli edifici antichi comportano camere talvolta piccole, con pavimenti e scale scricchiolanti",
      ],
    },
    {
      ...
      vibe: "Questo tratto del 10° e 11° arrondissement corre lungo un canale alberato dove i residenti fanno picnic sulle rive e torrefazioni indipendenti, enoteche di vini naturali e negozi vintage riempiono le vie laterali. Non ha nessuno dei monumenti da cartolina ma tutta la vita di quartiere, la cosa più vicina a Parigi a una serata trascorsa tra residenti anziché tra visitatori. Bisogna mettere in conto una corsa in metro per raggiungere la Torre Eiffel o il Louvre, dato che nessuna attrazione di primo piano si trova a distanza pedonale.",
      pros: [
        "La vita notturna più genuinamente locale della città, tra enoteche di vini naturali e picnic lungo il canale",
        "Cibo e bevande costano entrambi meno qui che in qualsiasi zona vicina al centro turistico",
        "I collegamenti in metro verso il Marais e il resto della Rive Droite sono rapidi e diretti",
      ],
      cons: [
        "Una corsa in metro separa questo quartiere dalla Torre Eiffel, dal Louvre e dalle isole",
        "Quasi nessuna attrazione di primo piano si trova a distanza pedonale",
        "Alcune strade vicino al canale danno una sensazione poco raccomandabile a tarda notte",
      ],
    },
  ],
