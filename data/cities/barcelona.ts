...
const barcelona: CityData = {
  city: {
    ...
    tagline: "Where you sleep decides whether your Barcelona runs on gothic lanes, Gaudi's grid or the sand.",
    heroIntro:
      "Barcelona packs Gaudi's modernist landmarks, a medieval old town and a city beach into a center small enough to walk, with the metro picking up the rest. Where you base yourself decides which version of the city you get each morning: cheap gothic lanes, a stylish old-town corner, the orderly Gaudi grid, a village-like local square, or sand outside the door. This guide compares five neighborhoods worth booking and names the trade-offs each one asks you to make.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Stone lanes twist between the cathedral and La Rambla here, opening onto hidden squares in a maze that still forms the medieval heart of the city. Everything a first-time visitor wants sits within ten minutes on foot, and the streets turn genuinely atmospheric once the day crowds thin after dark. Book here if budget and proximity outrank a quiet night, and keep a close eye on your bag, since this is also the most pickpocket-worked quarter in town.",
      pros: [
        "The cathedral, La Rambla, the port and El Born are all walkable",
        "Thick with cheap tapas bars, cafes and small hotels",
        "Lanes that empty out and glow after dinner",
      ],
      cons: [
        "The most pickpocket-heavy patch of the city, worst near La Rambla",
        "Foot traffic and bar noise run late, tough on light sleepers",
        "A few main-square restaurants coast on their location rather than the food",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Just east of the gothic core, medieval lanes here wrap around the church of Santa Maria del Mar and the Picasso Museum, lined with boutiques, wine bars and cocktail spots. It stays lively after dark without tipping into a tourist trap, carrying the old town's atmosphere with a more grown-up, design-conscious edge. Book here if you want the old-town feel with better food and drink, and don't mind paying a bit more for it.",
      pros: [
        "The old town's strongest run of wine bars, cocktail spots and tapas",
        "Walking distance to the Picasso Museum, Santa Maria del Mar and Ciutadella park",
        "Cobbled lanes that stay lively while keeping a local, boutique character",
      ],
      cons: [
        "Weekend nights get loud around the main lanes",
        "No metro station inside the district, though Jaume I and Barceloneta sit close",
        "Hotel rates run higher than the gothic quarter next door",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "Wide 19th-century boulevards and chamfered corners define this grid, home to the city's densest run of modernist facades along Passeig de Gracia. It puts Casa Batllo, La Pedrera and Sagrada Familia within a short walk, all sitting on a well-connected metro network. Book here if you want central and orderly without the crush of the old town, especially on a first Gaudi-focused visit.",
      pros: [
        "Passeig de Gracia's Gaudi houses are walkable, and Sagrada Familia is close",
        "A dense metro grid with direct links to the airport train and beyond",
        "Wide streets that go quiet at night, plus a good spread of mid-range hotels",
      ],
      cons: [
        "Feels more functional than romantic next to the old town lanes",
        "Sleeping right on Passeig de Gracia comes at a premium",
        "Some blocks are a long, straight walk from the beach or port",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "This former village, swallowed by the city north of the Eixample, has kept its own plaza-by-plaza layout and a strong sense of local identity. Independent shops, bohemian bars and family-run kitchens ring squares where locals drink outdoors on warm evenings, with Park Guell sitting up the hill above it all. Book here if you'd rather come home to a real neighborhood than a postcard, and can live with a 20-minute trip into the old town.",
      pros: [
        "Genuine neighborhood life, with plazas full of locals rather than tour groups",
        "Better-value dining and an unpretentious bar scene",
        "Walkable up to Park Guell, with the metro handling the rest",
      ],
      cons: [
        "A 20 to 25-minute walk or metro ride from the old town and the beach",
        "The busiest plazas get loud on weekend evenings",
    ...
    },
    {
      ...
      vibe: "Wedged between the port and the city beach, this old fishermen's quarter is a tight grid of narrow blocks that opens directly onto the sand. It has plenty of character by day, with seafood restaurants and the boardwalk right outside, and the seafront bars keep it running late through summer nights. Book here if the beach is the actual point of the trip, not an afternoon add-on.",
      pros: [
        "Steps from the city beach and boardwalk, no transit required",
        "A metro stop on line L4, a couple of stops from the old town",
        "Honest seafood and vermouth bars just a street back from the water",
      ],
      cons: [
        "Seafront restaurants lean tourist trap, so eat a street inland instead",
        "Flats run cramped and hot in summer, with noise near the beach bars",
        "A walk or metro ride separates you from the Gaudi sights up in the Eixample",
      ],
    },
  ],
