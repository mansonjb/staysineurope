...
const amsterdamDe: CityData = {
  city: {
    ...
    tagline: "Fünf ganz unterschiedliche Ringe um denselben Grachtengürtel, und Ihre Adresse entscheidet, welches Amsterdam Sie bekommen.",
    heroIntro:
      "Amsterdams Zentrum lässt sich in einer halben Stunde zu Fuß durchqueren, doch welche Hälfte davon Sie zum Schlafen wählen, entscheidet über den ganzen Aufenthalt: Postkarten-Grachtenblick zu Touristenpreisen oder ein ruhigeres Viertel mit einer Tramfahrt obendrauf. Dieser Guide wägt fünf ganz unterschiedliche Standorte ab, vom dichten historischen Kern bis zum grünen Westen, und zeigt, wo welcher Reisetyp tatsächlich am besten aufgehoben ist. Lesen Sie sich die Viertel unten durch, bevor Sie buchen, denn in einer so kompakten Stadt entscheidet die Adresse mehr als der Reiseplan.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Der Dam-Platz und die ältesten Grachtenstraßen liegen mitten in diesem Viertel, ab dem Frühstück voller Besucher und nachts laut rund um das Rotlichtviertel. Nichts hier ist mehr als zehn Gehminuten entfernt, das ist der ganze Handel: Sie geben Ruhe auf und zahlen den Lageaufschlag dafür, dass Sie nie eine Tram brauchen. Buchen Sie hier, wenn es eine kurze Reise ist und jede gesparte Minute mehr zählt als eine gute Nachtruhe.",
      pros: [
        "Jede Hauptsehenswürdigkeit, vom Dam bis zu den Neun Straßen, ist ein Spaziergang, keine Fahrt",
        "Die größte Hotelauswahl der Stadt, plus jede Tramlinie führt hier durch",
        "Ein Zweitagesbesuch kommt völlig ohne öffentlichen Nahverkehr aus",
      ],
      cons: [
        "Küchen an den Hauptstraßen verlangen Touristenpreise für durchschnittliches Essen",
        "Junggesellenabschiede und nächtlicher Lärm ballen sich rund um das Rotlichtviertel",
        "Zimmer kosten spürbar mehr als derselbe Standard in De Pijp oder Oud-West",
      ],
    },
    {
      slug: "jordaan",
      ...
      vibe: "Schmale Grachten, Giebelfassaden und versteckte Hofgärten machen dieses Viertel zu dem Ort, an dem jede Amsterdam-Postkarte entsteht, doch die menschlich dimensionierten Straßen bleiben ruhiger als die Altstadt, sobald die Tagesausflügler weiterziehen. Unabhängige Läden und braune Cafés, in denen Einheimische noch trinken, geben ihm ein gewachsenes Gefühl, das das Zentrum größtenteils verloren hat. Buchen Sie hier, wenn Ihnen das Anne-Frank-Haus und die westlichen Grachten wichtiger sind als ein paar gesparte Gehminuten, und Sie bereit sind, für den Ausblick zu zahlen.",
      pros: [
        "Die schönsten Grachtenblicke der Stadt, mit dem Anne-Frank-Haus in kurzer Gehdistanz",
        "Eine starke Auswahl an braunen Cafés, kleinen Galerien und einem Samstagsmarkt",
        "Wohnlich und ruhig bei Nacht, aber trotzdem nah an allem",
      ],
      cons: [
        "Zimmer kosten mehr als in den südlichen oder westlichen Vierteln",
        "Grachtenhaus-Hotels sind oft schmal, mit steilen Treppen und ohne Aufzug",
        "Wenige große Supermärkte und kaum günstige Gastronomie in der Nähe",
      ],
    },
    {
      slug: "de-pijp",
      ...
      vibe: "Südlich des Zentrums ist dieses dichte Raster rund um den täglichen Albert-Cuyp-Markt gewachsen und lebt bis heute vom Appetit der jungen Amsterdamer, die hier tatsächlich wohnen. Restaurants und Bars unterbieten das Zentrum preislich, ohne bei der Qualität nachzugeben, und das Museumsviertel liegt nur zehn Gehminuten oder eine Tramstation entfernt. Buchen Sie hier, wenn gutes Essen und Trinken Ihnen ebenso wichtig sind wie die Sehenswürdigkeiten, und Sie gerne Grachtenblick gegen besseres Preis-Leistungs-Verhältnis eintauschen.",
      pros: [
        "Die dichteste Essens- und Barszene der Stadt zum besten Preis-Leistungs-Verhältnis",
        "Der Albert-Cuyp-Markt und der Sarphatipark direkt vor der Tür",
        "Ein kurzer Spaziergang vom Rijksmuseum und Museumsviertel entfernt",
      ],
      cons: [
        "Keine Wahrzeichen des Grachtengürtels innerhalb des Viertels selbst",
        "Markt- und Barstraßen werden zu Stoßzeiten laut und voll",
        "Die Beliebtheit hat die Zimmerpreise über ihr altes Schnäppchenniveau getrieben",
      ],
    },
    {
      slug: "oud-west",
      ...
      vibe: "Westlich des Vondelparks geben baumbestandene Straßen und die belebte Markthalle Foodhallen den Ton an, in einem Viertel, in dem Familien und Berufstätige tatsächlich wohnen statt nur durchzuziehen. Das verleiht ihm ein gesetztes, untouristisches Gefühl und Preise deutlich unter dem Grachtengürtel, während Trams die zehn Minuten ins Zentrum überbrücken. Buchen Sie hier, wenn Sie den Park und ein gutes Essen vor der Tür wollen und nicht mitten in der Postkarte wohnen müssen.",
      pros: [
        "Der Vondelpark und die Foodhallen sind beide nur wenige Gehminuten entfernt",
        "Ruhigere, familienfreundliche Straßen zu einem niedrigeren Preis",
        "Direkte Tramlinien ins Zentrum und zum Museumsviertel",
      ],
      cons: [
        "Jede größere Sehenswürdigkeit erfordert eine kurze Fahrt, auch wenn diese schnell ist",
        "Keine Grachten oder Wahrzeichen-Architektur innerhalb des Viertels",
        "Das Nachtleben ist hier ruhiger als in De Pijp oder im Zentrum",
      ],
    },
    {
      slug: "oost",
      ...
      vibe: "Östlich des Zentrums rund um den Oosterpark treffen renovierte Blocks aus dem 19. Jahrhundert auf eine der stärksten multikulturellen Essensszenen der Stadt, in einem Viertel, das noch im Aufwind ist. Es ist die Preis-Leistungs-Wahl dieser Liste: grüne, ruhige Straßen, echte Viertelrestaurants und Zimmerpreise deutlich unter dem Zentrum, während Metro und Trams die zehn bis fünfzehn Minuten ins Zentrum überbrücken. Buchen Sie hier, wenn Ihnen das Budget wichtiger ist als die Nähe und eine authentische Essensszene einen Grachtenblick schlägt.",
      pros: [
        "Die günstigsten Zimmer aller zentrumsnahen Viertel",
        "Eine wirklich vielfältige Essensszene mit kaum Touristenaufschlag",
        "Oosterpark, der Zoo Artis und das Tropenmuseum alle in der Nähe",
      ],
      cons: [
        "Von diesen Vierteln am weitesten von den Sehenswürdigkeiten des Grachtengürtels entfernt",
        "Weitläufig genug, dass Sie eher auf Tram oder Metro als aufs Gehen angewiesen sind",
        "Weniger Wahrzeichen-Attraktionen innerhalb des Viertels selbst",
      ],
    },
  ],
