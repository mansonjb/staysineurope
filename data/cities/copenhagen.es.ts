...
const copenhagenEs: CityData = {
  city: {
    ...
    tagline: "Cinco barrios muy distintos, a un paseo en bici de distancia: elige bien y el viaje sigue su rumbo.",
    heroIntro:
      "Copenhague se divide en barrios de bolsillo que apenas se parecen entre sí, así que dónde duermas decide si el viaje transcurre entre plazas reales, la calma de los canales o cocinas que sirven hasta tarde. El casco antiguo pone todas las grandes atracciones a pie, pero lo cobra caro; Vesterbro y Nørrebro cambian las vistas de postal por la comida que de verdad comen los locales, y Christianshavn flota en un punto más tranquilo entre ambos extremos. Esta guía repasa los cinco para que la cama que reserves encaje con la ciudad que de verdad quieres.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Este núcleo medieval se extiende entre Strøget, los palacios y los canales, con casi todas las grandes atracciones a menos de diez minutos a pie. Es denso y elegante de día, más tranquilo en cuanto cierran las tiendas, y deja la Torre Redonda, Rosenborg y Nyhavn todos a pie. Alójate aquí si el viaje es corto y prefieres pagar por la comodidad antes que por una habitación más grande.",
      pros: [
        "La Torre Redonda, Rosenborg, Strøget y Nyhavn, todos a pie",
        "La mejor caminabilidad y las mejores conexiones de metro de la ciudad",
        "Una visita de dos días se hace entera a pie",
      ],
      cons: [
        "Las tarifas de habitación están entre las más altas de la ciudad",
        "Las calles principales aplican un sobreprecio turístico en comida y bebida",
        "Menos restaurantes de barrio que en Nørrebro o Vesterbro",
      ],
    },
    {
      slug: "nyhavn",
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "Es la vista que todo visitante imagina antes de aterrizar: un corto canal del siglo XVII bordeado de fachadas de colores, barcos de madera amarrados y bares con terraza apretados en verano. Dormir tan cerca pone el puerto y el barrio real a la puerta de casa, aunque la propia orilla se vuelve ruidosa y cara en cuanto sale el sol. Alójate aquí si la vista al canal te importa más que una noche tranquila, y no te molesta comer una calle más allá.",
      pros: [
        "Duermes justo en el canal más fotografiado de la ciudad",
        "El barrio real, Amalienborg y los embarcaderos de los barcos del canal a un corto paseo",
        "Bien conectado por metro y por los autobuses del puerto",
      ],
      cons: [
        "Los restaurantes junto al agua cobran caro por las vistas",
        "Las tardes de verano traen ruido y multitudes justo en la puerta",
        "Las habitaciones económicas escasean tan cerca del canal",
      ],
    },
    {
      slug: "vesterbro",
      ...
      vibe: "Antiguo barrio rojo y de mataderos de Copenhague, este barrio al oeste de la Estación Central se ha convertido en el rincón más afilado de la ciudad para comer y salir de noche. Las viejas naves del matadero de Kødbyen albergan hoy bares de vino natural y panaderías donde los jóvenes locales, no los grupos turísticos, pasan de verdad sus noches. Alójate aquí si quieres precios reales de Copenhague y una noche más animada, con Tivoli y el centro todavía a un paseo fácil.",
      pros: [
        "La mejor escena gastronómica y de vida nocturna en relación calidad-precio",
        "Los bares de Kødbyen y la Estación Central, ambos cerca",
        "Un paseo fácil hasta Tivoli y el centro",
      ],
      cons: [
        "Algunas calles todavía se sienten un poco ásperas de madrugada",
        "Ningún canal ni monumento emblemático dentro del propio barrio",
        "Las zonas de vida nocturna se mantienen ruidosas después de anochecer",
      ],
    },
    {
      slug: "norrebro",
      ...
      vibe: "Al norte de los lagos, es el barrio más joven y mestizo de la ciudad, anclado en el parque de retazos Superkilen y en los cafés que bordean Jægersborggade. La escena gastronómica de barrio aquí se sostiene con panaderías y parrillas de Oriente Medio en lugar de menús turísticos, a precios que el centro dejó atrás hace tiempo. Alójate aquí si prefieres comer como un local y no te importa un paseo de quince minutos o un corto trayecto en autobús hasta el casco antiguo.",
      pros: [
        "Las habitaciones más baratas entre los barrios más o menos céntricos",
        "Una sólida escena gastronómica independiente, con poco sobreprecio turístico",
        "Superkilen, el cementerio de Assistens y Jægersborggade cerca",
      ],
      cons: [
        "El más alejado de estos cinco barrios de las atracciones del puerto",
        "Lo bastante extenso como para depender de la bici o el autobús",
        "La cobertura de metro es irregular, aunque los autobuses pasan con frecuencia",
      ],
    },
    {
      slug: "christianshavn",
      ...
      vibe: "Trazada por orden de Christian IV, esta isla surcada de canales mezcla casas flotantes y muelles adoquinados con la ciudad libre de Christiania justo en su borde. Cambia el ajetreo del casco antiguo por algo más residencial, aunque se queda a solo una parada de metro o un paseo por el puerto del centro. Alójate aquí si quieres vistas al agua y noches tranquilas sin renunciar a un cruce fácil hacia todo lo demás.",
      pros: [
        "Canales y casas flotantes lejos de las multitudes",
        "A una parada de metro o un paseo del centro, con Christiania al lado",
        "Cafés locales de verdad y el frente portuario a pie",
      ],
      cons: [
        "Menos hoteles, así que las opciones y la disponibilidad son más ajustadas",
        "Una vida nocturna más tranquila que en Vesterbro o Nørrebro",
        "La mayoría de las atracciones céntricas exigen cruzar el puerto",
      ],
    },
  ],
