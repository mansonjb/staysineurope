...
const amsterdam: CityData = {
  city: {
    ...
    tagline: "Five very different rings around one canal belt, and your address decides which Amsterdam you get.",
    heroIntro:
      "Amsterdam's center fits inside a half-hour walk, but which half you sleep in still decides the whole visit: postcard canal views and tourist prices, or a quieter district with a tram ride to match. This guide weighs five very different bases, from the packed historic core to the leafy west, and points to where each type of traveller actually sleeps best. Read the neighborhoods below before you book, because in a city this compact the address does more work than the itinerary.",
