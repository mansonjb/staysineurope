...
const barcelonaPt: CityData = {
  city: {
    ...
    tagline: "Onde dorme decide se a sua Barcelona vive das vielas góticas, da grelha de Gaudí ou da areia.",
    heroIntro:
      "Barcelona junta os marcos modernistas de Gaudí, uma cidade velha medieval e uma praia urbana num centro pequeno o suficiente para se percorrer a pé, com o metro a tratar do resto. Onde se instala decide que versão da cidade tem cada manhã: vielas góticas baratas, um canto elegante da cidade velha, a grelha ordenada de Gaudí, uma praça de bairro com ar de aldeia, ou areia à porta. Este guia compara cinco bairros que vale a pena reservar e indica as trocas que cada um lhe pede para fazer.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Vielas de pedra serpenteiam entre a catedral e La Rambla, abrindo-se para praças escondidas num labirinto que continua a ser o coração medieval da cidade. Tudo o que um visitante de primeira vez quer fica a dez minutos a pé, e as ruas ganham uma atmosfera genuína assim que as multidões do dia rareiam ao anoitecer. Reserve aqui se o orçamento e a proximidade pesarem mais do que uma noite tranquila, e vigie bem a mala, já que este é também o bairro mais trabalhado pelos carteiristas da cidade.",
      pros: [
        "A catedral, La Rambla, o porto e El Born ficam todos a pé",
        "Repleto de bares de tapas baratos, cafés e pequenos hotéis",
        "Vielas que se esvaziam e ganham brilho depois do jantar",
      ],
      cons: [
        "A zona com mais carteiristas da cidade, pior perto de La Rambla",
        "Movimento de peões e barulho de bares até tarde, difícil para quem tem sono leve",
        "Alguns restaurantes das praças principais vivem só da localização, não da comida",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Mesmo a leste do núcleo gótico, vielas medievais rodeiam aqui a igreja de Santa Maria del Mar e o Museu Picasso, ladeadas de boutiques, wine bars e bares de coquetéis. Mantém-se animado à noite sem cair em armadilha para turistas, mantendo a atmosfera da cidade velha com um toque mais adulto e atento ao design. Reserve aqui se quiser a sensação de cidade velha com melhor comida e bebida, e não se importar de pagar um pouco mais por isso.",
      pros: [
        "A melhor oferta de wine bars, bares de coquetéis e tapas da cidade velha",
        "A uma curta caminhada do Museu Picasso, de Santa Maria del Mar e do parque da Ciutadella",
        "Vielas de calçada que se mantêm animadas mas guardam um carácter local e boutique",
      ],
      cons: [
        "As noites de fim de semana ficam barulhentas à volta das vielas principais",
        "Sem estação de metro dentro do bairro, embora Jaume I e Barceloneta fiquem perto",
        "Os preços de hotel são mais altos do que no bairro gótico ao lado",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "Largas avenidas do século XIX e esquinas chanfradas definem esta grelha, casa da maior concentração de fachadas modernistas da cidade ao longo do Passeig de Gràcia. Deixa a Casa Batlló, La Pedrera e a Sagrada Família a uma curta caminhada, todas servidas por uma rede de metro bem ligada. Reserve aqui se quiser central e ordenado sem o aperto da cidade velha, sobretudo numa primeira visita centrada em Gaudí.",
      pros: [
        "As casas de Gaudí no Passeig de Gràcia ficam a pé, e a Sagrada Família fica perto",
        "Uma grelha de metro densa, com ligações diretas ao comboio do aeroporto e mais além",
        "Ruas largas que ficam sossegadas à noite, mais uma boa oferta de hotéis de gama média",
      ],
      cons: [
        "Parece mais funcional do que romântico em comparação com as vielas da cidade velha",
        "Dormir mesmo no Passeig de Gràcia tem um preço premium",
        "Alguns quarteirões ficam a uma longa caminhada em linha reta da praia ou do porto",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "Esta antiga aldeia, engolida pela cidade a norte do Eixample, manteve o seu traçado de praça em praça e um forte sentido de identidade local. Lojas independentes, bares boémios e restaurantes de gestão familiar rodeiam praças onde os locais bebem ao ar livre nas noites quentes, com o Park Güell na colina acima de tudo isto. Reserve aqui se preferir voltar para um bairro a sério em vez de um postal, e não se importar com uma viagem de 20 minutos até à cidade velha.",
      pros: [
        "Vida de bairro genuína, com praças cheias de locais em vez de grupos de turistas",
        "Restaurantes com melhor relação qualidade-preço e uma cena de bares sem pretensões",
        "Sobe-se a pé até ao Park Güell, com o metro a tratar do resto",
      ],
      cons: [
        "A 20 a 25 minutos a pé ou de metro da cidade velha e da praia",
        "As praças mais movimentadas ficam barulhentas nas noites de fim de semana",
        "Menos hotéis de nome, mais apartamentos e pequenas casas de hóspedes",
      ],
    },
    {
      slug: "barceloneta",
      ...
      vibe: "Encaixado entre o porto e a praia urbana, este antigo bairro de pescadores é uma malha apertada de quarteirões estreitos que se abre diretamente para a areia. Tem muito carácter de dia, com marisqueiras e o passadiço mesmo à porta, e os bares da frente de mar mantêm-no animado até tarde nas noites de verão. Reserve aqui se a praia for mesmo o objetivo da viagem, e não apenas um extra de tarde.",
      pros: [
        "A poucos passos da praia urbana e do passadiço, sem precisar de transporte",
        "Uma estação de metro na linha L4, a poucas paragens da cidade velha",
        "Marisqueiras e bares de vermute honestos a apenas uma rua da água",
      ],
      cons: [
        "Os restaurantes da frente de mar tendem a armadilha para turistas, por isso coma antes uma rua para dentro",
        "Os apartamentos são apertados e quentes no verão, com barulho perto dos bares da praia",
        "Uma caminhada ou viagem de metro separa-o dos pontos de interesse de Gaudí lá em cima no Eixample",
      ],
    },
  ],
