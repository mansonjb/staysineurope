...
const viennaFr: CityData = {
  city: {
    ...
    tagline: "Cinq arrondissements, un ring : où vous dormez décide à quel point le séjour a des airs impériaux.",
    heroIntro:
      "Les plus grands sites de Vienne se serrent à l'intérieur de la Ringstrasse, mais les arrondissements alentour vivent à des rythmes complètement différents, entre l'élégance impériale feutrée du centre et les boutiques de design et tavernes à vin qui restent ouvertes bien après l'heure de coucher des palais. Le quartier où vous dormez décide si le séjour penche vers le formel et le central, ou vers le local et le moins cher, à un tramway de distance. Ce guide passe en revue les cinq arrondissements qui valent la réservation, du parvis de la cathédrale aux rues plus calmes de l'autre côté du canal du Danube.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Enroulé autour de la cathédrale Saint-Étienne et de la Hofburg à l'intérieur de la Ringstrasse, ce premier arrondissement est le coeur impérial : grands boulevards, cours à arcades et cafés historiques, l'image que tout le monde a de Vienne en tête. Tout ce qu'attend un premier séjour se trouve à moins de quinze minutes à pied, et la foule se disperse vite une fois les boutiques fermées pour la soirée. Logez ici si la commodité compte plus que le prix et que vous voulez faire tout le séjour impérial à pied.",
      pros: [
        "Cathédrale, Hofburg, Opéra national et grands musées, tout à pied",
        "Toutes les lignes de tram et de métro se croisent ici, parfait pour les excursions à la journée",
        "Un séjour de deux jours ne nécessite aucun transport",
      ],
      cons: [
        "L'arrondissement le plus cher de la ville, pour l'hôtel comme pour le dîner",
        "Les restaurants près de la cathédrale et du Graben vivent de la vue, pas de la cuisine",
        "La vie nocturne s'éteint vite une fois le dîner terminé",
      ],
    },
    {
      slug: "leopoldstadt",
      ...
      vibe: "De l'autre côté du canal du Danube, ce deuxième arrondissement mêle l'étendue verte du Prater à la vieille Vienne juive, aux épiceries turques et balkaniques et à une scène créative en pleine expansion. Le Karmelitermarkt ancre une scène culinaire et de cafés qui semble vraiment locale plutôt que mise en scène pour les visiteurs. Logez ici pour l'espace vert et la vraie vie de quartier, à un arrêt de métro des palais, à des tarifs bien inférieurs à ceux du centre.",
      pros: [
        "Le parc du Prater, la Grande Roue et de longs chemins le long du canal, parfaits pour les familles",
        "Le Karmelitermarkt et le Volkertmarkt pour une cuisine locale à prix justes",
        "Les lignes U1 et U2 rapides gardent le centre à un arrêt",
      ],
      cons: [
        "Aucun site majeur dans l'arrondissement en dehors du Prater lui-même",
        "Les rues près des stations peuvent sembler quelconques et inachevées",
        "Les soirées restent résidentielles et calmes si vous cherchez à sortir",
      ],
    },
    {
      slug: "neubau",
      ...
      vibe: "Derrière le MuseumsQuartier, ce septième arrondissement est là où vit vraiment la scène design de Vienne : les ruelles pavées Biedermeier de Spittelberg abritent tavernes à vin et boutiques, tandis que la Neubaugasse aligne concept stores, torréfacteurs et petits bars. On reste à distance de marche des grands musées, mais on sent que ce sont les soirées que les habitants choisissent pour eux-mêmes. Logez ici pour être près des grands sites sans dormir dans une carte postale.",
      pros: [
        ...
        "Une scène de bars et de tavernes à vin animée et sans prétention le soir",
      ],
      cons: [
        "Une marche ou un court trajet en tram vous sépare des sites du premier arrondissement",
        "Les rues prisées deviennent bruyantes les soirs de week-end",
        "Peu de grands hôtels, surtout des appartements et des adresses de charme",
      ],
    },
    {
      slug: "mariahilf",
      ...
      vibe: "Le sixième arrondissement longe la Mariahilfer Strasse, la rue commerçante la plus fréquentée de la ville, avec le vaste Naschmarkt ancré à son extrémité basse. Il équilibre le pratique et le pittoresque : des hôtels milieu de gamme fiables en haut, des étals de nourriture et un marché aux puces du samedi en bas près du marché. Logez ici pour un bon rapport qualité-prix garanti et quinze minutes à pied en ligne droite, ou deux arrêts de métro, jusqu'au centre.",
      pros: [
        "Les étals du Naschmarkt et le marché aux puces du samedi à deux pas",
        "Le plus grand choix d'hôtels solides, milieu de gamme et petit budget",
        "Accès direct par le U3 et un itinéraire piéton jusqu'au centre",
      ],
      cons: [
        "La rue commerçante principale est bondée et sans charme aux heures de pointe",
        "Moins de caractère qu'à Neubau, juste plus haut",
        "Les restaurants du Naschmarkt coûtent plus cher que ne le laisse penser la réputation des étals",
      ],
    },
    {
      slug: "landstrasse",
      ...
      vibe: "Au sud-est du ring, ce troisième arrondissement enveloppe le palais du Belvédère et ses jardins à la française, avec la Hundertwasserhaus et le Rochusmarkt qui complètent une zone résidentielle et calme. Il abrite aussi Wien Mitte, si bien que le train de l'aéroport y arrive plus vite que partout ailleurs dans la ville. Logez ici pour avoir le Belvédère et le ring à distance de marche, à des tarifs inférieurs à ceux du premier arrondissement.",
      pros: [
        "Le palais du Belvédère, ses jardins et Le Baiser de Klimt à quelques minutes",
        "Wien Mitte offre la liaison aéroport la plus rapide de la ville",
        "Plus calme et moins cher que le centre, tout en restant accessible à pied",
      ],
      cons: [
        "Assez étalé pour que certains hôtels soient à une vraie marche du moindre site",
        "Moins de restaurants marquants qu'à Neubau ou Leopoldstadt",
        "Pas de coeur animé unique pour ancrer une soirée",
      ],
    },
  ],
