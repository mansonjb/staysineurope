...
const amsterdamFr: CityData = {
  city: {
    ...
    tagline: "Cinq quartiers radicalement différents autour d'une même ceinture de canaux, et votre adresse décide de l'Amsterdam que vous aurez.",
    heroIntro:
      "Le centre d'Amsterdam se traverse en une demi-heure à pied, mais l'endroit précis où vous dormez décide quand même de tout le séjour : vues de carte postale sur les canaux et prix touristiques, ou quartier plus calme avec un trajet de tram en prime. Ce guide pèse cinq bases très différentes, du coeur historique bondé à l'ouest verdoyant, et indique où chaque type de voyageur dort vraiment le mieux. Lisez les quartiers ci-dessous avant de réserver, car dans une ville aussi compacte, l'adresse compte plus que l'itinéraire.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Le Dam et les plus vieilles rues à canaux occupent le coeur de ce quartier, dense de visiteurs dès le petit-déjeuner et bruyant la nuit près du quartier rouge. Rien n'y est à plus de dix minutes à pied, et c'est tout l'arbitrage : renoncer au calme et payer la prime d'emplacement pour ne jamais toucher un tram. Réservez ici pour un court séjour, si chaque minute gagnée compte plus qu'une bonne nuit de sommeil.",
      pros: [
        "Tous les sites incontournables, du Dam aux Neuf Petites Rues, se rejoignent à pied",
        "Le plus grand choix d'hôtels de la ville, et toutes les lignes de tram qui passent par là",
        "Un séjour de deux jours ne demande aucun transport en commun",
      ],
      cons: [
        "Les cuisines des rues principales facturent des prix touristiques pour une cuisine banale",
        "Enterrements de vie de garçon et bruit nocturne se concentrent autour du quartier rouge",
        "Les chambres coûtent nettement plus cher qu'un standard équivalent à De Pijp ou Oud-West",
      ],
    },
    {
      slug: "jordaan",
      ...
      vibe: "Canaux étroits, façades à pignon et jardins de cour cachés font de ce quartier celui de toutes les cartes postales d'Amsterdam, mais ses rues à échelle humaine restent plus calmes que le vieux centre une fois les visiteurs à la journée repartis. Boutiques indépendantes et brown cafes où les habitants boivent encore lui donnent un caractère vécu que le centre a largement perdu. Réservez ici si la maison d'Anne Frank et les canaux ouest comptent plus que quelques minutes de marche économisées, et que payer pour la vue ne vous dérange pas.",
      pros: [
        "Les plus belles vues sur les canaux de la ville, avec la maison d'Anne Frank à deux pas",
        "Une belle concentration de brown cafes, petites galeries et un marché le samedi",
        "Résidentiel et calme la nuit, mais toujours proche de tout",
      ],
      cons: [
        "Les chambres coûtent plus cher que dans les quartiers sud ou ouest",
        "Les hôtels en maison de canal sont souvent étroits, avec des escaliers raides et pas d'ascenseur",
        "Peu de grands supermarchés et pas beaucoup de restauration bon marché à proximité",
      ],
    },
    {
      slug: "de-pijp",
      ...
      vibe: "Au sud du centre, ce quadrillage serré s'est bâti autour du marché quotidien Albert Cuyp et vit toujours au rythme de l'appétit des jeunes Amstellodamois qui y habitent vraiment. Les restaurants et les bars cassent les prix du centre sans sacrifier la qualité, et le quartier des musées n'est qu'à dix minutes à pied ou un arrêt de tram. Réservez ici si bien manger et bien boire comptent autant que les sites, et que troquer la vue sur les canaux contre un meilleur rapport qualité-prix ne vous gêne pas.",
      pros: [
        "La scène de restaurants et de bars la plus dense et la plus abordable de la ville",
        "Le marché Albert Cuyp et le Sarphatipark juste devant la porte",
        "À courte distance à pied du Rijksmuseum et du quartier des musées",
      ],
      cons: [
        "Aucun monument de la ceinture de canaux dans le quartier lui-même",
        "Les rues du marché et des bars deviennent bruyantes et bondées aux heures de pointe",
        "Le succès a fait grimper les tarifs, loin de leurs anciens prix cassés",
      ],
    },
    {
      slug: "oud-west",
      ...
      vibe: "À l'ouest du Vondelpark, des rues bordées d'arbres et le Foodhallen bouillonnant donnent le tempo de ce quartier où familles et actifs vivent vraiment, plutôt que d'y passer en coup de vent. Il en résulte une ambiance installée, peu touristique, et des tarifs bien en dessous de la ceinture de canaux, les trams couvrant les dix minutes jusqu'au centre. Réservez ici si vous voulez le parc et un bon repas à votre porte, sans avoir besoin d'être dans la carte postale.",
      pros: [
        "Le Vondelpark et le Foodhallen sont tous deux à quelques minutes à pied",
        "Des rues plus calmes et familiales, à des prix plus doux",
        "Des trams directs vers le centre et le quartier des musées",
      ],
      cons: [
        "Chaque site majeur demande un petit trajet, même rapide",
        "Aucun canal ni architecture emblématique dans le quartier",
        "La vie nocturne y est plus calme qu'à De Pijp ou au centre",
      ],
    },
    {
      slug: "oost",
      ...
      vibe: "À l'est du centre, autour de l'Oosterpark, des immeubles du XIXe siècle rénovés côtoient l'une des scènes culinaires multiculturelles les plus fortes de la ville, dans un quartier encore en pleine ascension. C'est le bon plan de cette liste : rues arborées et tranquilles, vrais restaurants de quartier et chambres à des tarifs bien en dessous du centre, le métro et les trams comblant les dix à quinze minutes jusqu'en ville. Réservez ici si le budget compte plus que la proximité et qu'une scène culinaire authentique l'emporte sur la vue sur un canal.",
      pros: [
        "Les chambres les moins chères de tous les quartiers proches du centre",
        "Une scène culinaire vraiment diverse, avec peu de majoration touristique",
        "L'Oosterpark, le zoo Artis et le Tropenmuseum tout proches",
      ],
      cons: [
        "Le plus éloigné de ces quartiers par rapport aux sites de la ceinture de canaux",
        "Assez étendu pour dépendre du tram ou du métro plutôt que de la marche",
        "Moins d'attractions emblématiques dans le quartier lui-même",
      ],
    },
  ],
