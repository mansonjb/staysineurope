...
const viennaPt: CityData = {
  city: {
    ...
    tagline: "Cinco distritos, um único anel: onde dorme decide o quão imperial a viagem parece.",
    heroIntro:
      "As grandes atrações de Viena concentram-se dentro da Ringstrasse, mas os distritos à sua volta correm a velocidades completamente diferentes, da elegância imperial silenciosa às lojas de design e tabernas de vinho que ficam abertas muito depois de os palácios fecharem. O local onde dorme decide se a viagem pende para o formal e central ou para o local e mais barato, a um elétrico de distância. Este guia percorre os cinco distritos que vale a pena reservar, da porta da catedral às ruas mais calmas do outro lado do Canal do Danúbio.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Envolvendo a Catedral de Santo Estêvão e o Hofburg dentro da Ringstrasse, este primeiro distrito é o núcleo imperial: grandes avenidas, pátios arcados e os cafés que todos imaginam quando pensam em Viena. Tudo o que uma primeira visita procura fica a quinze minutos a pé, e as multidões dispersam depressa assim que as lojas fecham ao fim da tarde. Reserve aqui se a comodidade importar mais do que o preço e quiser toda a viagem imperial a pé.",
      pros: [
        "Catedral, Hofburg, Ópera Estatal e os principais museus, tudo a pé",
        "Todas as linhas de elétrico e metro convergem aqui, fácil para excursões de um dia",
        "Uma visita de dois dias não precisa de qualquer transporte",
      ],
      cons: [
        "O distrito mais caro da cidade em hotéis e jantares",
        "Os restaurantes perto da catedral e do Graben vivem da vista, não da comida",
        "A vida noturna esvazia assim que o jantar termina",
      ],
    },
    {
      slug: "leopoldstadt",
      ...
      vibe: "Do outro lado do Canal do Danúbio, este segundo distrito mistura a vasta zona verde do Prater com a velha Viena judaica, mercearias turcas e balcânicas e uma comunidade criativa em rápido crescimento. O Karmelitermarkt ancora uma cena de comida e cafés que parece genuinamente local, e não montada para visitantes. Reserve aqui se quiser espaço de parque e vida de bairro real a uma paragem de metro dos palácios, a preços bem abaixo do centro.",
      pros: [
        "O parque Prater, a Riesenrad e longos caminhos junto ao canal, ideais para famílias",
        "O Karmelitermarkt e o Volkertmarkt servem comida local a preços justos",
        "Ligações rápidas de metro U1 e U2 mantêm o centro a uma paragem",
      ],
      cons: [
        "Sem grandes atrações no distrito para além do próprio Prater",
        "As ruas perto das estações podem parecer sem graça e por acabar",
        "As noites mantêm-se residenciais e sossegadas, se procura vida noturna",
      ],
    },
    {
      slug: "neubau",
      ...
      vibe: "Atrás do MuseumsQuartier, este sétimo distrito é onde a comunidade do design de Viena realmente vive: as vielas de calçada Biedermeier de Spittelberg guardam tabernas de vinho e boutiques, enquanto a Neubaugasse alinha concept stores, torrefações de café e pequenos bares. Fica a pé dos grandes museus, mas tem o ambiente das noites que os locais escolhem para si próprios. Reserve aqui se quiser estar perto das grandes atrações sem dormir dentro de um postal.",
      pros: [
        ...
        "Uma cena de bares e tabernas de vinho animada e sem pretensões à noite",
      ],
      cons: [
        "Uma caminhada ou um curto trajeto de elétrico separa-o das atrações do primeiro distrito",
        "Os quarteirões populares ficam ruidosos nas noites de fim de semana",
        "Menos hotéis grandes, sobretudo apartamentos e alojamentos boutique",
      ],
    },
    {
      slug: "mariahilf",
      ...
      vibe: "O sexto distrito estende-se ao longo da Mariahilfer Strasse, a rua comercial mais movimentada da cidade, com o vasto Naschmarkt a ancorar a sua ponta inferior. Equilibra o prático com o pitoresco: hotéis de gama média fiáveis na parte de cima, bancas de comida e uma feira da ladra ao sábado junto ao mercado. Reserve aqui se quiser uma relação qualidade-preço segura e uma caminhada direta de quinze minutos, ou duas paragens de metro, até ao centro.",
      pros: [
        "As bancas de comida do Naschmarkt e a feira da ladra de sábado por perto",
        "A maior escolha de hotéis sólidos de gama média e económicos",
        "Acesso direto pelo U3 e uma rota pedonal até ao centro",
      ],
      cons: [
        "A rua comercial principal fica cheia e sem charme nas horas de ponta",
        "Menos carácter do que Neubau, logo ali acima na encosta",
        "Os restaurantes do Naschmarkt custam mais do que a fama das bancas de comida sugere",
      ],
    },
    {
      slug: "landstrasse",
      ...
      vibe: "A sudeste do anel, este terceiro distrito envolve o palácio Belvedere e os seus jardins formais, com a Hundertwasserhaus e o Rochusmarkt a completar uma zona residencial e calma. Alberga também Wien Mitte, por isso o comboio do aeroporto chega aqui mais depressa do que a qualquer outro ponto da cidade. Reserve aqui se quiser o Belvedere e o anel ao alcance a pé, por menos do que os preços do primeiro distrito.",
      pros: [
        "O palácio Belvedere, os seus jardins e O Beijo de Klimt a poucos minutos",
        "Wien Mitte oferece a ligação mais rápida ao aeroporto da cidade",
        "Mais calmo e mais barato do que o centro, mas ainda ao alcance a pé",
      ],
      cons: [
        "Suficientemente disperso para que alguns hotéis fiquem a uma verdadeira caminhada de qualquer atração",
        "Menos restaurantes de destaque do que Neubau ou Leopoldstadt",
        "Sem um único núcleo animado para ancorar uma noite",
      ],
    },
  ],
