...
const amsterdamEs: CityData = {
  city: {
    ...
    tagline: "Cinco anillos muy distintos alrededor de un mismo cinturón de canales, y tu dirección decide qué Amsterdam te toca.",
    heroIntro:
      "El centro de Amsterdam se cruza en media hora a pie, pero en qué mitad duermes sigue decidiendo toda la visita: vistas de postal a los canales y precios de turista, o un distrito más tranquilo con un trayecto de tranvía a la altura. Esta guía sopesa cinco bases muy distintas, desde el núcleo histórico abarrotado hasta el oeste frondoso, y señala dónde duerme mejor cada tipo de viajero. Lee los barrios de abajo antes de reservar, porque en una ciudad tan compacta la dirección pesa más que el itinerario.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "La plaza Dam y las calles de canal más antiguas ocupan el centro de este barrio, lleno de visitantes desde el desayuno y ruidoso de noche cerca del Barrio Rojo. Nada aquí queda a más de diez minutos a pie, y ese es todo el trato: renuncias a la tranquilidad y pagas la prima de ubicación a cambio de no tocar nunca un tranvía. Reserva aquí si el viaje es corto y cada minuto ahorrado importa más que dormir bien.",
      pros: [
        "Todos los sitios estrella, de la plaza Dam a las Nueve Callecitas, se hacen a pie, no en transporte",
        "La mayor oferta de hoteles de la ciudad, además de todas las líneas de tranvía pasando por aquí",
        "Una visita de dos días no necesita transporte público en absoluto",
      ],
      cons: [
        "Las cocinas de las calles principales cobran precios de turista por comida mediocre",
        "Despedidas de soltero y ruido nocturno se concentran cerca del Barrio Rojo",
        "Las habitaciones cuestan notablemente más que el mismo nivel en De Pijp u Oud-West",
      ],
    },
    {
      slug: "jordaan",
      ...
      vibe: "Canales estrechos, fachadas con gablete y jardines escondidos de patio convierten este barrio en el escenario de cada postal de Amsterdam, aunque las calles a escala humana se mantienen más tranquilas que el Centro histórico una vez que los visitantes de un día se marchan. Tiendas independientes y brown cafes donde los vecinos todavía beben le dan un aire habitado que el centro ha perdido en buena parte. Reserva aquí si la Casa de Ana Frank y los canales del oeste importan más que ahorrarte unos minutos en cada paseo, y no te importa pagar por la vista.",
      pros: [
        "Los mejores canales de la ciudad, con la Casa de Ana Frank a un corto paseo",
        "Una sólida oferta de brown cafes, pequeñas galerías y un mercado los sábados",
        "Residencial y tranquilo de noche, pero aun así cerca de todo",
      ],
      cons: [
        "Las habitaciones cuestan más que en los barrios del sur o del oeste",
        "Los hoteles en casas de canal suelen ser estrechos, con escaleras empinadas y sin ascensor",
        "Pocos supermercados grandes y no mucha oferta de comida económica cerca",
      ],
    },
    {
      slug: "de-pijp",
      ...
      vibe: "Al sur del centro, esta cuadrícula apretada creció en torno al mercado diario Albert Cuyp y todavía funciona con el apetito de los jóvenes de Amsterdam que de verdad viven aquí. Los restaurantes y bares bajan el precio respecto al centro sin renunciar a la calidad, y el Barrio de los Museos queda a solo diez minutos a pie o una parada de tranvía. Reserva aquí si comer y beber bien importa tanto como los sitios, y no te importa cambiar vistas de canal por mejor relación calidad-precio.",
      pros: [
        "La escena de comida y bares más densa y de mejor relación calidad-precio de la ciudad",
        "El Mercado Albert Cuyp y el Sarphatipark justo en la puerta",
        "A un corto paseo del Rijksmuseum y el Barrio de los Museos",
      ],
      cons: [
        "Ningún hito del anillo de canales dentro del propio barrio",
        "Las calles del mercado y de los bares se llenan y se ponen ruidosas en las horas punta",
        "La popularidad ha subido las tarifas de habitación respecto a su antiguo nivel de ganga",
      ],
    },
    {
      slug: "oud-west",
      ...
      vibe: "Al oeste del Vondelpark, calles arboladas y el bullicioso mercado gastronómico Foodhallen marcan el ritmo de este barrio, donde familias y profesionales viven de verdad en lugar de solo pasar por aquí. Eso le da un aire asentado y poco turístico, con tarifas bastante por debajo del anillo de canales, y los tranvías cubren los diez minutos hasta el centro. Reserva aquí si quieres el parque y una buena comida a la puerta de casa y no necesitas estar dentro de la postal.",
      pros: [
        "El Vondelpark y el Foodhallen quedan ambos a pocos minutos a pie",
        "Calles más tranquilas y familiares a un precio más bajo",
        "Tranvías directos al centro y al Barrio de los Museos",
      ],
      cons: [
        "Cada sitio importante exige un desplazamiento corto, aunque sea rápido",
        "Ningún canal ni arquitectura emblemática dentro del barrio",
        "La vida nocturna es más tranquila aquí que en De Pijp o el centro",
      ],
    },
    {
      slug: "oost",
      ...
      vibe: "Al este del centro, en torno al Oosterpark, bloques del siglo XIX renovados se encuentran con una de las escenas gastronómicas multiculturales más fuertes de la ciudad, en un barrio todavía en ascenso. Es la apuesta con mejor relación calidad-precio de esta lista: calles frondosas y tranquilas, restaurantes de barrio de verdad y habitaciones bastante por debajo del centro, con el metro y los tranvías cerrando los diez a quince minutos hasta el núcleo. Reserva aquí si el presupuesto importa más que la cercanía y una escena gastronómica auténtica gana a una vista de canal.",
      pros: [
        "Las habitaciones más baratas de todos los barrios casi céntricos",
        "Una escena gastronómica genuinamente diversa con casi ningún recargo turístico",
        "El Oosterpark, el zoo Artis y el Tropenmuseum, todos cerca",
      ],
      cons: [
        "El más alejado de estos barrios de los sitios del anillo de canales",
        "Lo bastante disperso como para depender del tranvía o el metro más que de caminar",
        "Menos atracciones emblemáticas dentro del propio barrio",
      ],
    },
  ],
