...
const madridIt: CityData = {
  city: {
    ...
    tagline: "Una capitale costruita su nottate lunghe e grandi musei, dove cinque barrios tirano in cinque direzioni diverse e sceglierne uno decide tutto il soggiorno.",
    heroIntro:
      "Madrid racchiude un triangolo dell'arte di livello mondiale, un elegante nucleo asburgico e una cultura delle tapas che quasi non comincia prima delle 22, in una città dove la distanza conta meno del barrio che si sceglie. Questa guida mette a confronto i cinque quartieri che vale la pena prenotare, dal Centro da cartolina alle strade di tapas di La Latina, e indica l'hotel che in ciascuno vale davvero la tariffa.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Ogni attrazione di punta di Madrid si trova a dieci minuti a piedi da questo miglio quadrato attorno a Puerta del Sol, Plaza Mayor e il Palazzo Reale, con i negozi e i teatri della Gran Via appena qualche isolato a nord. È la zona più rumorosa e frequentata della città, di giorno e fino a tarda notte: comitive in pullman, bancarelle di souvenir e trappole per turisti con il menu del giorno attorno alle piazze principali. Da prenotare qui se il viaggio è breve e ogni ora conta più dell'indirizzo, e non dispiace scambiare la quiete con zero tempo di spostamento. È la porta d'ingresso di Madrid, non il suo angolo tranquillo.",
      pros: [
        "Plaza Mayor, il Palazzo Reale, Puerta del Sol e la Gran Via tutti entro dieci minuti a piedi",
        "La base meglio collegata della città, proprio sopra lo snodo Cercanias e metro di Sol",
        "Non manca mai un bar di tapas o una bancarella di mercato, di giorno o di notte",
      ],
      cons: [
        "Le folle turistiche più dense di Madrid, e i borseggiatori battono duramente Sol e la Gran Via",
        "Il rumore in strada prosegue oltre mezzanotte, poco adatto a chi ha il sonno leggero",
        "I ristoranti affacciati sulle piazze principali fanno pagare l'indirizzo, non il cibo",
      ],
    },
    {
      slug: "la-latina",
      ...
      vibe: "A sud di Plaza Mayor, le strade più antiche di Madrid serpeggiano tra i bar di tapas fitti fitti di Cava Baja e la distesa domenicale del mercato di El Rastro. I residenti considerano questo il vero giro di tapas, non la versione turistica, e il rito di vermut e piattini prosegue a lungo dopo che le bancarelle del mercato hanno chiuso. Da prenotare qui se un vero giro di bar conta più della vista su un museo, e si preferisce camminare fino a Plaza Mayor e al palazzo piuttosto che prendere un mezzo. I weekend portano alcune delle sere più rumorose e più locali del centro.",
      pros: [
        "Cava Baja e Cava Alta ospitano il giro di bar di tapas più fitto e migliore di Madrid",
        "Dieci minuti a piedi in piano da Plaza Mayor e dal Palazzo Reale",
        "Le domeniche mattina regalano El Rastro e una vera sessione di vermut a seguire",
      ],
      cons: [
        "Dal giovedì alla domenica sera le strade dei bar diventano davvero rumorose",
        "Gli edifici antichi significano stanze piccole, scale strette e ascensori spesso assenti",
        "Le folle del mercato domenicale intasano le strade fino a metà pomeriggio inoltrato",
      ],
    },
    {
      slug: "malasana",
      ...
      vibe: "A nord della Gran Via, le strade che videro nascere la Movida degli anni Ottanta oggi vivono di negozi vintage, caffè torrefatti in piccoli lotti e bar indipendenti attorno a Plaza del Dos de Mayo. È giovane e un po' spigolosa ai margini, sveglia più a lungo di quasi ogni altra zona del centro, con cucine e cocktail bar piuttosto che attrazioni a riempire le serate. Da prenotare qui per i letti dal miglior rapporto qualità-prezzo a portata di piedi dall'azione, accettando la colonna sonora del weekend che sale dalla finestra. Il centro storico è a dieci minuti a piedi ogni volta che si vuole la Madrid da cartolina.",
      pros: [
        "Il giro più forte della città di bar indipendenti, caffè e negozi vintage",
        "Dieci minuti a piedi dalla Gran Via e dal centro storico",
        "Le camere costano meno di Sol e Salamanca a parità di centralità",
      ],
      cons: [
        "Le sere del weekend attorno alle piazze si fanno rumorose e restano tali oltre le 3 di notte",
        "Poche attrazioni convenzionali si trovano all'interno del quartiere stesso",
        "La folla da festa che attira può rendere alcune strade movimentate a tarda notte",
      ],
    },
    {
      slug: "chueca",
      ...
      vibe: "Appena a nord-est della Gran Via, il quartiere LGBTQ+ di Madrid vive di boutique di design, wine bar e tavoli di ristoranti che si riversano attorno a Plaza de Chueca, e diventa l'epicentro dell'enorme Orgullo Pride di inizio luglio. Si presenta curato e socievole più che trasgressivo, più vicino a una buona cena e a un cocktail serale che a un giro di bar sfrenato. Da prenotare qui per raggiungere a piedi il Thyssen e la Gran Via in quindici minuti e sentirsi comunque a proprio agio tornando a casa alle 2 di notte. Fuori dalla settimana del Pride, le serate qui sono vivaci senza scivolare nel caos.",
      pros: [
        "Una fitta concentrazione di ottimi ristoranti, cocktail bar e boutique di design",
        "Quindici minuti a piedi dalla Gran Via, dal Thyssen e dal Retiro",
        "Vita notturna accogliente e socievole che raggiunge il picco durante la settimana del Pride di luglio",
      ],
      cons: [
        "Plaza de Chueca diventa davvero rumorosa nei weekend e per tutta la settimana del Pride",
        "Hotel e ristoranti qui sono tra i più cari del centro",
        "Poche attrazioni di richiamo si trovano nelle strade del quartiere stesso",
      ],
    },
    {
      slug: "salamanca",
      ...
      vibe: "A nord-est del Retiro, l'ampia griglia di Salamanca scambia il fascino acciottolato con boulevard tranquilli, shopping di alta gamma lungo Calle Serrano e notti nettamente più silenziose. È il quartiere elegante di Madrid: ristoranti raffinati e portieri in livrea al posto dei bar di tapas e del rumore in strada. Da prenotare qui se spazio, sicurezza e raffinatezza contano più della vicinanza barcollante alla città vecchia, dato che il Retiro e il Prado restano comunque a una breve camminata o una fermata di metro. Qui la vita notturna significa una buona cena, non un giro di bar.",
      pros: [
        "Strade ampie, tranquille ed eleganti con shopping di alta gamma lungo Serrano",
        "Una breve camminata dal Retiro e dal Prado, sostenuta da solidi collegamenti in metro",
        "Ristorazione costantemente buona e raffinata senza il chiasso della città vecchia",
      ],
      cons: [
        "Hotel, negozi e ristoranti qui hanno i prezzi più alti della città",
        "Sembra residenziale e formale più che vivace una volta calato il sole",
        "A venti minuti a piedi o una fermata di metro dal nucleo antico asburgico",
      ],
    },
  ],
