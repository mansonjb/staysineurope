...
const barcelonaDe: CityData = {
  city: {
    ...
    tagline: "Wo Sie schlafen, entscheidet, ob Ihr Barcelona sich um gotische Gassen, Gaudis Raster oder den Strand dreht.",
    heroIntro:
      "Barcelona vereint Gaudis modernistische Wahrzeichen, eine mittelalterliche Altstadt und einen Stadtstrand in einem Zentrum, das klein genug ist, um es zu Fuß zu erkunden, mit der Metro für den Rest. Wo Sie Ihre Basis wählen, entscheidet, welche Version der Stadt Sie jeden Morgen bekommen: günstige gotische Gassen, eine stilvolle Ecke der Altstadt, das geordnete Gaudi-Raster, ein dorfähnlicher lokaler Platz oder Sand vor der Tür. Dieser Guide vergleicht fünf Viertel, die eine Buchung wert sind, und benennt den Kompromiss, den jedes einzelne von Ihnen verlangt.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Steingassen winden sich hier zwischen der Kathedrale und La Rambla und öffnen sich zu versteckten Plätzen, in einem Labyrinth, das bis heute das mittelalterliche Herz der Stadt bildet. Alles, was ein Erstbesucher will, liegt binnen zehn Gehminuten, und die Straßen werden nach Einbruch der Dunkelheit, sobald sich die Tagesmassen lichten, wirklich stimmungsvoll. Buchen Sie hier, wenn Budget und Nähe wichtiger sind als eine ruhige Nacht, und behalten Sie Ihre Tasche im Auge, denn dies ist zugleich das am stärksten von Taschendieben heimgesuchte Viertel der Stadt.",
      pros: [
        "Die Kathedrale, La Rambla, der Hafen und El Born sind alle zu Fuß erreichbar",
        "Dicht besetzt mit günstigen Tapas-Bars, Cafés und kleinen Hotels",
        "Gassen, die sich nach dem Abendessen leeren und aufleuchten",
      ],
      cons: [
        "Das am stärksten von Taschendieben betroffene Fleckchen der Stadt, am schlimmsten nahe La Rambla",
        "Fußgängerverkehr und Barlärm halten bis spät an, schwierig für leichte Schläfer",
        "Manche Restaurants an den Hauptplätzen leben eher von der Lage als vom Essen",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Gleich östlich des gotischen Kerns winden sich hier mittelalterliche Gassen um die Kirche Santa Maria del Mar und das Picasso-Museum, gesäumt von Boutiquen, Weinbars und Cocktailspots. Es bleibt nach Einbruch der Dunkelheit lebendig, ohne zur Touristenfalle zu kippen, und trägt die Atmosphäre der Altstadt mit einer erwachseneren, designbewussteren Note. Buchen Sie hier, wenn Sie das Altstadtgefühl mit besserem Essen und Trinken wollen und bereit sind, dafür etwas mehr zu zahlen.",
      pros: [
        "Die stärkste Auswahl an Weinbars, Cocktailspots und Tapas der Altstadt",
        "Fußläufig zum Picasso-Museum, zu Santa Maria del Mar und zum Ciutadella-Park",
        "Kopfsteingepflasterte Gassen, die lebendig bleiben und dabei einen lokalen Boutique-Charakter bewahren",
      ],
      cons: [
        "An Wochenendabenden wird es rund um die Hauptgassen laut",
        "Keine Metrostation innerhalb des Viertels, aber Jaume I und Barceloneta liegen nah",
        "Die Zimmerpreise liegen höher als im gotischen Viertel nebenan",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "Breite Boulevards aus dem 19. Jahrhundert und abgeschrägte Ecken prägen dieses Raster, Heimat der dichtesten Ansammlung modernistischer Fassaden der Stadt entlang des Passeig de Gracia. Es bringt Casa Batllo, La Pedrera und die Sagrada Familia in kurze Gehweite, alle an ein gut angebundenes Metronetz angeschlossen. Buchen Sie hier, wenn Sie es zentral und geordnet wollen, ohne das Gedränge der Altstadt, besonders bei einem ersten, auf Gaudi ausgerichteten Besuch.",
      pros: [
        "Die Gaudi-Häuser am Passeig de Gracia sind zu Fuß erreichbar, und die Sagrada Familia ist nah",
        "Ein dichtes Metronetz mit direkten Verbindungen zum Flughafenzug und darüber hinaus",
        "Breite Straßen, die nachts ruhig werden, plus eine gute Auswahl an Mittelklassehotels",
      ],
      cons: [
        "Wirkt neben den Altstadtgassen eher funktional als romantisch",
        "Direkt am Passeig de Gracia zu übernachten kostet einen Aufpreis",
        "Manche Blocks liegen einen langen, geraden Weg vom Strand oder Hafen entfernt",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "Dieses ehemalige Dorf, von der Stadt nördlich des Eixample verschluckt, hat seine eigene Struktur aus Platz zu Platz und ein starkes Gefühl lokaler Identität bewahrt. Unabhängige Läden, Bohème-Bars und familiengeführte Küchen umringen Plätze, an denen Einheimische an warmen Abenden im Freien trinken, mit dem Park Guell oben am Hang über allem. Buchen Sie hier, wenn Sie lieber in ein echtes Viertel heimkehren als in eine Postkarte, und eine 20-minütige Fahrt in die Altstadt in Kauf nehmen können.",
      pros: [
        "Echtes Viertelleben, mit Plätzen voller Einheimischer statt Reisegruppen",
        "Preiswerteres Essen und eine unprätentiöse Barszene",
        "Zu Fuß hinauf zum Park Guell, die Metro übernimmt den Rest",
      ],
      cons: [
        "20 bis 25 Minuten zu Fuß oder mit der Metro von der Altstadt und dem Strand entfernt",
        "Die belebtesten Plätze werden an Wochenendabenden laut",
    ...
    },
    {
      ...
      vibe: "Eingekeilt zwischen dem Hafen und dem Stadtstrand, ist dieses alte Fischerviertel ein enges Raster schmaler Blocks, das sich direkt zum Sand hin öffnet. Tagsüber hat es viel Charakter, mit Fischrestaurants und der Strandpromenade direkt vor der Tür, und die Strandbars halten es durch die Sommernächte bis spät wach. Buchen Sie hier, wenn der Strand der eigentliche Sinn der Reise ist und nicht nur ein Nachmittagszusatz.",
      pros: [
        "Wenige Schritte vom Stadtstrand und der Promenade, kein Nahverkehr nötig",
        "Eine Metrostation an der Linie L4, wenige Stationen von der Altstadt entfernt",
        "Ehrliche Fisch- und Wermutbars nur eine Straße vom Wasser entfernt",
      ],
      cons: [
        "Restaurants direkt am Wasser neigen zur Touristenfalle, essen Sie besser eine Straße landeinwärts",
        "Wohnungen sind im Sommer eng und heiß, mit Lärm nahe den Strandbars",
        "Ein Fußweg oder eine Metrofahrt trennt Sie von den Gaudi-Sehenswürdigkeiten oben im Eixample",
      ],
    },
  ],
