...
const copenhagen: CityData = {
  city: {
    ...
    tagline: "まったく違う顔を持つ五つの地区が、自転車ですぐ届く距離にある。どこを選ぶかで旅の中身が決まる。",
    heroIntro:
      "コペンハーゲンは互いにまるで似ていない小さな地区の集まりで、どこに泊まるかで旅の中身が王宮広場になるか、運河沿いの静けさになるか、遅くまで開く厨房になるかが決まる。旧市街は主要な見どころすべてを徒歩圏に収めるが、その分値は張る。ヴェスタブロとノアブロは絵葉書のような景色を手放す代わりに、地元の人が実際に食べている料理を差し出してくれる。そしてクリスタンハウンはその中間で、もう少し落ち着いた雰囲気を漂わせている。このガイドでは五つの地区すべてを見ていくので、予約する宿が本当に求めている街に合ったものになるはずだ。",
  ...
  neighborhoods: [
    {
      ...
      vibe: "この中世からの中心部はストロイエと宮殿群、運河に囲まれ、主要な見どころのほぼすべてが徒歩十分圏内に収まる。昼間は密度が高く華やかだが、店が閉まる頃には静けさが戻ってくる。ラウンドタワーもローゼンボー城もニューハウンも、すべて歩いて行ける。滞在が短く、広い部屋よりも利便性にお金をかけたい人はここを選ぶといい。",
      pros: [
        "ラウンドタワー、ローゼンボー城、ストロイエ、ニューハウンすべてが徒歩圏内",
        "市内でも屈指の歩きやすさと地下鉄アクセスの良さ",
        "二日間の滞在なら移動はすべて徒歩でまかなえる",
      ],
      cons: [
        "宿泊料金は市内でも最高水準",
        "大通り沿いの飲食は観光客価格が上乗せされている",
        "ノアブロやヴェスタブロに比べると地元向けレストランは少ない",
      ],
    },
    {
      slug: "nyhavn",
      ...
      lng: 12.5913,
      bestFor: ["first-time", "romantic"],
      vibe: "誰もが到着前から思い描いている光景そのものがここにある。色とりどりの切妻屋根が並ぶ短い十七世紀の運河沿いに木造船が係留され、夏には奥までテラス席のバーが連なる。この近さに泊まれば港も王宮地区も玄関先も同然だが、日が出ている間の水辺は騒がしくなり値段も上がる。静かな夜より運河の眺めを優先したい人、そして食事は一本裏の通りで済ませても構わない人はここを選ぶといい。",
      pros: [
        "市内で最も写真に撮られる運河のすぐそばに泊まれる",
        "王宮地区、アマリエンボー宮殿、運河クルーズの乗り場まで少し歩けば着く",
        "地下鉄と港湾バスの便がよい",
      ],
      cons: [
        "水辺のレストランは眺めの分だけ高くつく",
        "夏の夜は玄関先まで騒がしさと人混みが押し寄せる",
        "運河沿いのこの近さでは格安の部屋はほとんどない",
      ],
    },
    {
      slug: "vesterbro",
      ...
      vibe: "かつて赤線地区と食肉解体場が広がっていたこの中央駅西側の地区は、いまや市内で最も鋭い食とナイトライフのエリアに変わった。かつての食肉市場ケズビーエンには今、ナチュラルワインのバーやベーカリーが並び、観光客ではなく地元の若者たちが実際に夜を過ごしている。本物のコペンハーゲンの物価と活気ある夜を求めるなら、しかもチボリ公園や中心部まで気軽に歩ける立地を望むならここを選ぶといい。",
      pros: [
        "コストパフォーマンスで見れば市内最強の食とナイトライフ",
        "ケズビーエンのバーも中央駅もすぐ近く",
        "チボリ公園と中心部まで気軽に歩ける",
      ],
      cons: [
        "深夜になると今も少し治安の悪さを感じる通りがある",
        "地区内に運河や目立った観光名所はない",
        "日が暮れるとナイトライフの一角は騒がしいまま",
      ],
    },
    {
      slug: "norrebro",
      ...
      vibe: "湖の北側に広がるこの地区は、市内で最も若く多様な顔ぶれが集まるエリアで、パッチワークのようなスーペルキーレン公園とイェーゲルスボー通りに並ぶカフェが軸になっている。地元の食のシーンは観光客向けメニューではなくベーカリーと中東系グリルが中心で、価格も中心部が置き去りにした水準のままだ。地元の人のように食事をしたい人、そして旧市街まで徒歩十五分か短いバス移動くらい気にならない人はここを選ぶといい。",
      pros: [
        "中心寄りの地区の中では最も宿泊料金が安い",
        "観光客向け価格をほとんど乗せない個性的な飲食店が充実",
        "スーペルキーレン公園、アシステンス墓地、イェーゲルスボー通りがすぐ近く",
      ],
      cons: [
        "五つの地区の中で港の見どころから最も遠い",
        "エリアが広く自転車かバスに頼ることになる",
        "地下鉄の網羅性はまばらだが、バスは頻繁に走っている",
      ],
    },
    {
      slug: "christianshavn",
      ...
      vibe: "クリスチャン四世が整備したこの運河が縫うように走る島には、水上住宅と石畳の岸壁が並び、すぐ隣にはフリータウン・クリスチャニアが控えている。旧市街の賑わいの代わりに、もう少し生活感のある雰囲気が広がるが、中心部までは地下鉄で一駅か港沿いを歩くだけの距離しかない。水辺の眺めと静かな夜を求めつつ、他のすべてへの行き来のしやすさも手放したくない人はここを選ぶといい。",
      pros: [
        "人混みから離れた運河と水上住宅",
        "中心部まで地下鉄一駅か徒歩、隣にはクリスチャニア",
        "本物の地元カフェと港沿いが徒歩圏内",
      ],
      cons: [
        "ホテルの数が少なく、選択肢も空室も限られる",
        "ヴェスタブロやノアブロに比べるとナイトライフは静か",
        "中心部の主要な見どころの多くは港を渡る必要がある",
      ],
    },
  ],
