...
const madridFr: CityData = {
  city: {
    ...
    tagline: "Une capitale bâtie sur les nuits tardives et les grands musées, où cinq barrios tirent chacun dans une direction différente et où le choix de l'un façonne tout le séjour.",
    heroIntro:
      "Madrid réunit un triangle de l'art de classe mondiale, un élégant coeur des Habsbourg et une culture des tapas qui ne démarre vraiment qu'à partir de 22h, dans une ville où la distance compte moins que le barrio choisi. Ce guide compare les cinq quartiers qui méritent d'y réserver, du Centro de carte postale aux ruelles à tapas de La Latina, et nomme l'hôtel qui justifie son tarif dans chacun.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Chaque site phare de Madrid se trouve à dix minutes à pied de ce mile carré autour de la Puerta del Sol, de la Plaza Mayor et du Palais royal, avec les boutiques et théâtres de la Gran Via à quelques rues au nord. C'est le secteur le plus bruyant et le plus animé de la ville, de jour comme tard le soir : cars de tourisme, étals à souvenirs et pièges à touristes au menu du jour cernent les grandes places. Réservez ici si le séjour est court et que chaque heure compte plus que l'adresse, et que le calme vous importe moins que l'absence totale de trajet. C'est la porte d'entrée de Madrid, pas son coin tranquille.",
      pros: [
        "La Plaza Mayor, le Palais royal, la Puerta del Sol et la Gran Via tous à moins de dix minutes à pied",
        "La base la mieux desservie de la ville, juste au-dessus du pôle Cercanias et métro de Sol",
        "Jamais à court de bar à tapas ou d'étal de marché, de jour comme de nuit",
      ],
      cons: [
        "Les foules touristiques les plus denses de Madrid, et les pickpockets sévissent autour de Sol et de la Gran Via",
        "Le bruit de la rue continue après minuit, un mauvais choix pour les petits dormeurs",
        "Les restaurants donnant sur les grandes places font payer l'adresse, pas la cuisine",
      ],
    },
    {
      slug: "la-latina",
      ...
      vibe: "Au sud de la Plaza Mayor, les plus vieilles ruelles de Madrid serpentent devant les bars à tapas qui se serrent sur toute la Cava Baja et l'étalement dominical du marché d'El Rastro. Les habitants considèrent que c'est la vraie tournée des tapas, pas la version touristique, et le rituel vermouth-et-assiettes se prolonge bien après que les étals du marché ont remballé. Réservez ici si une vraie tournée des bars compte plus qu'une vue sur musée, et que vous préférez marcher jusqu'à la Plaza Mayor et au palais plutôt que d'y aller en voiture. Les week-ends offrent certaines des nuits les plus bruyantes et les plus locales du centre.",
      pros: [
        "Cava Baja et Cava Alta réunissent la tournée de bars à tapas la plus dense et la meilleure de Madrid",
        "Dix minutes à pied à plat jusqu'à la Plaza Mayor et au Palais royal",
        "Les dimanches matin offrent El Rastro et une vraie session de vermouth ensuite",
      ],
      cons: [
        "Du jeudi au dimanche soir, les rues à bars deviennent vraiment bruyantes",
        "Les vieux immeubles signifient des chambres petites, des escaliers étroits et des ascenseurs souvent absents",
        "Les foules du marché du dimanche encombrent les ruelles jusque tard dans l'après-midi",
      ],
    },
    {
      slug: "malasana",
      ...
      vibe: "Au nord de la Gran Via, les rues qui ont vu naître la Movida des années 1980 vivent aujourd'hui de friperies, de café artisanal et de bars indépendants autour de la Plaza del Dos de Mayo. Le quartier est jeune et un peu négligé sur les bords, éveillé plus tard que presque partout ailleurs dans le centre, avec des cuisines et des bars à cocktails plutôt que des sites pour remplir vos soirées. Réservez ici pour les lits au meilleur rapport qualité-prix à distance de marche de l'animation, et acceptez la bande-son du week-end qui remonte par la fenêtre. Le centre historique est à dix minutes à pied dès que vous voulez plutôt la version carte postale de Madrid.",
      pros: [
        "La meilleure concentration de bars indépendants, cafés et boutiques vintage de la ville",
        "Dix minutes à pied de la Gran Via et du centre historique",
        "Les chambres coûtent moins cher qu'à Sol ou Salamanca pour un niveau de centralité comparable",
      ],
      cons: [
        "Les nuits de week-end autour des places deviennent bruyantes et le restent bien après 3h du matin",
        "Peu de sites classiques se trouvent au sein même du quartier",
        "La foule festive qu'il attire peut rendre certaines rues agitées tard le soir",
      ],
    },
    {
      slug: "chueca",
      ...
      vibe: "Juste au nord-est de la Gran Via, le quartier LGBTQ+ de Madrid vit de boutiques de design, de bars à vin et de tables de restaurant qui débordent autour de la Plaza de Chueca, et devient l'épicentre de l'immense Orgullo Pride de début juillet. Il se lit comme raffiné et convivial plutôt que provocateur, plus proche d'un bon dîner et d'un cocktail tardif que d'une tournée agitée. Réservez ici pour marcher jusqu'au Thyssen et à la Gran Via en quinze minutes tout en vous sentant bienvenu en rentrant à 2h du matin. Hors semaine de la Pride, les soirées ici sont animées sans basculer dans le chaos.",
      pros: [
        "Une grappe serrée d'excellents restaurants, bars à cocktails et boutiques de design",
        "Quinze minutes à pied de la Gran Via, du Thyssen et du Retiro",
        "Une vie nocturne accueillante et conviviale qui culmine fort pendant la semaine de la Pride en juillet",
      ],
      cons: [
        "La Plaza de Chueca devient vraiment bruyante le week-end et tout au long de la semaine de la Pride",
        "Les hôtels et restaurants ici comptent parmi les plus chers du centre",
        "Peu de sites de renom se trouvent dans les rues propres du quartier",
      ],
    },
    {
      slug: "salamanca",
      ...
      vibe: "Au nord-est du Retiro, la large grille de Salamanca échange le charme des pavés contre des boulevards calmes, du shopping haut de gamme le long de la Calle Serrano et des nuits nettement plus calmes. C'est le quartier chic de Madrid : des restaurants élégants et des portiers plutôt que des bars à tapas et le bruit de la rue. Réservez ici si l'espace, la sécurité et le raffinement comptent plus que la proximité titubante avec la vieille ville, puisque le Retiro et le Prado restent à courte marche ou un arrêt de métro. La vie nocturne ici signifie un bon dîner, pas une tournée des bars.",
      pros: [
        "Des rues larges, calmes et élégantes avec du shopping haut de gamme le long de Serrano",
        "Une courte marche jusqu'au Retiro et au Prado, avec de bonnes liaisons de métro en renfort",
        "Une gastronomie constamment bonne et haut de gamme, sans le tumulte de la vieille ville",
      ],
      cons: [
        "Hôtels, boutiques et restaurants pratiquent ici les prix les plus élevés de la ville",
        "L'ambiance devient résidentielle et guindée plutôt qu'animée une fois le soleil couché",
        "À vingt minutes de marche ou un saut de métro du vieux coeur des Habsbourg",
      ],
    },
  ],
