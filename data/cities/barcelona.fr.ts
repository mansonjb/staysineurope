...
const barcelonaFr: CityData = {
  city: {
    ...
    tagline: "L'endroit où vous dormez décide si votre Barcelone se joue dans les ruelles gothiques, la grille de Gaudi ou sur le sable.",
    heroIntro:
      "Barcelone concentre les monuments modernistes de Gaudi, une vieille ville médiévale et une plage urbaine dans un centre assez compact pour se parcourir à pied, le métro prenant le relais pour le reste. L'endroit où vous posez vos valises décide quelle version de la ville vous retrouvez chaque matin : des ruelles gothiques bon marché, un coin chic de la vieille ville, la grille ordonnée de Gaudi, une place de village local, ou le sable devant la porte. Ce guide compare cinq quartiers qui valent la réservation et détaille les compromis que chacun impose.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Les ruelles de pierre serpentent ici entre la cathédrale et La Rambla, débouchant sur des petites places cachées dans un dédale qui forme toujours le coeur médiéval de la ville. Tout ce qu'un premier visiteur recherche se trouve à dix minutes à pied, et les rues prennent une vraie atmosphère une fois la foule du jour dissipée, le soir venu. Réservez ici si le budget et la proximité comptent plus qu'une nuit calme, et surveillez bien votre sac, car c'est aussi le quartier le plus travaillé par les pickpockets de la ville.",
      pros: [
        "La cathédrale, La Rambla, le port et El Born se rejoignent tous à pied",
        "Une forte densité de bars à tapas bon marché, de cafés et de petits hôtels",
        "Des ruelles qui se vident et prennent vie après le dîner",
      ],
      cons: [
        "Le secteur le plus touché par les vols à la tire de la ville, pire encore près de La Rambla",
        "Passage et bruit des bars tard le soir, difficile pour les sommeils légers",
        "Quelques restaurants des places principales vivent sur leur emplacement plus que sur leur cuisine",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Juste à l'est du coeur gothique, des ruelles médiévales s'enroulent ici autour de l'église Santa Maria del Mar et du musée Picasso, bordées de boutiques, de bars à vin et de bars à cocktails. Le quartier reste animé le soir sans virer au piège à touristes, avec l'atmosphère de la vieille ville en plus adulte et plus soigné côté design. Réservez ici pour l'ambiance de la vieille ville avec une meilleure offre de tables et de bars, quitte à payer un peu plus cher.",
      pros: [
        "La plus belle concentration de bars à vin, bars à cocktails et tapas de la vieille ville",
        "À pied du musée Picasso, de Santa Maria del Mar et du parc de la Ciutadella",
        "Des ruelles pavées animées qui gardent malgré tout un esprit local et boutique",
      ],
      cons: [
        "Les soirs de week-end sont bruyants autour des ruelles principales",
        "Pas de station de métro dans le quartier même, mais Jaume I et Barceloneta sont proches",
        "Des tarifs d'hôtel plus élevés que dans le quartier gothique voisin",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "De larges boulevards du XIXe siècle et des angles coupés en pan dessinent cette grille, qui concentre la plus forte densité de façades modernistes de la ville le long du Passeig de Gracia. Elle place la Casa Batllo, La Pedrera et la Sagrada Familia à courte distance à pied, le tout sur un réseau de métro bien desservi. Réservez ici pour rester central et ordonné sans la cohue de la vieille ville, surtout pour un premier séjour centré sur Gaudi.",
      pros: [
        "Les maisons de Gaudi du Passeig de Gracia sont à pied, et la Sagrada Familia est proche",
        "Un réseau de métro dense, avec des liaisons directes vers le train de l'aéroport et au-delà",
        "Des rues larges qui se calment le soir, et un bon choix d'hôtels de milieu de gamme",
      ],
      cons: [
        "Plus fonctionnel que romantique, comparé aux ruelles de la vieille ville",
        "Dormir en plein sur le Passeig de Gracia coûte cher",
        "Certains pâtés de maisons sont à une longue marche en ligne droite de la plage ou du port",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "Cet ancien village, avalé par la ville au nord de l'Eixample, a gardé son découpage place par place et une forte identité locale. Boutiques indépendantes, bars bohèmes et petits restaurants familiaux entourent des places où les habitants boivent en terrasse les soirs de beau temps, avec le Park Guell sur la colline au-dessus de tout ça. Réservez ici si vous préférez rentrer chaque soir dans un vrai quartier plutôt que dans une carte postale, et que 20 minutes de trajet vers la vieille ville ne vous dérangent pas.",
      pros: [
        "Une vraie vie de quartier, des places pleines d'habitants plutôt que de groupes de touristes",
        "Des tables au meilleur rapport qualité-prix et des bars sans prétention",
        "Le Park Guell est accessible à pied, le métro se charge du reste",
      ],
      cons: [
        "20 à 25 minutes à pied ou en métro de la vieille ville et de la plage",
        "Les places les plus fréquentées sont bruyantes les soirs de week-end",
    ...
    },
    {
      ...
      vibe: "Coincé entre le port et la plage urbaine, cet ancien quartier de pêcheurs forme une grille serrée de petites rues qui débouche directement sur le sable. Il a beaucoup de caractère le jour, avec les restaurants de fruits de mer et la promenade juste devant la porte, et les bars du front de mer le font vivre tard dans la nuit en été. Réservez ici si la plage est vraiment l'objet du voyage, pas un simple à-côté de l'après-midi.",
      pros: [
        "À deux pas de la plage urbaine et de la promenade, sans transport nécessaire",
        "Une station de métro sur la ligne L4, à quelques arrêts de la vieille ville",
        "De vrais bars à fruits de mer et à vermouth, une rue seulement en retrait de l'eau",
      ],
      cons: [
        "Les restaurants du front de mer virent facilement au piège à touristes, mieux vaut manger une rue en retrait",
        "Des appartements exigus et chauds en été, avec du bruit près des bars de plage",
        "Une marche ou un trajet de métro vous sépare des sites de Gaudi, plus haut dans l'Eixample",
      ],
    },
  ],
