...
const rome: CityData = {
  city: {
    ...
    tagline: "どこを見ても古代遺跡が広がるが、テヴェレ川のどちら側に泊まるかで街が近く感じるか果てしなく感じるかが決まる。",
    heroIntro:
      "ローマには古代遺跡、バチカン、ヨーロッパ屈指の屋外ダイニングが中心部に広がっているが、歩けるのは部分的で、ひと続きのループでは巡れない。だからこそ、どのエリアに泊まるかで、一日のうちどれだけの時間を移動に取られるか、観光に使えるかが変わる。本ガイドでは予約する価値のある5エリアを比較する。絵はがきのような価格のチェントロ・ストーリコから、バチカン近くで静かで割安なプラーティまで、それぞれの相場に見合ったホテルを紹介する。",
  ...
  neighborhoods: [
    {
      ...
      vibe: "パンテオン、ナヴォーナ広場、トレビの泉の間に広がる黄土色の路地は迷路のようで、数歩ごとにバロック様式の広場へと開ける。初めての旅で見たいものはすべて徒歩15分圏内に収まり、夕食後に団体ツアーが引き上げると、同じ路地が静かで本当に美しい表情に変わる。滞在日数が短く、主要な見どころをすべて押さえつつ夜の静けさも味わいたいなら、地図を開かずに済むこのエリアを選ぶといい。",
      pros: [
        "パンテオン、トレビの泉、ナヴォーナ広場、スペイン階段がすべて徒歩圏内に収まる",
        "夕方に日帰りツアーのバスが去ると、静かで雰囲気のある表情に変わる",
        "ほぼ角ごとにカフェやジェラート店、アペリティボバーがある",
      ],
      cons: [
        "市内で最も宿泊料金が高いエリア",
        "地下鉄の路線が通っておらず、徒歩かバスに頼ることになる",
        "主要観光地の周辺は一日中人混みと騒がしさが絶えない",
      ],
    },
    {
      slug: "monti",
      ...
      vibe: "コロッセオとテルミニ駅の間にひっそりと収まるこのエリアは、かつて花街だったが今では最も生活感のある一角になっている。ピアッツァ・デッラ・マドンナ・デイ・モンティ周辺の路地にはヴィンテージ店やワインバーが並び、蔦が絡む。夜になるとチェックリスト片手の観光客ではなく地元住民が噴水の階段で一杯やる。旧市街の値段や団体バスの往来を避けつつ、古代遺跡まで歩ける距離に泊まりたいならここを選ぶといい。",
      pros: [
        "徒歩10分でコロッセオとフォロ・ロマーノの両方に行ける",
        "地下鉄B線のカヴール駅があり、テルミニ駅の乗り換えも近い",
        "観光客ではなく地元住民で賑わうワインバーやエノテカが多い",
      ],
      cons: [
        "テルミニ駅方面の一部の通りは夜になると雑然とした雰囲気になる",
        "週末の夜は人気のバーの喧騒が通りにまで溢れ出す",
        "大手ホテルより小さなブティックホテルやアパートメントの方が多い",
      ],
    },
    {
      slug: "trastevere",
      ...
      vibe: "テヴェレ川の向こう岸に広がる石畳の路地は、昼間は蔦や洗濯物が揺れる静かな景色だが、日が沈むと街で最も賑やかな食事と酒の街に変わる。どのトラットリアも歩道までテーブルを広げ、サンタ・マリア広場を取り囲むバーは深夜過ぎまで賑わう。夜遅くまでしっかり食べて飲みたい人向けで、部屋に戻ったあとは週末の騒がしさを気にしないタイプなら選ぶといい。",
      pros: [
        "本格的なトラットリアと夜の賑わいがローマで最も密集している",
        "川を渡ればすぐに中心部やユダヤ人街に歩いて行ける",
        "石畳の路地は早朝の静けさの中で最も美しく写真に収まる",
      ],
      cons: [
        "週末の夜は深夜過ぎまで騒がしく、眠りの浅い人にはつらい",
        "地下鉄駅は一切なく、トラムかバスか徒歩に頼るしかない",
        "広場に面した一部のレストランは料理より立地で商売している",
      ],
    },
    {
      slug: "prati",
      ...
      vibe: "バチカンの隣に碁盤の目状に整然と広がる大通り沿いには、洒落た店や地元に信頼される飲食店が並び、旧市街ほど観光客も多くない。サン・ピエトロ大聖堂とバチカン美術館まで気軽に歩ける距離にありながら、ごく普通の住宅街の空気も残っている。バチカンまで徒歩、他のエリアへは地下鉄、宿泊費は中心部より安く抑えたいならここを選ぶといい。",
      pros: [
        "サン・ピエトロ大聖堂とバチカン美術館の両方に、団体客より先に歩いて着ける",
        "地下鉄A線でわずか2駅、テルミニ駅やスペイン階段まで直通",
        "観光価格を上乗せしない、割安なホテルや飲食店が揃う",
      ],
      cons: [
        "店が閉まるとバーやナイトライフの選択肢は乏しくなる",
        "コロッセオ側へは徒歩20〜25分か地下鉄の乗り換えが必要",
        "旧市街と比べるとロマンチックというより実用的な印象",
      ],
    },
    {
      slug: "testaccio",
      ...
      vibe: "中心部の南、旧食肉解体場の跡地を中心に広がるこの労働者階級の街では、モツ料理も含めたローマの家庭料理「クチーナ・ポーヴェラ」が昔ながらの作り方で今も出される。屋根付き市場や気取らないトラットリアには観光客より本気の食通が集まり、モンテ・テスタッチョの丘に掘られたクラブが夕食後の夜を担う。眺めより地元価格でしっかり食べることを優先し、観光地までの移動も苦にならないならここを選ぶといい。",
      pros: [
        "ローマ随一の割安さと本格派の料理が味わえる",
        "地下鉄B線ピラミデ駅があり、コロッセオまで数駅",
        "観光価格がほとんどない、本物の住宅街の雰囲気",
      ],
      cons: [
        "定番の観光名所は少なく、観光より食事のためのエリア",
        "旧市街からは徒歩か地下鉄で20分以上かかる",
        "モンテ・テスタッチョのクラブ街は週末の夜に騒がしくなる",
      ],
    },
  ],
