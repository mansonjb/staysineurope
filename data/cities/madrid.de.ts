...
const madridDe: CityData = {
  city: {
    ...
    tagline: "Eine Hauptstadt aus späten Nächten und großen Museen, in der fünf Barrios in fünf verschiedene Richtungen ziehen und die Wahl eines von ihnen den ganzen Aufenthalt prägt.",
    heroIntro:
      "Madrid vereint ein Kunstdreieck von Weltklasse, einen eleganten habsburgischen Altstadtkern und eine Tapas-Kultur, die vor 22 Uhr kaum in Schwung kommt, in einer Stadt, in der die Entfernung weniger zählt als das gewählte Barrio. Dieser Leitfaden vergleicht die fünf Viertel, die eine Buchung wert sind, vom postkartenzentralen Centro bis zu den Tapas-Gassen von La Latina, und nennt in jedem das Hotel, das seinen Preis rechtfertigt.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Jede bekannte Sehenswürdigkeit Madrids liegt innerhalb eines Zehn-Minuten-Fußwegs dieser knappen Quadratmeile rund um die Puerta del Sol, die Plaza Mayor und den Konigspalast, mit den Geschäften und Theatern der Gran Via nur wenige Blocks nördlich. Es ist der lauteste, geschäftigste Fleck der Stadt bei Tag und bis tief in die Nacht: Reisebusgruppen, Souvenirstände und Tagesmenü-Touristenfallen umringen die Hauptplätze. Buchen Sie hier, wenn der Trip kurz ist und jede Stunde mehr zählt als die Adresse, und wenn es Ihnen nichts ausmacht, Ruhe gegen null Anfahrtszeit einzutauschen. Dies ist Madrids Eingangstür, nicht seine ruhige Ecke.",
      pros: [
        "Die Plaza Mayor, der Konigspalast, die Puerta del Sol und die Gran Via alle innerhalb eines Zehn-Minuten-Fußwegs",
        "Die am besten angebundene Basis der Stadt, direkt über dem Cercanias- und Metro-Knotenpunkt Sol",
        "Nie weit von einer Tapas-Bar oder einem Marktstand entfernt, Tag und Nacht",
      ],
      cons: [
        "Die dichtesten Touristenmengen Madrids, und Taschendiebe arbeiten Sol und die Gran Via hart",
        "Der Straßenlärm hält bis nach Mitternacht an, eine schlechte Wahl für leichte Schläfer",
        "Restaurants an den Hauptplätzen berechnen die Adresse, nicht das Essen",
      ],
    },
    {
      slug: "la-latina",
      ...
      vibe: "Südlich der Plaza Mayor winden sich die ältesten Gassen Madrids an den dicht an dicht stehenden Tapas-Bars der Cava Baja vorbei und an der sonntäglichen Ausdehnung des El-Rastro-Markts. Einheimische sehen darin den echten Tapas-Bummel, nicht die Touristenversion, und das Ritual aus Vermut und Tellern läuft noch lange, nachdem die Marktstände abgebaut sind. Buchen Sie hier, wenn ein richtiger Bar-Bummel mehr zählt als ein Museumsblick, und wenn Sie lieber zur Plaza Mayor und zum Palast laufen, statt dorthin zu fahren. An Wochenenden gibt es hier einige der lautesten, einheimischsten Nächte im Zentrum.",
      pros: [
        "Die Cava Baja und die Cava Alta bieten den dichtesten, besten Tapas-Bar-Bummel Madrids",
        "Ein flacher Zehn-Minuten-Fußweg zur Plaza Mayor und zum Konigspalast",
        "Sonntagmorgens gibt es den El Rastro und danach eine richtige Vermut-Session",
      ],
      cons: [
        "Von Donnerstag- bis Sonntagnacht wird es rund um die Bar-Straßen wirklich laut",
        "Alte Gebäude bedeuten kleine Zimmer, enge Treppen und Aufzüge, die oft fehlen",
        "Die Sonntagsmarktmassen verstopfen die Gassen bis weit in den Nachmittag hinein",
      ],
    },
    {
      slug: "malasana",
      ...
      vibe: "Nördlich der Gran Via laufen die Straßen, in denen die Movida der 1980er geboren wurde, heute auf Vintage-Ständern, Kaffee in kleinen Röstungen und unabhängigen Bars rund um die Plaza del Dos de Mayo. Es ist jung und an den Rändern etwas rau, wach bis später als fast überall sonst im Zentrum, mit Küchen und Cocktailbars statt Sehenswürdigkeiten, die Ihre Abende füllen. Buchen Sie hier für die preiswertesten Betten in Gehweite zum Geschehen, und nehmen Sie den Wochenend-Soundtrack in Kauf, der durchs Fenster hereinweht. Das historische Zentrum liegt einen Zehn-Minuten-Fußweg entfernt, wann immer Sie stattdessen das Postkarten-Madrid wollen.",
      pros: [
        "Die stärkste Reihe unabhängiger Bars, Cafés und Vintage-Läden der Stadt",
        "Ein Zehn-Minuten-Fußweg zur Gran Via und zum historischen Zentrum",
        "Zimmer unterbieten die Preise von Sol und Salamanca bei ähnlicher Zentralität",
      ],
      cons: [
        "An Wochenendabenden wird es rund um die Plätze laut und bleibt es bis nach 3 Uhr morgens",
        "Nur wenige klassische Sehenswürdigkeiten liegen im Viertel selbst",
        "Die Partymenge, die es anzieht, kann manche Straßen spät in der Nacht ruppig machen",
      ],
    },
    {
      slug: "chueca",
      ...
      vibe: "Direkt nordöstlich der Gran Via lebt Madrids LGBTQ+-Viertel von Designboutiquen, Weinbars und Restauranttischen, die sich rund um die Plaza de Chueca ausbreiten, und wird zum Epizentrum der riesigen Orgullo-Pride Anfang Juli. Es wirkt eher poliert und gesellig als kantig, näher an einem guten Abendessen und einem späten Cocktail als an einem lauten Bummel. Buchen Sie hier, um in fünfzehn Minuten zum Thyssen und zur Gran Via zu laufen und sich um 2 Uhr morgens beim Heimweg dennoch willkommen zu fühlen. Außerhalb der Pride-Woche sind die Abende hier lebendig, ohne ins Chaos zu kippen.",
      pros: [
        "Eine dichte Ansammlung ausgezeichneter Restaurants, Cocktailbars und Designboutiquen",
        "Fünfzehn Gehminuten zur Gran Via, zum Thyssen und zum Retiro",
        "Einladendes, geselliges Nachtleben, das während der Pride-Woche im Juli seinen Höhepunkt erreicht",
      ],
      cons: [
        "Die Plaza de Chueca wird an Wochenenden und während der gesamten Pride-Woche wirklich laut",
        "Hotels und Restaurants hier zählen zu den teuersten im Zentrum",
        "Nur wenige namhafte Sehenswürdigkeiten liegen in den eigenen Straßen des Viertels",
      ],
    },
    {
      slug: "salamanca",
      ...
      vibe: "Nordöstlich des Retiro tauscht das breite Straßenraster von Salamanca kopfsteingepflasterten Charme gegen ruhige Boulevards, gehobenes Shopping entlang der Calle Serrano und einen merklich ruhigeren Schlaf. Es ist Madrids herausgeputztes Viertel: feine Restaurants und Türsteher statt Tapas-Bars und Straßenlärm. Buchen Sie hier, wenn Platz, Sicherheit und Politur mehr zählen als Taumeldistanz zur Altstadt, denn der Retiro und der Prado sind noch immer einen kurzen Fußweg oder eine Metrostation entfernt. Nachtleben bedeutet hier ein gutes Abendessen, keinen Bar-Bummel.",
      pros: [
        "Breite, ruhige, elegante Straßen mit gehobenem Shopping entlang der Serrano",
        "Ein kurzer Fußweg zum Retiro und zum Prado, gestützt durch solide Metroanbindungen",
        "Durchgehend gute, gehobene Gastronomie ohne jeden Altstadt-Trubel",
      ],
      cons: [
        "Hotels, Läden und Restaurants hier tragen die höchsten Preise der Stadt",
        "Wirkt eher wohnlich und förmlich als lebhaft, sobald die Sonne untergeht",
        "Ein Zwanzig-Minuten-Fußweg oder eine Metrostation vom habsburgischen Altstadtkern entfernt",
      ],
    },
  ],
