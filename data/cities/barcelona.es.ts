...
const barcelonaEs: CityData = {
  city: {
    ...
    tagline: "Dónde duermes decide si tu Barcelona funciona a base de callejuelas góticas, la cuadrícula de Gaudi o la arena.",
    heroIntro:
      "Barcelona concentra los hitos modernistas de Gaudi, un casco antiguo medieval y una playa urbana en un centro lo bastante pequeño para recorrer a pie, con el metro cubriendo el resto. Dónde te alojas decide qué versión de la ciudad te toca cada mañana: callejuelas góticas baratas, un rincón elegante del casco antiguo, la ordenada cuadrícula de Gaudi, una plaza de barrio con aire de pueblo, o arena a la puerta. Esta guía compara cinco barrios que merece la pena reservar y detalla las renuncias que exige cada uno.",
  ...
  neighborhoods: [
    {
      ...
      vibe: "Aquí las callejuelas de piedra serpentean entre la catedral y La Rambla, abriéndose a plazas escondidas en un laberinto que todavía forma el corazón medieval de la ciudad. Todo lo que quiere un primer visitante queda a diez minutos a pie, y las calles cobran una atmósfera genuina una vez que la multitud del día se aclara al anochecer. Reserva aquí si el presupuesto y la cercanía pesan más que una noche tranquila, y vigila bien el bolso, porque este es también el barrio con más carterismo de la ciudad.",
      pros: [
        "La catedral, La Rambla, el puerto y El Born quedan todos a pie",
        "Denso en bares de tapas baratos, cafés y hoteles pequeños",
        "Callejuelas que se vacían y brillan después de cenar",
      ],
      cons: [
        "El tramo con más carterismo de la ciudad, peor cerca de La Rambla",
        "Tránsito peatonal y ruido de bares hasta tarde, duro para quien duerme ligero",
        "Algunos restaurantes de las plazas principales viven de la ubicación más que de la comida",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "Justo al este del núcleo gótico, las callejuelas medievales aquí rodean la iglesia de Santa Maria del Mar y el Museo Picasso, bordeadas de boutiques, bares de vinos y coctelerías. Se mantiene animado de noche sin caer en la trampa para turistas, con la atmósfera del casco antiguo pero con un aire más adulto y más atento al diseño. Reserva aquí si quieres el ambiente del casco antiguo con mejor comida y bebida, y no te importa pagar algo más por ello.",
      pros: [
        ...
        "Callejuelas empedradas que siguen animadas sin perder su carácter local y de boutique",
      ],
      cons: [
        "Las noches de fin de semana se ponen ruidosas en torno a las callejuelas principales",
        "Sin estación de metro dentro del barrio, aunque Jaume I y Barceloneta quedan cerca",
        "Las tarifas de hotel salen más caras que en el barrio gótico contiguo",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "Amplios bulevares del siglo XIX y esquinas achaflanadas definen esta cuadrícula, hogar de la mayor concentración de fachadas modernistas de la ciudad a lo largo del Passeig de Gracia. Pone la Casa Batllo, La Pedrera y la Sagrada Familia a un corto paseo, todo sobre una red de metro bien conectada. Reserva aquí si quieres estar céntrico y ordenado sin el agobio del casco antiguo, sobre todo en una primera visita centrada en Gaudi.",
      pros: [
        "Las casas de Gaudi del Passeig de Gracia quedan a pie, y la Sagrada Familia está cerca",
        "Una densa red de metro con enlaces directos al tren del aeropuerto y más allá",
        "Calles anchas que se quedan tranquilas de noche, además de una buena oferta de hoteles de gama media",
      ],
      cons: [
        "Se siente más funcional que romántico junto a las callejuelas del casco antiguo",
        "Dormir justo en el Passeig de Gracia sale caro",
        "Algunas manzanas quedan a una larga caminata en línea recta de la playa o el puerto",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "Este antiguo pueblo, engullido por la ciudad al norte del Eixample, ha conservado su propio trazado de plaza en plaza y un fuerte sentido de identidad local. Tiendas independientes, bares bohemios y cocinas familiares rodean plazas donde los vecinos beben al aire libre las noches templadas, con el Park Guell en la colina justo encima de todo. Reserva aquí si prefieres volver a un barrio de verdad antes que a una postal, y puedes vivir con un trayecto de 20 minutos hasta el casco antiguo.",
      pros: [
        "Vida de barrio auténtica, con plazas llenas de vecinos y no de grupos de turistas",
        "Comida con mejor relación calidad-precio y una escena de bares sin pretensiones",
        "Se sube a pie hasta el Park Guell, y el metro se encarga del resto",
      ],
      cons: [
        "Un trayecto de 20 a 25 minutos a pie o en metro desde el casco antiguo y la playa",
        "Las plazas más concurridas se ponen ruidosas las noches de fin de semana",
        "Menos hoteles de renombre, más apartamentos y pequeñas casas de huéspedes",
      ],
    },
    {
      slug: "barceloneta",
      ...
      vibe: "Encajado entre el puerto y la playa urbana, este antiguo barrio de pescadores es una apretada cuadrícula de manzanas estrechas que se abre directamente a la arena. Tiene mucho carácter de día, con restaurantes de marisco y el paseo marítimo justo a la puerta, y los bares del frente marítimo lo mantienen animado hasta tarde en las noches de verano. Reserva aquí si la playa es el objetivo real del viaje, no un añadido de tarde.",
      pros: [
        "A un paso de la playa urbana y el paseo marítimo, sin necesidad de transporte",
        "Una parada de metro en la línea L4, a un par de estaciones del casco antiguo",
        "Auténticos bares de marisco y de vermut a solo una calle del agua",
      ],
      cons: [
        "Los restaurantes del frente marítimo tienden a la trampa para turistas, así que come una calle hacia dentro",
        "Los pisos salen angostos y calurosos en verano, con ruido cerca de los bares de playa",
        "Un paseo o un trayecto de metro te separa de los sitios de Gaudi, arriba en el Eixample",
      ],
    },
  ],
