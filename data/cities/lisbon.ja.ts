...
const lisbon: CityData = {
  city: {
    ...
    tagline: "七つの丘と一本の川、そしてヨーロッパ屈指の美しい光。",
    heroIntro:
      "リスボンは坂道を受け入れて歩く人と、路面電車を乗りこなす人に報いる街だ。3日あれば旧市街、展望台、ベレンを急がずに回ることができ、食のレベルは価格をはるかに超えている。春か初秋に訪れれば、ヨーロッパ旅行の行き先としてほぼ最強と言っていい。",
  ...
  neighborhoods: [
    {
      ...
      vibe: "リスボン最古のこの地区は、川からカステロ(城)へと上る石段と洗濯物のロープ、タイル張りの建物が入り組む迷路のような街並みだ。夜になると小さなレストランからファドの調べが漏れ聞こえ、日が暮れれば観光客の団体は姿を消す。首都の中にありながら、まるで一つの村のような雰囲気がある。",
      pros: [
        "早朝と夜が特に雰囲気のある、街で最も情緒豊かな通り",
        "城、大聖堂、そして最高の展望台まで徒歩圏内",
        "ファドハウスや家族経営のタスカ(食堂)がすぐそば",
      ],
      cons: [
        "急な坂と石畳が続き、荷物を持っての移動はつらく、歩行に不安がある人には厳しい",
        "近くに地下鉄駅が少なく、路面電車かバス、自分の足に頼ることになる",
        "日中はメインの通りが観光団体で混雑する",
      ],
    },
    {
      ...
      vibe: "1755年の大地震の後に碁盤目状に再建された平坦なダウンタウンで、コメルシオ広場からシアードの洗練されたショップやカフェまで続く。地下鉄3路線、路面電車、フェリーとあらゆる交通がここで交わる。通り沿いは観光地然としているが、拠点としては申し分ない。",
      pros: [
        "リスボン中心部で最も平坦なエリアで、街歩きが最も楽",
        "街で最も交通の便が良く、空港エリアから乗り換え1回で地下鉄が直結",
        "あらゆる価格帯のホテルとレストランが豊富に揃う",
      ],
      cons: [
        "大通り沿いのレストランは味が平凡で観光客向け",
        "日中は混雑し騒がしい、特にアウグスタ通り周辺",
      ],
    },
    {
      slug: "principe-real",
      ...
      vibe: "バイロ・アルトの上に広がる緑豊かな高級住宅地で、巨大なヒマラヤスギがそびえる広場と週末のオーガニックマーケットが中心にある。19世紀のタウンハウスにはコンセプトストア、ナチュラルワインバー、街でも指折りの個性的なレストランが並ぶ。地元のリスボン市民が実際に夜遊びに出かける場所だ。",
      pros: [
        "ダウンタウンよりはるかに観光客が少なく、食と酒のシーンは抜群",
        "バイロ・アルトから徒歩10分の距離にありながら夜は静か",
        "広場とキオスクカフェが本物の地域らしい暮らしを感じさせる",
      ],
      cons: [
        "ほぼどこからも上り坂になるため、帰りにタクシー代を見込んでおくこと",
        "宿泊施設はブティック系で高めが中心、格安の選択肢は少ない",
        "地区内に地下鉄駅はなく、最寄りはラト駅",
      ],
    },
    {
      ...
      vibe: "昼間は静かなこの細い通りが並ぶ一角は、夜になるとリスボンの野外バー街に一変し、深夜2時まで石畳の上で人々が飲み歩く。安いビール、小さなバー、気取りは一切なし。この賑わいの一部になるつもりでなければ、ここに泊まるのはやめておいた方がいい。",
      pros: [
        "ナイトライフの中心地で、千鳥足5分圏内に何十軒ものバーがある",
        "シアードとプリンシペ・レアルの間という中心的な立地",
        "本当に安いゲストハウスがまだいくつか残っている",
      ],
      cons: [
        "週末は深夜2時から3時まで通りの騒音が続き、避けようがない",
        "朝は薄汚れた様子で、通りは毎晩痛めつけられている",
        "グロリア線のケーブルカーかエレベーターを使わない限り、バイシャからは急坂を上ることになる",
      ],
    },
    {
      slug: "belem",
      ...
      vibe: "ダウンタウンから西へ6キロの川沿いの地区で、テージョ川沿いにはポルトガルの大航海時代を物語る修道院や塔、近代的な美術館群が並ぶ。午後6時頃までは日帰り観光客で賑わうが、そこから先は本当に静かになる。広く平坦で緑も多く、リスボン中心部というより庭園都市のような趣がある。",
      pros: [
        "平坦な地形と川沿いの遊歩道で、リスボンで最も歩きやすい",
        "人混みが訪れる前に、記念建造物や美術館がすぐそばにある",
        "静かな夜と、ダウンタウンより安いホテル料金",
      ],
      cons: [
        "15番路面電車で中心部まで20〜30分、しかも車内は混雑する",
        "日が暮れるとレストランやナイトライフの選択肢が少なくなる",
      ],
    },
  ],
