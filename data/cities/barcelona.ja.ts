...
const barcelona: CityData = {
  city: {
    ...
    tagline: "どこに泊まるかで、あなたのバルセロナはゴシック地区の路地になるか、ガウディの碁盤目状の街並みになるか、それとも砂浜になるかが決まる。",
    heroIntro:
      "バルセロナは、ガウディのモダニズム建築群、中世の旧市街、そして街中のビーチを、徒歩でまわれるほどコンパクトな中心部に詰め込んでおり、残りは地下鉄がカバーしてくれる。どこを拠点にするかで、毎朝目にする街の顔が変わる。安価なゴシック地区の路地、洗練された旧市街の一角、整然としたガウディの碁盤目状エリア、村のような地元の広場、あるいは玄関を出ればすぐ砂浜、というように。このガイドでは、宿泊先として検討する価値のある5つのエリアを比較し、それぞれが求めるトレードオフを明らかにする。",
  ...
  neighborhoods: [
    {
      ...
      vibe: "石畳の路地が大聖堂とランブラス通りの間を曲がりくねりながら延び、隠れた広場へと開ける、今も街の中世的な中心をなす迷路のようなエリアだ。初めてバルセロナを訪れる人が求めるものはすべて徒歩10分圏内にそろい、日中の人混みが引く夜になると通りは本当に雰囲気のある表情を見せる。静かな夜よりも予算と立地の近さを優先するならここを予約するといい。ただし街で最もスリの被害が多い地区でもあるので、バッグからは目を離さないこと。",
      pros: [
        "大聖堂、ランブラス通り、港、エル・ボルンまですべて徒歩圏内",
        "安価なタパスバー、カフェ、小さなホテルが密集している",
        "夕食後は人が引き、路地が輝きを増す",
      ],
      cons: [
        "街で最もスリが多いエリアで、ランブラス通り付近が特にひどい",
        "人通りやバーの騒音が深夜まで続き、眠りの浅い人にはつらい",
        "広場周辺の一部のレストランは料理よりも立地だけで商売している",
      ],
    },
    {
      slug: "el-born",
      ...
      vibe: "ゴシック地区の中心部からすぐ東、中世の路地がサンタ・マリア・デル・マー教会とピカソ美術館を取り囲むように延び、ブティックやワインバー、カクテルスポットが軒を連ねる。観光客向けの罠に堕ちることなく夜も賑わいを保ち、旧市街らしい雰囲気をより大人っぽくデザイン性の高い空気で包んでいる。旧市街らしさを保ちながら食事や酒のレベルを上げたいなら、多少割高でもここを予約する価値がある。",
      pros: [
        "旧市街随一のワインバー、カクテルスポット、タパス店の集積",
        "ピカソ美術館、サンタ・マリア・デル・マー教会、シウタデリャ公園まで徒歩圏内",
        "地元らしいブティック感を保ちながら賑わいを保つ石畳の路地",
      ],
      cons: [
        "週末の夜はメインの路地周辺が騒がしくなる",
        "地区内に地下鉄駅はないが、ジャウマ1世駅とバルセロネータ駅は近い",
        "隣接するゴシック地区よりホテルの宿泊料金が高い",
      ],
    },
    {
      slug: "eixample",
      ...
      vibe: "19世紀に造られた広い大通りと角を斜めに切り落とした街区がこの碁盤目状のエリアを特徴づけ、パッセジ・ダ・グラシア沿いにはモダニズム建築のファサードが街で最も密集している。カサ・バトリョ、ラ・ペドレラ、サグラダ・ファミリアがいずれも徒歩圏内にあり、地下鉄網も充実している。旧市街の混雑を避けつつ中心部の整然とした立地を求めるなら、特に初めてのガウディ巡りにはここが向いている。",
      pros: [
        "パッセジ・ダ・グラシア沿いのガウディ建築群は徒歩圏内で、サグラダ・ファミリアも近い",
        "地下鉄網が充実しており、空港行きの電車などへの直通アクセスも良い",
        "夜は静かになる広い通りで、中価格帯のホテルも豊富に揃う",
      ],
      cons: [
        "旧市街の路地に比べるとロマンチックというより機能的な印象",
        "パッセジ・ダ・グラシア沿いに泊まるとなると割高になる",
        "一部の街区はビーチや港まで一直線に長く歩く必要がある",
      ],
    },
    {
      slug: "gracia",
      ...
      vibe: "かつて独立した村だったこのエリアは、エイシャンプラの北で市に飲み込まれた後も広場ごとの独自の街並みと強い地元らしさを保っている。個人経営の店やボヘミアン気質のバー、家族経営の食堂が広場を取り囲み、暖かい夜には地元の人々が屋外で酒を楽しむ。丘の上にはパルク・グエルがそびえる。絵葉書のような景観よりも本物の下町らしさを持ち帰りたいなら、そして旧市街まで20分ほどかかっても構わないならここを予約するといい。",
      pros: [
        "観光客の団体ではなく地元の人々でにぎわう広場があり、本物の下町生活が味わえる",
        "コストパフォーマンスの良い食事と気取らないバー街",
        "パルク・グエルまで徒歩圏内で、それ以外は地下鉄でカバーできる",
      ],
      cons: [
        "旧市街やビーチまで徒歩または地下鉄で20〜25分かかる",
        "特ににぎわう広場は週末の夜に騒がしくなる",
        "大手ホテルは少なく、アパートメントや小規模ゲストハウスが中心",
      ],
    },
    {
      slug: "barceloneta",
      ...
      vibe: "港と市街のビーチに挟まれたこのかつての漁師町は、狭い街区が密集した碁盤目状の街並みで、そのまま砂浜へと続いている。昼間はシーフードレストランと遊歩道が目の前に広がり味わい深く、海沿いのバーは夏の夜遅くまで賑わいを保つ。ビーチが旅の付け足しではなく本当の目的地であるなら、ここを予約するといい。",
      pros: [
        "市街のビーチと遊歩道まで数歩、移動手段は不要",
        "L4線の駅があり、旧市街から数駅の距離",
        "海から1本裏に入れば良心的なシーフード店やベルモットバーがある",
      ],
      cons: [
        "海沿いのレストランは観光客向けの罠になりがちなので、1本内陸の通りで食事するのがよい",
        "アパートは手狭で夏は暑くなりがちで、ビーチバー付近は騒がしい",
        "エイシャンプラにあるガウディの見どころまでは徒歩か地下鉄での移動が必要",
      ],
    },
  ],
