...
const hotelsEn: Hotel[] = [
  // ---- Lisbon ----
  {
    ...
    bestFor: "カップル向け",
    blurb:
      "アルファマの石段沿いにひっそりと佇む、大人向けのブティックホテル。屋上プールとワインテラスからは、テージョ川まで遮るものなく見渡せる。部屋はあえてコンパクトに作られており、床面積を削ってでも街屈指の眺望を手に入れるという割り切りだ。",
    image: px(2290753),
  ...
  },
  {
    ...
    bestFor: "長期滞在向け",
    blurb:
      "バイロ・アルトの静かな高台に建つ18世紀の旧宮殿を改装した施設で、各部屋は独立したキッチン付きのスイートになっており、週末を超える長期滞在向けに作られている。屋上バーは観光客よりも地元客で賑わうが、金曜夜の階下の騒音が気になるなら、裏手向きのスイートをリクエストする価値がある。",
    image: px(262048),
  ...
  },
  {
    ...
    bestFor: "初めての旅行者向け",
    blurb:
      "ロシオ広場に直接面したこのホテルからは、28番路面電車の停留所、サンタ・ジュスタのエレベーター、そしてアルファマとバイロ・アルト両方への上り口まで、徒歩5分圏内に収まる。表側の部屋は石畳の広場を見下ろせるが、裏側の部屋はその眺めと引き換えにぐっすり眠れる静けさを得られる。",
    image: px(2507010),
  ...
  },
  {
    ...
    bestFor: "予算重視の旅行者向け",
    blurb:
      "サン・ペドロ・デ・アルカンタラ展望台のすぐそばに建つ19世紀のタウンハウスを改装した施設で、相部屋のドミトリーと、価格を大きく上回る質のプライベートスイートを併せ持つ。五つ星クラスの眺めとプリンシペ・レアルのカフェ街がすぐそこにありながら、周辺のブティックホテルとは比べ物にならない料金で泊まれる。",
    image: px(279805),
  ...
  // ---- Rome ----
  {
    ...
    bestFor: "ランドマーク滞在",
    blurb:
      "スペイン階段の頂上に位置する家族経営のホテルで、屋上レストランからは旧市街を見下ろせる。料金はローマでも屈指の高さだが、宿泊客が対価を払っているのはあくまでもこの眺めと立地に対してだ。",
    image: px(2290753),
    imageAlt: "Rooftop terrace of a hotel at dusk with tables set for dinner",
  },
  {
    ...
    bestFor: "初めての旅",
    blurb:
      "ヴィア・ナツィオナーレ沿いに建つ洗練された4つ星ホテルで、テルミニ駅とモンティの間に位置し、コロッセオもすべての地下鉄路線も徒歩圏内にある。客室はローマの平均より広く、時期によっては屋上でのアペリティボタイムが宿泊料金に含まれることもある。",
    image: px(262048),
    imageAlt: "Bright elegant hotel suite with a chandelier and large bed",
  },
  {
    ...
    bestFor: "地元の暮らし",
    blurb:
      "オレンジの木が茂る中庭を囲むかつての修道院を利用した低層ホテルで、トラステヴェレの夜の賑わいは窓の外にとどまり、真下には響かない。中庭に直接面した1階の部屋がいくつかあり、ローマでは珍しく、階段が負担になる人には便利だ。",
    image: px(164595),
    imageAlt: "Hotel bedroom with dark wood beams and crisp bedding",
  },
  {
    ...
    bestFor: "予算重視",
    blurb:
      "テルミニ駅とトレビの泉のちょうど中間に位置する社交的なホステルで、大きな庭の中庭を囲むようにドミトリーと個室が並ぶ。古代遺跡の中心部までは徒歩圏内で、料金はローマ中心部のどのホテルよりもずっと安い。",
    image: px(279805),
    imageAlt: "Warm bedside lamp and headboard detail in a guesthouse room",
  },
  ...
  // ---- Madrid ----
  {
    ...
    band: "€€€",
    priceFrom: 250,
    style: "グラン・ビア高台のルーフトップ",
    bestFor: "眺望重視派向け",
    blurb:
      "グラン・ビアの高台に位置するこのホテルは、屋上テラス&レストランから街並みの向こうに、晴れた日にはグアダラマ山脈まで見渡せる。美術館街へは南に徒歩すぐ、チュエカとマラサーニャのバー街へも同じくらい近い反対側にある。",
    image: px(261102),
  ...
  },
  {
    ...
    bestFor: "デザイン好き向け",
    blurb:
      "19世紀のチュエカの邸宅を改装したこのホテルは、1階のバーが宿泊客だけでなく、ブランチやカクテル目当ての常連の地元客も引き寄せる。マドリードで最も活気ある中心バリオに滞在でき、プラド美術館にもグラン・ビアにも歩いてすぐ。",
    image: px(1267438),
    imageAlt: "Minimalist design hotel room in dark tones with low lighting",
  },
  {
    ...
    bestFor: "地元の暮らし重視派向け",
    blurb:
      "19世紀の元・馬車宿がカバ・バハ通りに直接面しており、ラ・ラティーナ随一のタパス巡りは玄関先から始まる。客室はガラス屋根の中庭を囲むように配置され、その中庭はマドリードの中世の城壁跡の上に建てられている。",
    image: px(279746),
    imageAlt: "Traditional hotel bedroom with wooden furniture",
  },
  {
    ...
    bestFor: "節約旅行者向け",
    blurb:
      "マヨール広場からわずか数歩のこの格安ホテル兼ホステルは、個室とドミトリーを併せ持ち、屋上バーからは旧市街の夜景を眺められる。歴史地区にこれほど近い場所では、最も安い部類の宿。",
    image: px(271624),
    imageAlt: "Simple bright room with a desk and double bed",
  },
  ...
  // ---- Paris ----
  {
    ...
    bestFor: "ランドマークに泊まる",
    blurb:
      "ラスパイユ大通りにある左岸唯一のパレスホテルで、1910年築の建物を4年かけて修復し2018年に再オープンした。歴史あるバーとブラッスリーはサンジェルマンの中心に位置し、オルセー美術館やカルチェ・ラタンへも歩いてすぐ。",
    image: px(262048),
    imageAlt: "Grand elegant hotel suite with a chandelier and large bed",
  },
  {
    ...
    bestFor: "デザイン好きに",
    blurb:
      "マレ地区北端に位置するこのホテルは、イタリアのデザインチームが内装を手がけた。ルーフトップバーからはサクレ・クール寺院を望む街の屋根並みが見渡せる。ポンピドゥー・センターや地区のバーへは少し歩けば着き、近くの地下鉄駅から右岸の他エリアへもアクセスしやすい。",
    image: px(1267438),
    imageAlt: "Minimalist design hotel room in dark tones with low lighting",
  },
  {
    ...
    bestFor: "初めてのパリ旅行に",
    blurb:
      "カルチェ・ラタンにある小さなこのホテルの客室からは、パンテオンのドームが真正面に見える。バルコニー付きの部屋も少数あり、その眺めを独り占めできる。ノートルダム大聖堂とリュクサンブール公園はどちらも徒歩15分圏内。",
    image: px(279746),
    imageAlt: "Traditional hotel bedroom with wooden furniture",
  },
  {
    ...
    bestFor: "予算重視に",
    blurb:
      "サン・マルタン運河のほとりに建つこのデザインホステルは、街のスカイラインを望むルーフトップバーが自慢で、ドミトリーと個室の両方を用意している。宿泊料金は右岸のホテルよりかなり抑えめで、近くの地下鉄駅からパリの他エリアへも行きやすい。",
    image: px(271624),
    imageAlt: "Simple bright room with a desk and double bed",
  },
