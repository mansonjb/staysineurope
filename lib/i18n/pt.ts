...
const pt: typeof en = {
  ...
  home: {
    ...
    stamp: "Onde ficar, bem feito",
    heroParts: [
      { pre: "A ", word: "cidade", post: " certa." },
      { pre: " O ", word: "bairro", post: " certo." },
      { pre: " O ", word: "hotel", post: " certo." },
    ],
    heroSub:
      "Para cada cidade que cobrimos, uma página responde à pergunta que decide discretamente a viagem: em que bairro dormir, e o melhor hotel a sério em cada um. Prós e contras honestos, mapas em tempo real, sem enchimento.",
    pickCity: "Escolher uma cidade",
    howManyBtn: "De quantos dias preciso?",
    departures: "Partidas · a Europa primeiro",
    daysIdealShort: "{days} dias, o ideal",
    best: "melhor",
    boarding: "embarque →",
    whereNext: "Para onde a seguir?",
    allDest: "Todos os destinos",
    searchPlaceholder: "Procure uma cidade, ex. Bruges",
    searchNoResult: "Ainda não há nenhuma cidade para essa pesquisa. Novas são acrescentadas com cuidado ao longo do tempo.",
    browseAll: "Ver todas",
    knownForLead: "Conhecida por",
    faqTitle: "Perguntas sobre onde ficar, respondidas",
    faqs: [
      {
        q: "Por que razão o bairro importa tanto numa viagem a uma cidade?",
        a: "Numa viagem de dois a quatro dias, quase não se sai da zona à volta do hotel, por isso o bairro escolhido torna-se a própria viagem. O certo coloca os pontos turísticos, a boa comida e o ambiente noturno que procura à porta de casa; o errado transforma tudo numa deslocação.",
      },
      {
        q: "Como decidem qual é a melhor zona para ficar numa cidade?",
        a: "Pesamos o que realmente muda os seus dias: a que distância a pé estão os principais pontos turísticos, o ambiente das ruas à noite, a segurança, o ruído e quanto custa mesmo um quarto decente ali. Cada página de cidade coloca as melhores zonas lado a lado para poder escolher a que combina com a sua viagem.",
      },
      {
        q: "As escolhas de hotéis são patrocinadas?",
        a: "Não. Cada cidade recebe quatro hotéis a sério que nós próprios reservaríamos, do luxo ao económico, escolhidos primeiro pela localização. Recebemos uma comissão se reservar através dos nossos links, mas isso nunca decide quais os hotéis que entram na lista.",
      },
      {
        q: "Quantos hotéis listam por cidade?",
        a: "Quatro: um de luxo, dois de gama média e um económico, cada um ancorado num bairro diferente, para que a escolha sirva também de recomendação de zona. Menos escolhas, mas melhores, valem mais do que uma parede de cem anúncios para filtrar sozinho.",
      },
      {
        q: "Os mapas mostram os preços reais dos hotéis?",
        a: "Sim. O mapa de cada cidade vai buscar as tarifas de hotéis em tempo real para as suas datas, para comparar o que pagaria realmente, não um preço de partida desatualizado. Reservar através dele apoia o site sem custo extra para si.",
      },
    ],
    methodKicker: "O nosso método",
    methodTitle:
      "Sem «joias escondidas». Sem listas de 100 hotéis. Uma escolha clara por zona.",
    methodBody:
      "Cada cidade é construída da mesma forma: os bairros comparados no que realmente importa, a melhor zona indicada para cada tipo de viagem, e um hotel a sério que vale a pena reservar em cada um. Cada linha tem de passar um teste: consegue agir com base nela? Se não, é cortada.",
    methodLink: "Como escolhemos",
  },
  dest: {
